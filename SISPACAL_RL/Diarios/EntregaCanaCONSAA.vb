...
Public Class EntregaCanaCONSAA
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SISPACAL.RL.EntregaCanaCONSAA.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedEntregaCanaCONSAA
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As EntregaCanaCONSAA = New EntregaCanaCONSAA()
        rpt.Site = Me.Site
        Return rpt
    End Function
