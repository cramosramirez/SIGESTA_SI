...
Public Class OrdenCombustible
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SISPACAL.RL.OrdenCombustible.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedOrdenCombustible
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As OrdenCombustible = New OrdenCombustible()
        rpt.Site = Me.Site
        Return rpt
    End Function
