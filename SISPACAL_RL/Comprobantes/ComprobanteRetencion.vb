...
Public Class ComprobanteRetencion
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "ComprobanteRetencion.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SISPACAL.RL.ComprobanteRetencion.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedComprobanteRetencion
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ComprobanteRetencion = New ComprobanteRetencion()
        rpt.Site = Me.Site
        Return rpt
    End Function
