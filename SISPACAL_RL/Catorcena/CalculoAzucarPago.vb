...
Public Class CalculoAzucarPago
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SISPACAL.RL.CalculoAzucarPago.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCalculoAzucarPago
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CalculoAzucarPago = New CalculoAzucarPago()
        rpt.Site = Me.Site
        Return rpt
    End Function
