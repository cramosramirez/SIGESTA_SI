...
Public Class DescuentosCanero
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SISPACAL.RL.DescuentosCanero.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedDescuentosCanero
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As DescuentosCanero = New DescuentosCanero()
        rpt.Site = Me.Site
        Return rpt
    End Function
