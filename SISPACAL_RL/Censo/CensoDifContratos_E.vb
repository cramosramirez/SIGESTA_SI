...
Public Class CensoDifContratos_E
    ...
    Private MZ_G4_CONTRA As Decimal = 0
    Private TC_G4_CONTRA As Decimal = 0
    ...
    Private MZ_G4_CENSO As Decimal = 0
    Private TC_G4_CENSO As Decimal = 0
    ...
    Private MZ_G4_DIF As Decimal = 0
    Private TC_G4_DIF As Decimal = 0
    ...
    Private Sub SummaryGetResult(sender As Object, e As DevExpress.XtraReports.UI.SummaryGetResultEventArgs) _
            Handles xrTC_MZG1_CONTRA.SummaryGetResult, xrTC_MZG2_CONTRA.SummaryGetResult, xrTC_MZG3_CONTRA.SummaryGetResult, xrTC_MZG4_CONTRA.SummaryGetResult, _
                xrTC_MZG1_CENSO.SummaryGetResult, xrTC_MZG2_CENSO.SummaryGetResult, xrTC_MZG3_CENSO.SummaryGetResult, xrTC_MZG4_CENSO.SummaryGetResult, _
                xrTC_MZG1_DIF.SummaryGetResult, xrTC_MZG2_DIF.SummaryGetResult, xrTC_MZG3_DIF.SummaryGetResult, xrTC_MZG4_DIF.SummaryGetResult
        ...
        Select Case TryCast(sender, XRTableCell).Name
            ...
            Case "xrTC_MZG4_CONTRA"
                e.Result = If(MZ_G4_CONTRA > 0, TC_G4_CONTRA / MZ_G4_CONTRA, 0)
            ...
            Case "xrTC_MZG4_CENSO"
                e.Result = If(MZ_G4_CENSO > 0, TC_G4_CENSO / MZ_G4_CENSO, 0)
            ...
            Case "xrTC_MZG4_DIF"
                e.Result = If(MZ_G4_DIF > 0, TC_G4_DIF / MZ_G4_DIF, 0)
        End Select
        e.Handled = True
    End Sub

    Private Sub SummaryReset(sender As Object, e As System.EventArgs) _
            Handles xrTC_MZG1_CONTRA.SummaryReset, xrTC_MZG2_CONTRA.SummaryReset, xrTC_MZG3_CONTRA.SummaryReset, xrTC_MZG4_CONTRA.SummaryReset, _
                xrTC_MZG1_CENSO.SummaryReset, xrTC_MZG2_CENSO.SummaryReset, xrTC_MZG3_CENSO.SummaryReset, xrTC_MZG4_CENSO.SummaryReset, _
                xrTC_MZG1_DIF.SummaryReset, xrTC_MZG2_DIF.SummaryReset, xrTC_MZG3_DIF.SummaryReset, xrTC_MZG4_DIF.SummaryReset
        Select Case TryCast(sender, XRTableCell).Name
            Case "xrTC_MZG1_CONTRA"
                MZ_G1_CONTRA = 0
                TC_G1_CONTRA = 0
    ...
    Private Sub SummaryRowChanged(sender As Object, e As System.EventArgs) _
            Handles xrTC_MZG1_CONTRA.SummaryRowChanged, xrTC_MZG2_CONTRA.SummaryRowChanged, xrTC_MZG3_CONTRA.SummaryRowChanged, xrTC_MZG4_CONTRA.SummaryRowChanged, _
                xrTC_MZG1_CENSO.SummaryRowChanged, xrTC_MZG2_CENSO.SummaryRowChanged, xrTC_MZG3_CENSO.SummaryRowChanged, xrTC_MZG4_CENSO.SummaryRowChanged, _
                xrTC_MZG1_DIF.SummaryRowChanged, xrTC_MZG2_DIF.SummaryRowChanged, xrTC_MZG3_DIF.SummaryRowChanged, xrTC_MZG4_DIF.SummaryRowChanged
        ...
        Select Case TryCast(sender, XRTableCell).Name
            ...
            Case "xrTC_MZG4_CONTRA"
                MZ_G4_CONTRA += Convert.ToDecimal(GetCurrentColumnValue("MZ_CONTRATADO"))
                TC_G4_CONTRA += Convert.ToDecimal(GetCurrentColumnValue("TC_CONTRATADO"))
            Case "xrTC_MZG1_CENSO"
            ...
            Case "xrTC_MZG4_CENSO"
                MZ_G4_CENSO += Convert.ToDecimal(GetCurrentColumnValue("MZ_CENSO"))
                TC_G4_CENSO += Convert.ToDecimal(GetCurrentColumnValue("TONEL_CENSO"))
            Case "xrTC_MZG1_DIF"
            ...
            Case "xrTC_MZG4_DIF"
                MZ_G4_DIF += Convert.ToDecimal(GetCurrentColumnValue("MZ_VAR"))
                TC_G4_DIF += Convert.ToDecimal(GetCurrentColumnValue("TC_VAR"))
        End Select
    End Sub
