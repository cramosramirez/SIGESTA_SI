...
Public Class ContratoCanaLotesTC_D
    ...
    Public Sub CargarDatos(ByVal ID_ZAFRA As Int32, ByVal ZONA As String, ByVal SUB_ZONA As String)
        ...
        Me.ContratO_REND_ESTIMADOTableAdapter1.FillPorZona(Me.DS_SIGESTA1.CONTRATO_REND_ESTIMADO, ID_ZAFRA, ZONA, SUB_ZONA, "", "", "")
        mID_ZAFRA = ID_ZAFRA
        mZONA = ZONA
        mSUB_ZONA = SUB_ZONA
    ...
    Public Sub CargarDatosEsticana(ByVal ID_ZAFRA As Int32, ByVal ZONA As String, ByVal SUB_ZONA As String)
        Me.ContratO_REND_ESTIMADOTableAdapter1.SetCommandTimeOut(900000)
        Me.ContratO_REND_ESTIMADOTableAdapter1.FillPorZonaEsticana(Me.DS_SIGESTA1.CONTRATO_REND_ESTIMADO, ID_ZAFRA, ZONA, SUB_ZONA, "", "", "")
        mID_ZAFRA = ID_ZAFRA
        mZONA = ZONA
        mSUB_ZONA = SUB_ZONA
        Me.xrTitulo.Text = "CONTRATOS DE CAÑA (MZ - TC)"
