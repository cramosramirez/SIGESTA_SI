...
Public Class ContratoCanaLotesTCUS_E
    ...
    Public Sub CargarDatos(ByVal ID_ZAFRA As Int32, ByVal ZONA As String, ByVal SUB_ZONA As String, ByVal CODI_DEPTO As String, ByVal CODI_MUNI As String, ByVal CODI_CANTON As String)
        Me.Contrato_REND_ESTIMADOTableAdapter1.FillPorContrato(Me.DS_SIGESTA1.CONTRATO_REND_ESTIMADO, ID_ZAFRA, ZONA, SUB_ZONA, CODI_DEPTO, CODI_MUNI, CODI_CANTON, "", "")
        mID_ZAFRA = ID_ZAFRA
        mZONA = ZONA
        mSUB_ZONA = SUB_ZONA
