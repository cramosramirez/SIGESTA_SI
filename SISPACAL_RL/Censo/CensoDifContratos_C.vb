...
Public Class CensoDifContratos_C
    ...
    Private Sub SummaryGetResult(sender As Object, e As DevExpress.XtraReports.UI.SummaryGetResultEventArgs) _
            Handles xrTC_MZG1_CONTRA.SummaryGetResult, xrTC_MZG2_CONTRA.SummaryGetResult, _
                xrTC_MZG1_CENSO.SummaryGetResult, xrTC_MZG2_CENSO.SummaryGetResult, _
                xrTC_MZG1_DIF.SummaryGetResult, xrTC_MZG2_DIF.SummaryGetResult
    ...
    Private Sub SummaryReset(sender As Object, e As System.EventArgs) _
            Handles xrTC_MZG1_CONTRA.SummaryReset, xrTC_MZG2_CONTRA.SummaryReset, _
                xrTC_MZG1_CENSO.SummaryReset, xrTC_MZG2_CENSO.SummaryReset, _
                xrTC_MZG1_DIF.SummaryReset, xrTC_MZG2_DIF.SummaryReset
        Select Case TryCast(sender, XRTableCell).Name
            Case "xrTC_MZG1_CONTRA"
                MZ_G1_CONTRA = 0
                TC_G1_CONTRA = 0
    ...
    Private Sub SummaryRowChanged(sender As Object, e As System.EventArgs) _
            Handles xrTC_MZG1_CONTRA.SummaryRowChanged, xrTC_MZG2_CONTRA.SummaryRowChanged, _
                xrTC_MZG1_CENSO.SummaryRowChanged, xrTC_MZG2_CENSO.SummaryRowChanged, _
                xrTC_MZG1_DIF.SummaryRowChanged, xrTC_MZG2_DIF.SummaryRowChanged
