...
Public Class ContratoCanaLotesTCUS_A
    ...
    Private Sub SummaryGetResultREND(sender As Object, e As DevExpress.XtraReports.UI.SummaryGetResultEventArgs) Handles xrRENDG1.SummaryGetResult, xrRENDG2.SummaryGetResult, xrRENDG3.SummaryGetResult, xrTC_MZG3.SummaryGetResult, xrTC_MZG2.SummaryGetResult, xrTC_MZG1.SummaryGetResult
        Select Case TryCast(sender, XRTableCell).Name
            Case "xrRENDG1"
    ...
    Private Sub SummaryResetREND(sender As Object, e As System.EventArgs) Handles xrRENDG1.SummaryReset, xrRENDG2.SummaryReset, xrRENDG3.SummaryReset, xrTC_MZG3.SummaryReset, xrTC_MZG2.SummaryReset, xrTC_MZG1.SummaryReset
        Select Case TryCast(sender, XRTableCell).Name
            Case "xrRENDG1"
                TC_RENDG1 = 0
                LBS_RENDG1 = 0
    ...
    Private Sub SummaryRowChangedREND(sender As Object, e As System.EventArgs) Handles xrRENDG1.SummaryRowChanged, xrRENDG2.SummaryRowChanged, xrRENDG3.SummaryRowChanged, xrTC_MZG3.SummaryRowChanged, xrTC_MZG2.SummaryRowChanged, xrTC_MZG1.SummaryRowChanged
        Select Case TryCast(sender, XRTableCell).Name
            Case "xrRENDG1"
