...
Public Class ContratoCanaLotesTC_B
    ...
    Public Sub CargarDatosEsticana(ByVal ID_ZAFRA As Int32, ByVal ZONA As String, ByVal SUB_ZONA As String,
                           ...
                           ByVal CODIPROVEE As String, ByVal CODISOCIO As String)
        Me.ContratO_REND_ESTIMADOTableAdapter1.SetCommandTimeOut(900000)
        Me.ContratO_REND_ESTIMADOTableAdapter1.FillPorContratoEsticana(Me.DS_SIGESTA1.CONTRATO_REND_ESTIMADO, ID_ZAFRA, ZONA, SUB_ZONA, CODI_DEPTO, CODI_MUNI, CODI_CANTON, CODIPROVEE, CODISOCIO)
        Me.xrTitulo.Text = "CONTRATOS DE ESTICAÑA (MZ - TC)"
    End Sub

    Private Sub ReportFooter_BeforePrint(sender As Object, e As System.Drawing.Printing.PrintEventArgs)
        ...
        If dt IsNot Nothing AndAlso dt.Rows.Count > 0 AndAlso dt(0).TC_CONTRATADO > 0 Then
            If dt(0).MZ_CONTRATADO > 0 Then Me.XrTableTC_MZ1.Text = (dt(0).TC_CONTRATADO / dt(0).MZ_CONTRATADO).ToString("#,##0.00")
        End If
    End Sub
