...
Public Class PlanCATTransPorLote
    ...
    Public Sub CargarDatos(ByVal USUARIO_CREA As String, ByVal ZONA As String, ByVal SUB_ZONA As String, _
        ...
        Me.Plan_CATTableAdapter1.FillPorLote(Me.DS_SIGESTA1.PLAN_CAT, USUARIO_CREA, ZONA, SUB_ZONA, CODI_DEPTO, CODI_MUNI, CODIPROVEE, CODISOCIO, NOMBRE_PROVEEDOR, ID_TIPO_ROZA, ID_TIPO_ALZA, ID_TIPO_TRANS, SEMANA, CATORCENA, SUB_TERCIO, TERCIO, ID_ZAFRA, ID_CICLO, FECHA_CREA)
    ...
    Public Sub CargarDatosPorFecha(ByVal USUARIO_CREA As String, ByVal ZONA As String, ByVal SUB_ZONA As String, _
        ...
        Criterios(USUARIO_CREA, ZONA, SUB_ZONA, CODI_DEPTO, CODI_MUNI, CODIPROVEE, CODISOCIO, _
                  ...
                  FECHA1, FECHA2)
        NOMBRE_PROVEEDOR = NOMBRE_PROVEEDOR.Replace(" ", "%")
        Me.Plan_CATTableAdapter1.FillPorLoteFecha(Me.DS_SIGESTA1.PLAN_CAT, USUARIO_CREA, ZONA, SUB_ZONA, CODI_DEPTO, CODI_MUNI, CODIPROVEE, CODISOCIO, NOMBRE_PROVEEDOR, ID_TIPO_ROZA, ID_TIPO_ALZA, ID_TIPO_TRANS, SEMANA, CATORCENA, SUB_TERCIO, TERCIO, FECHA1, FECHA2, ID_ZAFRA, ID_CICLO, FECHA_CREA)
        Me.AsignarTitulo(ID_CICLO)
    End Sub
