...
Public Class rptSigestaEjec014_Zona
    ...
    Public Sub CargarDatos(ByVal ID_ZAFRA As Int32, ByVal FECHA_INI_COSECHA As DateTime, ByVal FECHA_FIN_COSECHA As DateTime, ByVal CODIAGRON As String)
        ...
        RPT_SIGESTA_EJEC014_PLAN_COSECHATableAdapter1.FillPorZonaCatorcenal(DS_SIGESTA1.RPT_SIGESTA_EJEC014_PLAN_COSECHA, ID_ZAFRA, FECHA_INI_COSECHA, FECHA_FIN_COSECHA, CODIAGRON)
    ...
    Public Sub CargarDatos(ByVal TIPO As String, _
        ...
        If lDiasZafra IsNot Nothing AndAlso lDiasZafra.Count > 0 Then
            ...
            Dim moliendaDiariaAJUSTADO As Decimal = bBascula.ObtenerTONEL_PROMEDIO_RANGO_DIAS_ZAFRA(ID_ZAFRA, 3)
