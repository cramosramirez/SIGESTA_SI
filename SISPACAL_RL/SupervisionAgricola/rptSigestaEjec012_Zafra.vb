...
Public Class rptSigestaEjec012_Zafra
    ...
    Public Sub CargarDatos(ByVal ZONA As String, ByVal SUB_ZONA As String, _
        ...
        Me.RPT_SIGESTA_EJEC012_PLAN_COSECHATableAdapter1.SetCommandTimeOut(900000)
        Me.RPT_SIGESTA_EJEC012_PLAN_COSECHATableAdapter1.FillPorCriterios(DS_SIGESTA1.RPT_SIGESTA_EJEC012_PLAN_COSECHA, ID_ZAFRA, USUARIO_CREA, FECHA_CREA, ZONA, _
        ...
        If lZafra IsNot Nothing Then
            ...
            Me.DisplayName = "EJECUCION ZAFRA - RENDIMIENTO AGRICOLA E INDUSTRIAL ZAFRA " + Replace(lZafra.NOMBRE_ZAFRA, "/", "-")
        End If
