...
Public Class rptSigestaEjec015_Zafra
    ...
    Public Sub CargarDatos(ByVal TIPO As String, _
        ...
        Me.RpT_SIGESTA_EJEC015_PLAN_COSECHATableAdapter1.FillPorCriterios(DS_SIGESTA1.RPT_SIGESTA_EJEC015_PLAN_COSECHA, TIPO, ID_ZAFRA, USUARIO_CREA, FECHA_CREA, ZONA, _
