...
Public Class rptSigestaEjec003_Zafra
    ...
    Public Sub CargarDatos(ByVal TIPO As String, _
        ...
        If lZafra IsNot Nothing Then
            ...
            Me.DisplayName = "EJECUCION ZAFRA - POR CATORCENAS ZAFRA " + Replace(lZafra.NOMBRE_ZAFRA, "/", "-")
        End If
        ...
        If lLotesCosecha IsNot Nothing AndAlso lLotesCosecha.TONEL_CENSO > 0 Then
            Dim dValorPlan As Decimal = (lLotesCosecha.TONEL_ENTREGADA + lLotesCosecha.TONEL_ENTREGAR)
            xrMontoPlanCosecha.Text = dValorPlan.ToString("#,##0.00")
            xrMontoEjecutado.Text = lLotesCosecha.TONEL_ENTREGADA.ToString("#,##0.00")
            xrPorcEjecutado.Text = Math.Round(lLotesCosecha.TONEL_ENTREGADA / dValorPlan * 100, 2).ToString("#0.00") + "%"
            xrMontoEjecutar.Text = (lLotesCosecha.TONEL_ENTREGAR).ToString("#,##0.00")
            xrPorcEjecutar.Text = ((lLotesCosecha.TONEL_ENTREGAR) / dValorPlan * 100).ToString("#0.00") + "%"
        Else
