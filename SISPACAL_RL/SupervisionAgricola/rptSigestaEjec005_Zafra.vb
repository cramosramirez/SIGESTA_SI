...
Public Class rptSigestaEjec005_Zafra
    ...
    Public Sub CargarDatos(ByVal TIPO As String, _
        ...
        Me.RpT_SIGESTA_EJEC005_PLAN_COSECHATableAdapter1.FillPorZafra(DS_SIGESTA1.RPT_SIGESTA_EJEC005_PLAN_COSECHA, TIPO, ID_ZAFRA, USUARIO_CREA, FECHA_CREA, ZONA, _
