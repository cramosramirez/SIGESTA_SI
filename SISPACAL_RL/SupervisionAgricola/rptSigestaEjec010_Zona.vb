...
Public Class rptSigestaEjec010_Zona
    ...
    Public Sub CargarDatos(ByVal TIPO As String, _
        ...
        Me.RPT_SIGESTA_EJEC010TableAdapter1.FillPorZonaCriterios(DS_SIGESTA1.RPT_SIGESTA_EJEC010, TIPO, ID_ZAFRA, USUARIO_CREA, FECHA_CREA, ZONA, _
                                                                    SUB_ZONA, CODI_DEPTO, CODI_MUNI, CODIPROVEE, CODISOCIO, sNombreProveedor, False)
        ...
        If lZafra IsNot Nothing Then txtTITULO.Text = "EJECUCIÓN PLAN DE COSECHA - ZAFRA " + lZafra.NOMBRE_ZAFRA
