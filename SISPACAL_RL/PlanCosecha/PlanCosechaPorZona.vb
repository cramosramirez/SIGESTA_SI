...
Public Class PlanCosechaPorZona
    ...
    Public Sub CargarDatos(ByVal ID_CENSO As Integer, ByVal ZONA As String, ByVal SUB_ZONA As String, _
        ...
        Me.CensoTableAdapter1.FillPorPlanCosechaPorZona(Me.DS_SIGESTA1.CENSO, SEMANA, CATORCENA, SUB_TERCIO, TERCIO, ZONA, SUB_ZONA, CODI_DEPTO, CODI_MUNI, CODI_CANTON, CODIPROVEE, CODISOCIO, CODIVARIEDAD, ID_TIPO_CANA, ID_SUB_TIPO_CANA, NOMBRE_PROVEEDOR, ID_ZAFRA_COMPA, HORAS_AJUSTE, ID_CENSO, ID_CICLO)
