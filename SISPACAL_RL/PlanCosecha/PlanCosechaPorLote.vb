...
Public Class PlanCosechaPorLote
    ...
    Public Sub CargarDatos(ByVal ID_CENSO As Integer, ByVal ZONA As String, ByVal SUB_ZONA As String, _
        ...
        Me.CensoTableAdapter1.FillPorPlanCosechaFabricaPorLote(Me.DS_SIGESTA1.CENSO, SEMANA, CATORCENA, SUB_TERCIO, TERCIO, USUARIO_CREA, ZONA, SUB_ZONA, CODI_DEPTO, CODI_MUNI, CODIPROVEE, CODISOCIO, CODIVARIEDAD, ID_TIPO_CANA, ID_SUB_TIPO_CANA, NOMBRE_PROVEEDOR, ID_ZAFRA_COMPA, HORAS_AJUSTE, ID_CENSO, ID_CICLO, FECHA_CREA)
    ...
    Public Sub CargarDatosPorFecha(ByVal ID_CENSO As Integer, ByVal ZONA As String, ByVal SUB_ZONA As String, _
        ...
        Criterios(ID_CENSO, ZONA, SUB_ZONA, _
                            ...
                            USUARIO_CREA, FECHA_CREA)
        NOMBRE_PROVEEDOR = NOMBRE_PROVEEDOR.Replace(" ", "%")
        Me.CensoTableAdapter1.FillPorPlanCosechaFabricaPorFecha(Me.DS_SIGESTA1.CENSO, SEMANA, CATORCENA, SUB_TERCIO, TERCIO, USUARIO_CREA, ZONA, SUB_ZONA, CODI_DEPTO, CODI_MUNI, CODIPROVEE, CODISOCIO, CODIVARIEDAD, ID_TIPO_CANA, ID_SUB_TIPO_CANA, FECHA1, FECHA2, NOMBRE_PROVEEDOR, ID_ZAFRA_COMPA, HORAS_AJUSTE, ID_CENSO, ID_CICLO, FECHA_CREA)
        Me.AsignarTitulo(ID_CICLO)
    End Sub
    ...
    Private Sub Criterios(ByVal ID_CENSO As Integer, ByVal ZONA As String, ByVal SUB_ZONA As String, _
        ...
        Me.xrNombrePlanCosecha.Text = "PLAN DE COSECHA N° " + iNumCenso.ToString

        lZafraAnt = (New cZAFRA).ObtenerZAFRA(ID_ZAFRA_COMPA)
        If lZafraAnt IsNot Nothing Then Me.xrZafraAnterior.Text = "ENTREGA CAÑA " + lZafraAnt.NOMBRE_ZAFRA
    End Sub
