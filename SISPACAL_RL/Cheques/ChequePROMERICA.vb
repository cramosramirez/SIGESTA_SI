...
Public Class ChequePROMERICA
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SISPACAL.RL.ChequePROMERICA.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedChequePROMERICA
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ChequePROMERICA = New ChequePROMERICA()
        rpt.Site = Me.Site
        Return rpt
    End Function
