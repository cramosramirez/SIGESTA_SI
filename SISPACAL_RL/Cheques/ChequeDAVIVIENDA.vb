...
Public Class ChequeDAVIVIENDA
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SISPACAL.RL.ChequeDAVIVIENDA.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedChequeDAVIVIENDA
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ChequeDAVIVIENDA = New ChequeDAVIVIENDA()
        rpt.Site = Me.Site
        Return rpt
    End Function
