...
Public Class ChequeBHObsoleto
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SISPACAL.RL.ChequeBHObsoleto.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedChequeBHObsoleto
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ChequeBHObsoleto = New ChequeBHObsoleto()
        rpt.Site = Me.Site
        Return rpt
    End Function
