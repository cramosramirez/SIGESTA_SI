...
Public Class EstadoCtaTransportista
    Public Sub CargarDatos(ByVal ID_ZAFRA As Integer, ByVal CODTRANSPORT As String, ByVal ID_CUENTA_FINAN As Integer)
        DS_TRANSPORTE1.Clear()
        REPO_ESTADO_CTATRANSPORTTableAdapter1.FillPorCriterios(DS_TRANSPORTE1.REPO_ESTADO_CTATRANSPORT, ID_ZAFRA, CODTRANSPORT, ID_CUENTA_FINAN)
