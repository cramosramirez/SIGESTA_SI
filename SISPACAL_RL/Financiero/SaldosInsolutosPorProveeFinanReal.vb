Public Class SaldosInsolutosPorProveeFinanReal
    ...
    Public Sub Cargar(ByVal ID_ZAFRA As Integer, ByVal CODIPROVEEDOR As String, ByVal ID_CUENTA_FINAN As Integer, ByVal ES_TOTAL As Boolean)
        Me.DS_SIFAG1.Clear()
        Me.RPT_SALDOS_INSOLUTOSTableAdapter1.FillPorCriterios(Me.DS_SIFAG1.RPT_SALDOS_INSOLUTOS, ID_ZAFRA, CODIPROVEEDOR, ID_CUENTA_FINAN, 2, ES_TOTAL)
