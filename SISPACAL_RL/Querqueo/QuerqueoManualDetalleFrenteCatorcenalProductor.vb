...
Public Class QuerqueoManualDetalleFrenteCatorcenalProductor
    ...
    Public Sub CargarDatos(ByVal ID_ZAFRA As Int32, ByVal CATORCENA As Integer,
        ...
        Me.RPT_ROZA_PARTICULARESTableAdapter1.FillPorQuerqueo(DS_CATORCENA1.RPT_ROZA_PARTICULARES, ID_ZAFRA, CATORCENA,
