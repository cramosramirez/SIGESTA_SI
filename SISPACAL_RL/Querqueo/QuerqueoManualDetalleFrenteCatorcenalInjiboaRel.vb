...
Public Class QuerqueoManualDetalleFrenteCatorcenalInjiboaRel
    ...
    Public Sub CargarDatos(ByVal ID_ZAFRA As Int32, ByVal CATORCENA As Integer,
        ...
        Me.RPT_ROZA_INJIBOA_RELTableAdapter1.FillPorQuerqueo(DS_CATORCENA1.RPT_ROZA_INJIBOA_REL, ID_ZAFRA, CATORCENA,
        ...
        If CODIPROVEEDOR = "0140150000" Then
            txtTIPO_ROZA3.Text = "3. TOTAL QUERQUEO - QR099 FRENTE PROPIO INJIBOA"
            ...
            End If
        Else
            txtTIPO_ROZA3.Text = "3. TOTAL QUERQUEO - QR004 INGENIO CENTRAL AZUCARERO JIBOA S.A. DE C.V."
            If dt IsNot Nothing AndAlso dt.Rows.Count > 0 Then
