''' -----------------------------------------------------------------------------
''' Project	 : SISPACAL_EL
''' Class	 : EL.CREDITO_ENCA
''' 
''' -----------------------------------------------------------------------------
''' <summary>
''' Class that allows manipulate a table row CREDITO_ENCA en memoria
''' </summary>
''' <remarks>
...
<Serializable(), Table(Name:="CREDITO_ENCA")> Public Class CREDITO_ENCA
    Inherits entidadBase

#Region " Metodos Generador "

    Public Sub New(aID_CREDITO_ENCA As Int32, aCODIPROVEEDOR As String, aID_ZAFRA As Int32, aZAFRA As String, aID_TIPO_COMPROB As Int32, aID_CUENTA_FINAN As Int32, aDESCRIP_FINAN As String, aID_PROVEE As Int32, aFECHA As DateTime, aNO_COMPROB As String, aFECHA_APLIC As DateTime, aFECHA_ULTMOV As DateTime, aUID_REFERENCIA As Guid, aTASAINT As Decimal, aCARGO As Decimal, aABONO As Decimal, aSALDO As Decimal, aINTERES As Decimal, aIVA_INTERES As Decimal, aABONO_IVA As Decimal, aABONO_INTERES As Decimal, aABONO_INTERES_IVA As Decimal, aUSUARIO_CREA As String, aFECHA_CREA As DateTime, aUSUARIO_ACT As String, aFECHA_ACT As DateTime, aES_SALDO_INSOLUTO As Boolean, aTIPO_INTERES As String, aID_PROVEEDOR_ROZA As Int32)
