''' -----------------------------------------------------------------------------
''' Project	 : SISPACAL_EL
''' Class	 : EL.REMESA_DETA_PRODU
''' 
''' -----------------------------------------------------------------------------
''' <summary>
''' Class that allows manipulate a table row REMESA_DETA_PRODU en memoria
''' </summary>
''' <remarks>
...
<Serializable(), Table(Name:="REMESA_DETA_PRODU")> Public Class REMESA_DETA_PRODU
...
#Region " Properties "
    ...
    Private _fkID_REMESA_ENCA As REMESA_ENCA_PRODU
    Public Property fkID_REMESA_ENCA() As REMESA_ENCA_PRODU
        Get
