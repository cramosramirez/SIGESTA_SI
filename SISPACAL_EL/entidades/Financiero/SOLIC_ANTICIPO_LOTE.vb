''' -----------------------------------------------------------------------------
''' Project	 : SISPACAL_EL
''' Class	 : EL.SOLIC_ANTICIPO_LOTE
''' 
''' -----------------------------------------------------------------------------
''' <summary>
''' Class that allows manipulate a table row SOLIC_ANTICIPO_LOTE en memoria
''' </summary>
''' <remarks>
...
<Serializable(), Table(Name:="SOLIC_ANTICIPO_LOTE")> Public Class SOLIC_ANTICIPO_LOTE
...
#Region " Metodos Generador "
    ...
    Public Sub New(aID_SOLI_LOTE As Int32, aID_ANTICIPO As Int32, aACCESLOTE As String, aMZ As Decimal, aTONEL_ESTI As Decimal, aPROPORCION As Decimal, aUSUARIO_CREA As String, aFECHA_CREA As DateTime, aUSUARIO_ACT As String, aFECHA_ACT As DateTime, aID_ZAFRA As Integer)
