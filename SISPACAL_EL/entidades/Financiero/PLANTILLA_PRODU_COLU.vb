''' -----------------------------------------------------------------------------
''' Project	 : SISPACAL_EL
''' Class	 : EL.PLANTILLA_PRODU_COLU
''' 
''' -----------------------------------------------------------------------------
''' <summary>
''' Class that allows manipulate a table row PLANTILLA_PRODU_COLU en memoria
''' </summary>
''' <remarks>
...
<Serializable(), Table(Name:="PLANTILLA_PRODU_COLU")> Public Class PLANTILLA_PRODU_COLU
