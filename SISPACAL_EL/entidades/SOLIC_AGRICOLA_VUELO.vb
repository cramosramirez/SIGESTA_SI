''' -----------------------------------------------------------------------------
''' Project	 : SISPACAL_EL
''' Class	 : EL.SOLIC_AGRICOLA_VUELO
''' 
''' -----------------------------------------------------------------------------
''' <summary>
''' Class that allows manipulate a table row SOLIC_AGRICOLA_VUELO en memoria
''' </summary>
''' <remarks>
...
<Serializable(), Table(Name:="SOLIC_AGRICOLA_VUELO")> Public Class SOLIC_AGRICOLA_VUELO
...
#Region " Metodos Generador "
    ...
    Public Sub New(aID_SOLIC_AGRI_VUELO As Int32, aID_SOLICITUD As Int32, aID_PROVEE As Int32, aMEDIO_APLICA As String, aDESCRIP_AERONAVE As String, aNOMBRE_PILOTO As String, aPRECIO_UNIT_VUELO As Decimal, aMZ_HORAS_VUELO As Decimal, aCARGO_VUELO As Decimal, aPRECIO_TOTAL_VUELO As Decimal, aPRECIO_UNIT_AGUA As Decimal, aMZ_REGAR_AGUA As Decimal, aPRECIO_TOTAL_AGUA As Decimal, aUSUARIO_CREA As String, aFECHA_CREA As DateTime, aUSUARIO_ACT As String, aFECHA_ACT As DateTime, aZAFRA As String, aUID_SOLIC_AGRI_VUELO As Guid)
        Me._ID_SOLIC_AGRI_VUELO = aID_SOLIC_AGRI_VUELO
...
#Region " Properties "
    ...
    Private _ID_SOLIC_AGRI_VUELO As Int32
    <Column(Name:="Id solic agri vuelo", Storage:="ID_SOLIC_AGRI_VUELO", DbType:="INT NOT NULL", Id:=True), _
     DataObjectField(True, False, False), Precision(Precision:=10, Scale:=255)> _
    Public Property ID_SOLIC_AGRI_VUELO() As Int32
        Get
            Return _ID_SOLIC_AGRI_VUELO
        End Get
        Set(ByVal Value As Int32)
            _ID_SOLIC_AGRI_VUELO = Value
            OnPropertyChanged("ID_SOLIC_AGRI_VUELO")
        End Set
    End Property 
