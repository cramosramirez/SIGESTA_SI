...
''' -----------------------------------------------------------------------------
''' <summary>
''' Class that allows manipulate a table row CONTRATO en memoria
''' </summary>
''' <remarks>
...
<Serializable(), Table(Name:="CONTRATO")> Public Class CONTRATO
...
#Region " Metodos Generador "
    ...
    Public Sub New(aCODICONTRATO As String, aANIOZAFRA As String, aCODIPROVEEDOR As String, aFECHA_CONTRATOCB As DateTime, aESTADO_CONTRATOCB As Int32, aFINANCOADO As String, aFINAN_NUMERO As String, aTOTALMZ_CONTRATOCB As Decimal, aTONELADAS_CONTRATOCB As Decimal, aOBSERVACIONES_CONTRATOCB As String, aUSER_CREA As Int32, aFECHA_CREA As DateTime, aUSER_ACT As Int32, aFECHA_ACT As DateTime, aNO_REGISTRO As String, aFECHA_REGISTRO As DateTime, aAPELLIDOS As String, aNOMBRES As String, aDIRECCION As String, aTELEFONO As String, aCELULAR As String, aDUI As String, aNIT As String, aCREDITFISCAL As String, aAPODERADO As String, aDUI_APODERADO As String, aNIT_APODERADO As String, aID_ZAFRA As Int32, aNO_CONTRATO As Int32, aTIPO_CONTRATO As Int32, aFECHA_CONTRA_LEGAL As DateTime, aEDAD As Int32)
...
#Region " Properties "
    ...
    <Column(Name:="Aniozafra", Storage:="ANIOZAFRA", DbType:="VARCHAR(10)", Id:=False), _
