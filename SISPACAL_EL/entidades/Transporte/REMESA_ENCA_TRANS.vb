''' -----------------------------------------------------------------------------
''' Project	 : SISPACAL_EL
''' Class	 : EL.REMESA_ENCA_TRANS
''' 
''' -----------------------------------------------------------------------------
''' <summary>
''' Class that allows manipulate a table row REMESA_ENCA_TRANS en memoria
''' </summary>
''' <remarks>
...
<Serializable(), Table(Name:="REMESA_ENCA_TRANS")> Public Class REMESA_ENCA_TRANS
