''' -----------------------------------------------------------------------------
''' Project	 : SISPACAL_EL
''' Class	 : EL.CREDITO_MOV_TRANS
''' 
''' -----------------------------------------------------------------------------
''' <summary>
''' Class that allows manipulate a table row CREDITO_MOV_TRANS en memoria
''' </summary>
''' <remarks>
...
<Serializable(), Table(Name:="CREDITO_MOV_TRANS")> Public Class CREDITO_MOV_TRANS
...
#Region " Metodos Generador "
    ...
    Public Sub New(aID_CREDITO_MOV As Int32, aID_CREDITO_ENCA As Int32, aFECHA As DateTime, aUID_REFERENCIA As Guid, aID_CATORCENA As Int32, aCARGO As Decimal, aABONO As Decimal, aSALDO As Decimal, aABONO_IVA As Decimal, aABONO_INTERES As Decimal, aABONO_INTERES_IVA As Decimal, aUSUARIO_CREA As String, aFECHA_CREA As DateTime, aUSUARIO_ACT As String, aFECHA_ACT As DateTime, aCODIBANCO As Int32, aNO_DOCUMENTO As String, aFECHA_ULTMOV As DateTime, aTASAINT As Decimal, aSALDO_INICIAL As Decimal, aTIPO_INTERES As String, aPLAZO_DIAS As Int32, aID_PLANILLA_BASE As Int32, aID_CATORCENA_VTO As Int32)
        ...
        Me._ID_CATORCENA_VTO = aID_CATORCENA_VTO
    End Sub
...
#Region " Properties "
    ...
    <Column(Name:="Id catorcena vto", Storage:="ID_CATORCENA_VTO", DbType:="INT", Id:=False), _
     DataObjectField(False, False, True), Precision(Precision:=10, Scale:=255)> _
    ...
    Private _ID_CATORCENA_VTOOld As Int32
    Public Property ID_CATORCENA_VTOOld() As Int32
        Get
            Return _ID_CATORCENA_VTOOld
        End Get
        Set(ByVal Value As Int32)
            _ID_CATORCENA_VTOOld = Value
        End Set
    End Property 

    Private _fkID_CATORCENA_VTO As CATORCENA_ZAFRA
    Public Property fkID_CATORCENA_VTO() As CATORCENA_ZAFRA
        Get
            Return _fkID_CATORCENA_VTO
        End Get
        Set(ByVal Value As CATORCENA_ZAFRA)
            _fkID_CATORCENA_VTO = Value
        End Set
    End Property 
