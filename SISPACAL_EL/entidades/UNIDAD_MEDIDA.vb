''' -----------------------------------------------------------------------------
''' Project	 : SISPACAL_EL
''' Class	 : EL.UNIDAD_MEDIDA
''' 
''' -----------------------------------------------------------------------------
''' <summary>
''' Class that allows manipulate a table row UNIDAD_MEDIDA en memoria
''' </summary>
''' <remarks>
...
<Serializable(), Table(Name:="UNIDAD_MEDIDA")> Public Class UNIDAD_MEDIDA
...
#Region " Metodos Generador "
    ...
    Public Sub New(aID_UNIDAD As Int32, aNOMBRE_UNIDAD As String, aUSUARIO_CREA As String, aFECHA_CREA As DateTime, aUSUARIO_ACT As String, aFECHA_ACT As DateTime)
...
#Region " Properties "
    ...
    <Column(Name:="Id unidad", Storage:="ID_UNIDAD", DbType:="INT NOT NULL", Id:=True), _
    ...
    <Column(Name:="Nombre unidad", Storage:="NOMBRE_UNIDAD", DbType:="VARCHAR(10) NOT NULL", Id:=False), _
