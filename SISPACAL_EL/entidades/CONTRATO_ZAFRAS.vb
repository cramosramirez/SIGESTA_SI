''' -----------------------------------------------------------------------------
''' Project	 : SISPACAL_EL
''' Class	 : EL.CONTRATO_ZAFRAS
''' 
''' -----------------------------------------------------------------------------
''' <summary>
''' Class that allows manipulate a table row CONTRATO_ZAFRAS en memoria
''' </summary>
''' <remarks>
...
<Serializable(), Table(Name:="CONTRATO_ZAFRAS")> Public Class CONTRATO_ZAFRAS
