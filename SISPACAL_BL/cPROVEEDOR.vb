...
''' las funciones CRUD(Create, Read, Update y Delete) de la tabla PROVEEDOR
''' </summary>
''' <remarks>
...
#Region " Privadas "
    Private mDb as New dbPROVEEDOR()
    Private mEntidad as New PROVEEDOR
#End Region
    ...
    Public Function ObtenerLista(ByVal Optional recuperarHijas As Boolean = False, ByVal Optional asColumnaOrden As String = "", ByVal Optional asTipoOrden As String = "ASC") As ListaPROVEEDOR
        Try
            Dim mListaPROVEEDOR As New ListaPROVEEDOR
            mListaPROVEEDOR = mDb.ObtenerListaPorID(asColumnaOrden, asTipoOrden)
            If Not recuperarHijas Then Return mListaPROVEEDOR
            If Not mListaPROVEEDOR Is Nothing Then
                For Each lEntidad As PROVEEDOR in  mListaPROVEEDOR
                    Try
    ...
    ''' -----------------------------------------------------------------------------
    <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Select, False)> _
    Public Function ObtenerPROVEEDOR(ByRef aEntidad As PROVEEDOR, ByVal Optional recuperarHijas As Boolean = False) As Integer
        Try
    ...
    ''' -----------------------------------------------------------------------------
    ''' <summary>
    ''' Función que selecciona un Registro y lo Devuelve en una Entidad de la Tabla PROVEEDOR.
    ''' </summary>
    ...
    Public Function ObtenerPROVEEDOR(ByVal CODIPROVEEDOR As String, ByVal Optional recuperarHijas As Boolean = False) As PROVEEDOR
        Try
    ...
    ''' -----------------------------------------------------------------------------
    ''' <summary>
    ''' Función que Elimina un Registro de la Tabla PROVEEDOR que se le envía como parámetro.
    ''' </summary>
    ''' <param name="CODIPROVEEDOR"></param>
    ''' <remarks>
    ''' </remarks>
    ...
    Public Function EliminarPROVEEDOR(ByVal CODIPROVEEDOR As String) As Integer
        Try
    ...
    ''' -----------------------------------------------------------------------------
    ''' <summary>
    ''' Función que Elimina un Registro de la Tabla PROVEEDOR que se le envía como
    ...
    ''' -----------------------------------------------------------------------------
    <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Delete, False)> _
    Public Function EliminarPROVEEDOR(ByVal aEntidad As PROVEEDOR, ByVal aTipoConcurrencia As TipoConcurrencia) As Integer
        Try
    ...
    ''' </history>
    ''' -----------------------------------------------------------------------------
    Private Sub RecuperarHijas(ByRef aEntidad As PROVEEDOR )
    End Sub
