...
#End Region
    ...
    ''' </history>
    ''' -----------------------------------------------------------------------------
    Public Function ObtenerUSUARIOConForaneas(ByVal aEntidad As USUARIO, Optional ByVal aPERFIL As Boolean = False) As Integer
        Try
            Return mDb.RecuperarConForaneas(aEntidad, aPERFIL)
        Catch ex as Exception
            ExceptionManager.Publish(ex)
            Return -1
        End Try
    ...
    ''' -----------------------------------------------------------------------------
    <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Select, False)> _
    Public Function ObtenerListaPorPERFIL(ByVal ID_PERFIL As Int32, ByVal Optional recuperarHijas As Boolean = False, ByVal Optional recuperarForaneas As Boolean = False, ByVal Optional asColumnaOrden As String = "", ByVal Optional asTipoOrden As String = "ASC") As ListaUSUARIO
        Try
            Dim mListaUSUARIO As New ListaUSUARIO
            mListaUSUARIO = mDb.ObtenerListaPorPERFIL(ID_PERFIL, asColumnaOrden, asTipoOrden)
            If Not mListaUSUARIO Is Nothing And recuperarForaneas Then
                For Each lEntidad As USUARIO in  mListaUSUARIO
                    Try
                        Me.RecuperarForaneas(lEntidad)
