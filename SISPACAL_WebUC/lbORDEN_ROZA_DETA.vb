...
''' </history>
''' -----------------------------------------------------------------------------
<DefaultProperty("ID_ORDEN_DETA"), ToolboxData("<{0}:lbORDEN_ROZA_DETA runat=server></{0}:lbORDEN_ROZA_DETA>")> _
Public Class lbORDEN_ROZA_DETA
    Inherits lbBase

    ''' -----------------------------------------------------------------------------
    ''' <summary>
    ''' Función que Recupera el ListBox con los Datos de la Tabla ORDEN_ROZA_DETA.
    ''' </summary>
    ''' <remarks>
