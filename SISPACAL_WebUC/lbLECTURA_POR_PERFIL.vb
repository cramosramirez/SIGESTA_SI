...
''' Class	 : WebUC.lbLECTURA_POR_PERFIL
''' 
''' -----------------------------------------------------------------------------
''' <summary>
...
''' </history>
''' -----------------------------------------------------------------------------
<DefaultProperty("ID_LECTURA_PERFIL"), ToolboxData("<{0}:lbLECTURA_POR_PERFIL runat=server></{0}:lbLECTURA_POR_PERFIL>")> _
Public Class lbLECTURA_POR_PERFIL
    Inherits lbBase

    ''' -----------------------------------------------------------------------------
    ''' <summary>
    ''' Función que Recupera el ListBox con los Datos de la Tabla LECTURA_POR_PERFIL.
    ''' </summary>
    ''' <remarks>
