...
''' </history>
''' -----------------------------------------------------------------------------
<DefaultProperty("ACCESLOTE"), ToolboxData("<{0}:lbLOTES runat=server></{0}:lbLOTES>")> _
Public Class lbLOTES
    Inherits lbBase

    ''' -----------------------------------------------------------------------------
    ''' <summary>
    ''' Función que Recupera el ListBox con los Datos de la Tabla LOTES.
    ''' </summary>
    ''' <remarks>
