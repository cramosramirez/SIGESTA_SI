...
''' </history>
''' -----------------------------------------------------------------------------
<DefaultProperty("ID_TIPO_LECTURA"), ToolboxData("<{0}:lbTIPO_LECTURA runat=server></{0}:lbTIPO_LECTURA>")> _
Public Class lbTIPO_LECTURA
    Inherits lbBase

    ''' -----------------------------------------------------------------------------
    ''' <summary>
    ''' Función que Recupera el ListBox con los Datos de la Tabla TIPO_LECTURA.
    ''' </summary>
    ''' <remarks>
