...
''' </history>
''' -----------------------------------------------------------------------------
<DefaultProperty("ID_ENVIO"), ToolboxData("<{0}:lbENVIO runat=server></{0}:lbENVIO>")> _
Public Class lbENVIO
    Inherits lbBase

    ''' -----------------------------------------------------------------------------
    ''' <summary>
    ''' Función que Recupera el ListBox con los Datos de la Tabla ENVIO.
    ''' </summary>
    ''' <remarks>
