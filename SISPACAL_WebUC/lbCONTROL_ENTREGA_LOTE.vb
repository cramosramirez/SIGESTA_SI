...
''' Class	 : WebUC.lbCONTROL_ENTREGA_LOTE
''' 
''' -----------------------------------------------------------------------------
''' <summary>
...
''' </history>
''' -----------------------------------------------------------------------------
<DefaultProperty("ID_CTRL_ENTREGA_LOTE"), ToolboxData("<{0}:lbCONTROL_ENTREGA_LOTE runat=server></{0}:lbCONTROL_ENTREGA_LOTE>")> _
Public Class lbCONTROL_ENTREGA_LOTE
    Inherits lbBase

    ''' -----------------------------------------------------------------------------
    ''' <summary>
    ''' Función que Recupera el ListBox con los Datos de la Tabla CONTROL_ENTREGA_LOTE.
    ''' </summary>
    ''' <remarks>
