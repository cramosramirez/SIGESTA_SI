...
''' Class	 : WebUC.ddlCUENTA_PROVEEDOR
''' 
''' -----------------------------------------------------------------------------
''' <summary>
...
''' </history>
''' -----------------------------------------------------------------------------
<DefaultProperty("ID_CUENTA_PROVEEDOR"), ToolboxData("<{0}:ddlCUENTA_PROVEEDOR runat=server></{0}:ddlCUENTA_PROVEEDOR>")> _
Public Class ddlCUENTA_PROVEEDOR
    Inherits ddlBase
    ...
    ''' -----------------------------------------------------------------------------
    ''' <summary>
    ''' Función que Recupera el DropDownList con los Datos de la Tabla CUENTA_PROVEEDOR.
    ''' </summary>
    ''' <remarks>
