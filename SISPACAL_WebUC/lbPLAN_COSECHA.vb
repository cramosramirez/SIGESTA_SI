...
''' </history>
''' -----------------------------------------------------------------------------
<DefaultProperty("ID_PLAN_COSECHA"), ToolboxData("<{0}:lbPLAN_COSECHA runat=server></{0}:lbPLAN_COSECHA>")> _
Public Class lbPLAN_COSECHA
    Inherits lbBase

    ''' -----------------------------------------------------------------------------
    ''' <summary>
    ''' Función que Recupera el ListBox con los Datos de la Tabla PLAN_COSECHA.
    ''' </summary>
    ''' <remarks>
