...
''' Class	 : WebUC.ddlDESCUENTOS_PLANILLA
''' 
''' -----------------------------------------------------------------------------
''' <summary>
...
''' </history>
''' -----------------------------------------------------------------------------
<DefaultProperty("ID_DESCUENTO_PLANILLA"), ToolboxData("<{0}:ddlDESCUENTOS_PLANILLA runat=server></{0}:ddlDESCUENTOS_PLANILLA>")> _
Public Class ddlDESCUENTOS_PLANILLA
    Inherits ddlBase
    ...
    ''' -----------------------------------------------------------------------------
    ''' <summary>
    ''' Función que Recupera el DropDownList con los Datos de la Tabla DESCUENTOS_PLANILLA.
    ''' </summary>
    ''' <remarks>
