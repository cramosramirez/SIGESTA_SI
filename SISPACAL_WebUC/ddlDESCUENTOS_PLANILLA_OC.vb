...
''' Class	 : WebUC.ddlDESCUENTOS_PLANILLA_OC
''' 
''' -----------------------------------------------------------------------------
''' <summary>
...
''' </history>
''' -----------------------------------------------------------------------------
<DefaultProperty("ID_DESC_PLA_OC"), ToolboxData("<{0}:ddlDESCUENTOS_PLANILLA_OC runat=server></{0}:ddlDESCUENTOS_PLANILLA_OC>")> _
Public Class ddlDESCUENTOS_PLANILLA_OC
    Inherits ddlBase
    ...
    ''' -----------------------------------------------------------------------------
    ''' <summary>
    ''' Función que Recupera el DropDownList con los Datos de la Tabla DESCUENTOS_PLANILLA_OC.
    ''' </summary>
    ''' <remarks>
