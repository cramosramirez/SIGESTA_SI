...
''' Class	 : WebUC.ddlPLAN_ENTREGA_CANA
''' 
''' -----------------------------------------------------------------------------
''' <summary>
...
''' </history>
''' -----------------------------------------------------------------------------
<DefaultProperty("ID_PLAN_ENTREGA_CANA"), ToolboxData("<{0}:ddlPLAN_ENTREGA_CANA runat=server></{0}:ddlPLAN_ENTREGA_CANA>")> _
Public Class ddlPLAN_ENTREGA_CANA
    Inherits ddlBase
    ...
    ''' -----------------------------------------------------------------------------
    ''' <summary>
    ''' Función que Recupera el DropDownList con los Datos de la Tabla PLAN_ENTREGA_CANA.
    ''' </summary>
    ''' <remarks>
