...
''' </history>
''' -----------------------------------------------------------------------------
<DefaultProperty("ID_CHEQUE_PLANILLA"), ToolboxData("<{0}:lbCHEQUE_PLANILLA runat=server></{0}:lbCHEQUE_PLANILLA>")> _
Public Class lbCHEQUE_PLANILLA
    Inherits lbBase

    ''' -----------------------------------------------------------------------------
    ''' <summary>
    ''' Función que Recupera el ListBox con los Datos de la Tabla CHEQUE_PLANILLA.
    ''' </summary>
    ''' <remarks>
