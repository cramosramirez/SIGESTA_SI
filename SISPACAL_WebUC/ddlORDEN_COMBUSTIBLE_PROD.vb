...
''' Class	 : WebUC.ddlORDEN_COMBUSTIBLE_PROD
''' 
''' -----------------------------------------------------------------------------
''' <summary>
...
''' </history>
''' -----------------------------------------------------------------------------
<DefaultProperty("ID_ORDEN_COMBUSTIBLE_PROD"), ToolboxData("<{0}:ddlORDEN_COMBUSTIBLE_PROD runat=server></{0}:ddlORDEN_COMBUSTIBLE_PROD>")> _
Public Class ddlORDEN_COMBUSTIBLE_PROD
    Inherits ddlBase
    ...
    ''' -----------------------------------------------------------------------------
    ''' <summary>
    ''' Función que Recupera el DropDownList con los Datos de la Tabla ORDEN_COMBUSTIBLE_PROD.
    ''' </summary>
    ''' <remarks>
