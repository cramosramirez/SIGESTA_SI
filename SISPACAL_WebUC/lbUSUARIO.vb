...
''' </history>
''' -----------------------------------------------------------------------------
<DefaultProperty("USUARIO"), ToolboxData("<{0}:lbUSUARIO runat=server></{0}:lbUSUARIO>")> _
Public Class lbUSUARIO
    Inherits lbBase

    ''' -----------------------------------------------------------------------------
    ''' <summary>
    ''' Función que Recupera el ListBox con los Datos de la Tabla USUARIO.
    ''' </summary>
    ''' <remarks>
