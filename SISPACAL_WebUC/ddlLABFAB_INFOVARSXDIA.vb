...
''' Class	 : WebUC.ddlLABFAB_INFOVARSXDIA
''' 
''' -----------------------------------------------------------------------------
''' <summary>
...
''' </history>
''' -----------------------------------------------------------------------------
<DefaultProperty("ID_INFOVARSXDIA"), ToolboxData("<{0}:ddlLABFAB_INFOVARSXDIA runat=server></{0}:ddlLABFAB_INFOVARSXDIA>")> _
Public Class ddlLABFAB_INFOVARSXDIA
    Inherits ddlBase
    ...
    ''' -----------------------------------------------------------------------------
    ''' <summary>
    ''' Función que Recupera el DropDownList con los Datos de la Tabla LABFAB_INFOVARSXDIA.
    ''' </summary>
    ''' <remarks>
