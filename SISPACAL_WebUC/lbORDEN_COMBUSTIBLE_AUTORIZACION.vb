...
''' Class	 : WebUC.lbORDEN_COMBUSTIBLE_AUTORIZACION
''' 
''' -----------------------------------------------------------------------------
''' <summary>
...
''' </history>
''' -----------------------------------------------------------------------------
<DefaultProperty("ID_ORDEN_COMBUS_AUTO"), ToolboxData("<{0}:lbORDEN_COMBUSTIBLE_AUTORIZACION runat=server></{0}:lbORDEN_COMBUSTIBLE_AUTORIZACION>")> _
Public Class lbORDEN_COMBUSTIBLE_AUTORIZACION
    Inherits lbBase

    ''' -----------------------------------------------------------------------------
    ''' <summary>
    ''' Función que Recupera el ListBox con los Datos de la Tabla ORDEN_COMBUSTIBLE_AUTORIZACION.
    ''' </summary>
    ''' <remarks>
