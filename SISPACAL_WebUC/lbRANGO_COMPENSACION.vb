...
''' Class	 : WebUC.lbRANGO_COMPENSACION
''' 
''' -----------------------------------------------------------------------------
''' <summary>
...
''' </history>
''' -----------------------------------------------------------------------------
<DefaultProperty("ID_RANGO_COMPE"), ToolboxData("<{0}:lbRANGO_COMPENSACION runat=server></{0}:lbRANGO_COMPENSACION>")> _
Public Class lbRANGO_COMPENSACION
    Inherits lbBase

    ''' -----------------------------------------------------------------------------
    ''' <summary>
    ''' Función que Recupera el ListBox con los Datos de la Tabla RANGO_COMPENSACION.
    ''' </summary>
    ''' <remarks>
