...
''' </history>
''' -----------------------------------------------------------------------------
<DefaultProperty("ID_ORDEN"), ToolboxData("<{0}:lbORDEN_ROZA_ENCA runat=server></{0}:lbORDEN_ROZA_ENCA>")> _
Public Class lbORDEN_ROZA_ENCA
    Inherits lbBase

    ''' -----------------------------------------------------------------------------
    ''' <summary>
    ''' Función que Recupera el ListBox con los Datos de la Tabla ORDEN_ROZA_ENCA.
    ''' </summary>
    ''' <remarks>
