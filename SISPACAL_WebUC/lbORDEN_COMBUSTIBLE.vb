...
''' Class	 : WebUC.lbORDEN_COMBUSTIBLE
''' 
''' -----------------------------------------------------------------------------
''' <summary>
...
''' </history>
''' -----------------------------------------------------------------------------
<DefaultProperty("ID_ORDEN_COMBUS"), ToolboxData("<{0}:lbORDEN_COMBUSTIBLE runat=server></{0}:lbORDEN_COMBUSTIBLE>")> _
Public Class lbORDEN_COMBUSTIBLE
    Inherits lbBase

    ''' -----------------------------------------------------------------------------
    ''' <summary>
    ''' Función que Recupera el ListBox con los Datos de la Tabla ORDEN_COMBUSTIBLE.
    ''' </summary>
    ''' <remarks>
