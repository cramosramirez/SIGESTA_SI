...
''' </history>
''' -----------------------------------------------------------------------------
<DefaultProperty("ID_PLAN_CATORCENA"), ToolboxData("<{0}:lbPLAN_CATORCENA runat=server></{0}:lbPLAN_CATORCENA>")> _
Public Class lbPLAN_CATORCENA
    Inherits lbBase

    ''' -----------------------------------------------------------------------------
    ''' <summary>
    ''' Función que Recupera el ListBox con los Datos de la Tabla PLAN_CATORCENA.
    ''' </summary>
    ''' <remarks>
