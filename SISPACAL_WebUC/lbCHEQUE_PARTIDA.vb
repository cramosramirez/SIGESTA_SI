...
''' </history>
''' -----------------------------------------------------------------------------
<DefaultProperty("ID_CHEQUE_PARTIDA"), ToolboxData("<{0}:lbCHEQUE_PARTIDA runat=server></{0}:lbCHEQUE_PARTIDA>")> _
Public Class lbCHEQUE_PARTIDA
    Inherits lbBase

    ''' -----------------------------------------------------------------------------
    ''' <summary>
    ''' Función que Recupera el ListBox con los Datos de la Tabla CHEQUE_PARTIDA.
    ''' </summary>
    ''' <remarks>
