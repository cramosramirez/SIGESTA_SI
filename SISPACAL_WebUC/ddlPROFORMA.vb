...
''' </history>
''' -----------------------------------------------------------------------------
<DefaultProperty("ID_PROFORMA"), ToolboxData("<{0}:ddlPROFORMA runat=server></{0}:ddlPROFORMA>")> _
Public Class ddlPROFORMA
    Inherits ddlBase
    ...
    ''' -----------------------------------------------------------------------------
    ''' <summary>
    ''' Función que Recupera el DropDownList con los Datos de la Tabla PROFORMA.
    ''' </summary>
    ''' <remarks>
