...
''' Class	 : WebUC.ddlCARGADORA_ASIGNADA
''' 
''' -----------------------------------------------------------------------------
''' <summary>
...
''' </history>
''' -----------------------------------------------------------------------------
<DefaultProperty("ID_CARGADORA_ASIG"), ToolboxData("<{0}:ddlCARGADORA_ASIGNADA runat=server></{0}:ddlCARGADORA_ASIGNADA>")> _
Public Class ddlCARGADORA_ASIGNADA
    Inherits ddlBase
    ...
    ''' -----------------------------------------------------------------------------
    ''' <summary>
    ''' Función que Recupera el DropDownList con los Datos de la Tabla CARGADORA_ASIGNADA.
    ''' </summary>
    ''' <remarks>
