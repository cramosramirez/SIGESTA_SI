...
''' Class	 : WebUC.ddlDISTRIBUCION_DESCTO
''' 
''' -----------------------------------------------------------------------------
''' <summary>
...
''' </history>
''' -----------------------------------------------------------------------------
<DefaultProperty("ID_DISTRIB_DESCTO"), ToolboxData("<{0}:ddlDISTRIBUCION_DESCTO runat=server></{0}:ddlDISTRIBUCION_DESCTO>")> _
Public Class ddlDISTRIBUCION_DESCTO
    Inherits ddlBase
    ...
    ''' -----------------------------------------------------------------------------
    ''' <summary>
    ''' Función que Recupera el DropDownList con los Datos de la Tabla DISTRIBUCION_DESCTO.
    ''' </summary>
    ''' <remarks>
