...
Partial Public Class dbLOTES
    ...
    Public Function ObtenerDataSetIngresoCenso(ByVal NOMBRE_ZAFRA As String, ByVal ZONA As String, ByVal ID_PLAN_SEMANAL As Integer, ByVal CODIPROVEE As String, _
                                               ByVal CODISOCIO As String, ByVal NOMBRE_PROVEEDOR As String, ByVal INCLUIR_LOTES_NO_PROGRAMADOS As Boolean, _
                                               Optional ByVal asColumnaOrden As String = "", Optional ByVal asTipoOrden As String = "ASC") As DataSet
        Dim args As New List(Of SqlParameter)
        Dim arg As SqlParameter
    ...
    Public Function ObtenerListaPorCriterios(ByVal NOMBRE_ZAFRA As String, ByVal ZONA As String, ByVal ID_PLAN_SEMANAL As Integer, ByVal CODIPROVEE As String, _
        ...
        Dim strCondicion As New StringBuilder
        Dim tieneWhere As Boolean = False
        Dim aEntidad As LOTES
        Dim listadoLotes As New listaLOTES
        strSQL.Append("     SELECT LOTES.*, PROVEEDOR.CODIPROVEE, PROVEEDOR.CODISOCIO, PROVEEDOR.NOMBRES + ' ' + PROVEEDOR.APELLIDOS AS PROVEEDOR, LOTES.NOMBLOTE ")
        strSQL.Append("     FROM PROVEEDOR INNER JOIN ")
        strSQL.Append("     LOTES ON PROVEEDOR.CODIPROVEEDOR = LOTES.CODIPROVEEDOR ")
        ...
        If ZONA IsNot Nothing AndAlso ZONA.Trim <> "" Then
            ...
            arg.Value = ZONA.Trim
            args.Add(arg)
            AgregarCondicion(strCondicion, " LOTES.ZONA = @ZONA ")
        End If
        If CODIPROVEE IsNot Nothing AndAlso CODIPROVEE <> "" Then
            arg = New SqlParameter("@CODIPROVEE", SqlDbType.VarChar)
            arg.Value = Utilerias.RellenarIzquierda(CODIPROVEE, 6)
    ...
    Public Function AsignarAgronomo(ByVal OPCION As String, ByVal ID_ZAFRA As Integer, ByVal ZONA As String, ByVal ACCESLOTE As String, ByVal CODIAGRON As String, ByVal USUARIO As String) As Integer
        ...
        Try
            lRet = SqlHelper.ExecuteNonQuery(Me.cnnStr, CommandType.StoredProcedure, "ASIGNACION_TECNICO_A_LOTES", args.ToArray)
    ...
    Public Function ObtenerListaPorZAFRA_NO_CONTRATO(ByVal ID_ZAFRA As Int32, ByVal NO_CONTRATO As Int32, Optional ByVal asColumnaOrden As String = "C.NO_CONTRATO, L.CODILOTE", Optional ByVal asTipoOrden As String = "ASC") As listaLOTES
        Dim args As New List(Of SqlParameter)
        Dim arg As SqlParameter
        Dim strSQL As New StringBuilder
    ...
    Public Function ObtenerListaPorZAFRA_CONTRATADA_PROVEEDOR_CONTRATADO(ByVal ID_ZAFRA As Int32, ByVal CODIPROVEEDOR As String, ByVal CODIAGRON As String, Optional ByVal asColumnaOrden As String = "L.CODIPROVEEDOR, L.CODILOTE", Optional ByVal asTipoOrden As String = "ASC") As listaLOTES
        Dim args As New List(Of SqlParameter)
        Dim arg As SqlParameter
        Dim strSQL As New StringBuilder
        strSQL.Append("SELECT L.* FROM LOTES L, CONTRATO C, CONTRATO_ZAFRAS CZ ")
    ...
    Public Function ObtenerListaPorZAFRA_CONTRATADA_PROVEEDOR(ByVal ID_ZAFRA As Int32, ByVal CODIPROVEEDOR As String, ByVal CODIAGRON As String, Optional ByVal asColumnaOrden As String = "L.CODIPROVEEDOR, L.CODILOTE", Optional ByVal asTipoOrden As String = "ASC") As listaLOTES
        Dim args As New List(Of SqlParameter)
        Dim arg As SqlParameter
        Dim strSQL As New StringBuilder
        strSQL.Append("SELECT L.* FROM LOTES L, CONTRATO C, CONTRATO_ZAFRAS CZ ")
    ...
    Public Function ObtenerListaPorZAFRA_MAESTRO_LOTES(ByVal ID_ZAFRA As Integer, ByVal ID_MAESTRO As Int32, Optional CODICONTRATO_NOINCLUIR As String = "") As listaLOTES
        ...
        Dim arg As SqlParameter
        Dim strSQL As New StringBuilder
        strSQL.Append(" SELECT L.* FROM LOTES L ")
        strSQL.Append(" WHERE L.ID_MAESTRO = @ID_MAESTRO ")
        strSQL.Append(" AND EXISTS(SELECT 1 FROM LOTES_COSECHA LC WHERE LC.ACCESLOTE = L.ACCESLOTE AND LC.ID_ZAFRA = @ID_ZAFRA) ")
