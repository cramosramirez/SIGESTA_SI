...
Public Class frmCapturaZafraBRIX_POL
    ...
    Private archivoLog As String = ConfigurationManager.AppSettings("ARCHIVO_LOG_ZAFRA")
    ...
    Private Sub frmCapturaZafraPOL_BRIX_Closed(sender As Object, e As EventArgs) Handles Me.Closed
    ...
    Private Sub txtTACO_Validating(sender As Object, e As CancelEventArgs) Handles txtTACO.Validating
        ...
        If Envios IsNot Nothing AndAlso Envios.Count > 0 Then
            ...
            If esCapturaPolBrixSimultanea Then
                ...
                End If
            Else
                If entidadAnalisis.BRIX = -1 Then
            ...
            If entidadAnalisis.BAGAZO_BRUTO = -1 OrElse entidadAnalisis.BAGAZO_NETO = -1 Then
                MsgBox("Capture el peso del bagazo antes de capturar POL/BRIX", MsgBoxStyle.Critical, Application.ProductName)
                Return
            End If
            If entidadAnalisis.POL <> -1 AndAlso entidadAnalisis.BRIX <> -1 Then
                log.crea_archivo(archivoLog, "btnLeerPuerto_Click", "El BRIX/POL han sido capturados No. boleta: " + txtTACO.Text + " BRIX: " + entidadAnalisis.BRIX.ToString + " POL: " + entidadAnalisis.POL.ToString, Direccion.Output, "")
        ...
        Else
            log.crea_archivo(archivoLog, "btnLeerPuerto_Click", "El N° de boleta de Análisis " + txtTACO.Text + " no existe para esta Zafra", Direccion.Output, "")
            MsgBox("El N° de boleta de Análisis " + txtTACO.Text + " no existe para esta Zafra", MsgBoxStyle.Critical, Application.ProductName)
            txtTACO.Text = String.Empty
            e.Cancel = True
        End If
    End Sub
    ...
    Private Sub btnGuardar_Click(sender As Object, e As EventArgs) Handles btnGuardar.Click
        ...
        Else
            MsgBox("Error al guardar captura: " + bAnalisis.sError, MsgBoxStyle.Critical, Application.ProductName)
        End If
    End Sub
