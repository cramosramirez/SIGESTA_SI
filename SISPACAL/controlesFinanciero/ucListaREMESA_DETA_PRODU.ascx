<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ucListaREMESA_DETA_PRODU.ascx.vb" Inherits="controles_ucListaREMESA_DETA_PRODU" %>
...
<script type="text/javascript">
    ...
    function OnEndCallbackGrid(s, e) {
        cpMantREMESA_ENCA_PRODU.PerformCallback('');
    }
</script>
...
<asp:ObjectDataSource ID="odsREMESA_DETA_PRODUcache" runat="server" TypeName="cREMESA_DETA_PRODUcache"     
    SelectMethod="ObtenerLista" UpdateMethod="Actualizar">       
     <SelectParameters>             
        <asp:Parameter Name="nombreSesion_ucListaREMESA_DETA_PRODU" Type="String" />
     </SelectParameters>     
     <UpdateParameters>    
...
<asp:ObjectDataSource ID="odsLista" runat="server" 
    SelectMethod="ObtenerLista" InsertMethod="AgregarREMESA_DETA_PRODU" DeleteMethod="EliminarREMESA_DETA_PRODU" UpdateMethod="ActualizarREMESA_DETA_PRODU"
    TypeName="SISPACAL.BL.cREMESA_DETA_PRODU">
    <SelectParameters>
...
<asp:ObjectDataSource ID="odsListaPorREMESA_ENCA_PRODU" runat="server" 
    SelectMethod="ObtenerListaPorREMESA_ENCA_PRODU" InsertMethod="AgregarREMESA_DETA_PRODU" DeleteMethod="EliminarREMESA_DETA_PRODU" UpdateMethod="ActualizarREMESA_DETA_PRODU"
    TypeName="SISPACAL.BL.cREMESA_DETA_PRODU">
    <SelectParameters>
        <asp:Parameter Name="ID_REMESA_ENCA" Type="Int32" />
        <asp:Parameter DefaultValue="False" Name="recuperarForaneas" Type="Boolean" />
...
<asp:ObjectDataSource ID="odsListaPorCREDITO_ENCA" runat="server" 
    SelectMethod="ObtenerListaPorCREDITO_ENCA" InsertMethod="AgregarREMESA_DETA_PRODU" DeleteMethod="EliminarREMESA_DETA_PRODU" UpdateMethod="ActualizarREMESA_DETA_PRODU"
    TypeName="SISPACAL.BL.cREMESA_DETA_PRODU">
    <SelectParameters>
        <asp:Parameter Name="ID_CREDITO_ENCA" Type="Int32" />
        <asp:Parameter DefaultValue="False" Name="recuperarForaneas" Type="Boolean" />
