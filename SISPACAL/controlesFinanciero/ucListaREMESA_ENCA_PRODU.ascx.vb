...
''' -----------------------------------------------------------------------------
''' Project	 : SISPACAL
''' Class	 : ucListaREMESA_ENCA_PRODU
''' 
''' -----------------------------------------------------------------------------
''' <summary>
''' Clase del Control de Usuario para mostrar un listado de la tabla REMESA_ENCA_PRODU
''' </summary>
''' <remarks>
...
''' </history>
''' -----------------------------------------------------------------------------
Partial Class controles_ucListaREMESA_ENCA_PRODU
...
#End Region
    ...
    Public Function DevolverSeleccionados() As listaREMESA_ENCA_PRODU
        Dim mLista As New listaREMESA_ENCA_PRODU
    ...
    Protected Sub dxgvLista_CustomButtonCallback(ByVal sender As Object, ByVal e As DevExpress.Web.ASPxGridViewCustomButtonCallbackEventArgs) Handles dxgvLista.CustomButtonCallback
        If e.ButtonID = "btnEliminar" Then
            Dim lEntidad As REMESA_ENCA_PRODU = CType(Me.dxgvLista.GetRow(e.VisibleIndex), REMESA_ENCA_PRODU)

            If Me.mComponente.EliminarREMESA_ENCA_PRODU(lEntidad.ID_REMESA_ENCA) <> 1 Then
    ...
    Protected Sub dxgvLista_CustomUnboundColumnData(sender As Object, e As DevExpress.Web.ASPxGridViewColumnDataEventArgs) Handles dxgvLista.CustomUnboundColumnData
        If e.Column.FieldName = "NOMBRE_PROVEEDOR" AndAlso e.GetListSourceFieldValue("CODIPROVEEDOR") <> "" Then
        ...
        ElseIf e.Column.FieldName = "ZAFRA" Then
            Dim lstDeta As listaREMESA_DETA_PRODU = (New cREMESA_DETA_PRODU).ObtenerListaPorREMESA_ENCA_PRODU(e.GetListSourceFieldValue("ID_REMESA_ENCA"))
            If lstDeta IsNot Nothing AndAlso lstDeta.Count > 0 Then
                Dim lEnca As CREDITO_ENCA = (New cCREDITO_ENCA).ObtenerCREDITO_ENCA(lstDeta(0).ID_CREDITO_ENCA)
