...
''' -----------------------------------------------------------------------------
''' Project	 : SISPACAL
''' Class	 : ucListaCONTRATO_CTAS_MOVTOS
''' 
''' -----------------------------------------------------------------------------
''' <summary>
''' Clase del Control de Usuario para mostrar un listado de la tabla CONTRATO_CTAS_MOVTOS
''' </summary>
''' <remarks>
...
''' </history>
''' -----------------------------------------------------------------------------
Partial Class controles_ucListaCONTRATO_CTAS_MOVTOS
    Inherits ucListaBase
 
    Private mComponente As New cCONTRATO_CTAS_MOVTOS
    Public Event Seleccionado(ByVal ID_CONTRATO_CTAS_MOVTOS As Int32) 
    Public Event Editando(ByVal ID_CONTRATO_CTAS_MOVTOS As Int32) 
...
#Region"Propiedades"
    ...
    Public Property VerID_CONTRATO_CTAS_MOVTOS() As Boolean
        Get
            Return Me.dxgvLista.Columns("ID_CONTRATO_CTAS_MOVTOS").Visible
        End Get
        Set(ByVal Value As Boolean)
            Me.dxgvLista.Columns("ID_CONTRATO_CTAS_MOVTOS").Visible = Value
        End Set
    End Property
    ...
    Public Property VerSALDO_INI() As Boolean
        Get
            Return Me.dxgvLista.Columns("SALDO_INI").Visible
        End Get
        Set(ByVal Value As Boolean)
            Me.dxgvLista.Columns("SALDO_INI").Visible = Value
        End Set
    End Property
    ...
    Public Property VerSALDO_FIN() As Boolean
        Get
            Return Me.dxgvLista.Columns("SALDO_FIN").Visible
        End Get
        Set(ByVal Value As Boolean)
            Me.dxgvLista.Columns("SALDO_FIN").Visible = Value
        End Set
    End Property
    ...
    Public Property VerUID_PLANILLA() As Boolean
        Get
            Return Me.dxgvLista.Columns("UID_PLANILLA").Visible
        End Get
        Set(ByVal Value As Boolean)
            Me.dxgvLista.Columns("UID_PLANILLA").Visible = Value
        End Set
    End Property
    ...
    Public Property HeaderID_CONTRATO_CTAS_MOVTOS() As String
        Get
            Return Me.dxgvLista.Columns("ID_CONTRATO_CTAS_MOVTOS").Caption
        End Get
        Set(ByVal Value As String)
            Me.dxgvLista.Columns("ID_CONTRATO_CTAS_MOVTOS").Caption = Value
        End Set
    End Property
    ...
    Public Property HeaderSALDO_INI() As String
        Get
            Return Me.dxgvLista.Columns("SALDO_INI").Caption
        End Get
        Set(ByVal Value As String)
            Me.dxgvLista.Columns("SALDO_INI").Caption = Value
        End Set
    End Property
    ...
    Public Property HeaderSALDO_FIN() As String
        Get
            Return Me.dxgvLista.Columns("SALDO_FIN").Caption
        End Get
        Set(ByVal Value As String)
            Me.dxgvLista.Columns("SALDO_FIN").Caption = Value
        End Set
    End Property
    ...
    Public Property HeaderUID_PLANILLA() As String
        Get
            Return Me.dxgvLista.Columns("UID_PLANILLA").Caption
        End Get
        Set(ByVal Value As String)
            Me.dxgvLista.Columns("UID_PLANILLA").Caption = Value
        End Set
    End Property
...
#End Region
    ...
    ''' -----------------------------------------------------------------------------
    ''' <summary>
    ''' FunciÃ³n que Carga la informaciÃ³n de los registros de la tabla CONTRATO_CTAS_MOVTOS
    ''' </summary>
    ''' <remarks>
    ''' </remarks>
    ''' <history>
    ...
    ''' <summary>
    ''' FunciÃ³n que Carga la informaciÃ³n de los registros de la tabla CONTRATO_CTAS_MOVTOS
    ''' filtrado por la tabla CONTRATO_CTAS
    ''' </summary>
    ...
    ''' </history>
    ''' -----------------------------------------------------------------------------
    Public Function CargarDatosPorCONTRATO_CTAS(ByVal ID_CONTRATO_CTAS As Int32) As Integer
        Me.odsListaPorCONTRATO_CTAS.SelectParameters("ID_CONTRATO_CTAS").DefaultValue = ID_CONTRATO_CTAS.ToString()
        Me.odsListaPorCONTRATO_CTAS.SelectParameters("recuperarForaneas").DefaultValue = "False"
        Me.odsListaPorCONTRATO_CTAS.SelectParameters("asColumnaOrden").DefaultValue = ""
        Me.odsListaPorCONTRATO_CTAS.SelectParameters("asTipoOrden").DefaultValue = ""
        Me.odsListaPorCONTRATO_CTAS.DataBind()
        Me.dxgvLista.DataSourceID = "odsListaPorCONTRATO_CTAS"
        Me.dxgvLista.Selection.UnselectAll()
        Me.dxgvLista.Visible = True
        Me.dxgvLista.DataBind()
        Return 1
    ...
    Protected Sub dxgvLista_CustomJSProperties(ByVal sender As Object, ByVal e As DevExpress.Web.ASPxGridViewClientJSPropertiesEventArgs) Handles dxgvLista.CustomJSProperties
        If Me.PermitirSeleccionParaCombo Then
            ...
            For i As Integer = 0 To grid.VisibleRowCount - 1
                keyValues(i) = grid.GetRowValues(i, "ID_CONTRATO_CTAS_MOVTOS")
                keyNames(i) = grid.GetRowValues(i, "ID_CONTRATO_CTAS")
            Next i
    ...
    Public Function DevolverSeleccionados() As listaCONTRATO_CTAS_MOVTOS
        Dim mLista As New listaCONTRATO_CTAS_MOVTOS
        For Each llave As Decimal In Me.dxgvLista.GetSelectedFieldValues("ID_CONTRATO_CTAS_MOVTOS")
            Dim lEntidad As New CONTRATO_CTAS_MOVTOS
            lEntidad.ID_CONTRATO_CTAS_MOVTOS = llave
            mLista.Add(lEntidad)
        Next
        Return mLista
    End Function
    ...
    Protected Sub dxgvLista_CustomButtonCallback(ByVal sender As Object, ByVal e As DevExpress.Web.ASPxGridViewCustomButtonCallbackEventArgs) Handles dxgvLista.CustomButtonCallback
        If e.ButtonID = "btnEliminar" Then
            Dim lEntidad As CONTRATO_CTAS_MOVTOS = CType(Me.dxgvLista.GetRow(e.VisibleIndex), CONTRATO_CTAS_MOVTOS)

            If Me.mComponente.EliminarCONTRATO_CTAS_MOVTOS(lEntidad.ID_CONTRATO_CTAS_MOVTOS) <> 1 Then
