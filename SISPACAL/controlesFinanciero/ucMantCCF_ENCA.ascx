<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ucMantCCF_ENCA.ascx.vb" Inherits="controles_ucMantCCF_ENCA" %>
<%@ Register TagPrefix="uc1" TagName="ucBarraNavegacion" Src="~/controles/ucBarraNavegacion.ascx" %>
<%@ Register TagPrefix="uc1" TagName="ucListaCCF_ENCA" Src="~/controlesFinanciero/ucListaCCF_ENCA.ascx" %>
<%@ Register TagPrefix="uc1" TagName="ucVistaDetalleCCF_ENCA" Src="~/controlesFinanciero/ucVistaDetalleCCF_ENCA.ascx" %>
                ...
                <TBODY>
	                   ...
	                   <TR>
                        <TD><uc1:ucListaCCF_ENCA id="ucListaCCF_ENCA1" runat="server"></uc1:ucListaCCF_ENCA>
                            <uc1:ucVistaDetalleCCF_ENCA ID="ucVistaDetalleCCF_ENCA1" runat="server" Visible="false" ></uc1:ucVistaDetalleCCF_ENCA></TD>
                    </TR>
                </TBODY>
            </TABLE>
    </dx:PanelContent>
