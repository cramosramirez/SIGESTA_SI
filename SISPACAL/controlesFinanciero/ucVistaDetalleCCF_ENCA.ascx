<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ucVistaDetalleCCF_ENCA.ascx.vb" Inherits="controles_ucVistaDetalleCCF_ENCA" %>
                                    ...
                                    <dx:LayoutItemNestedControlContainer ID="LayoutItemNestedControlContainer1" runat="server">
                                        ...
                                        <table>
                                            ...
                                            <tr>
                                                ...
                                                <td><dx:ASPxLabel id="ASPxLabel25" runat="server" Text="N° Orden:" /></td>
                                                <td>
                                                    <dx:ASPxComboBox ID="cbxORDEN_COMPRA" runat="server" AutoPostBack="true" HorizontalAlign="Right" ValueField="ID_ORDEN" TextField="CODI_ORDEN" ValueType="System.Int32" Width="120px" DropDownStyle="DropDownList">                                                               
                                                    <DisabledStyle BackColor="WhiteSmoke" ForeColor="Black" ></DisabledStyle>
                                                    </dx:ASPxComboBox>
                                                </td>
                                            </tr>       
                                            <tr>
                                                ...
                                                <th colspan="3" >
                                                    <dx:ASPxComboBox ID="cbxPROVEEDOR_AGRICOLA" runat="server" ValueType="System.Int32" DataSourceID="odsProveedorAgricola" ValueField="ID_PROVEE" TextField="NOMBRE" Width="100%" >                                                    
                                                        <DisabledStyle BackColor="WhiteSmoke" ForeColor="Black"></DisabledStyle>
                                                    </dx:ASPxComboBox>
                                                </th> 
                                                <td></td> 
                                            ...
                                            <tr id="trGIRO" runat="server" visible="false">
    ...
    <tr>
        <td align="center">
            <table>
                ...
                <tr>
                    <th colspan="6" >
                        <uc1:ucListaCCF_DETA id="ucListaCCF_DETA1" PermitirFiltroEnEncabezado="false" PermitirFilaDeFiltro="false" PermitirEditarInline="true" PermitirEliminarInline="true" PermitirEliminar="true"  runat="server"></uc1:ucListaCCF_DETA>                                    
                    </th>                                            
                </tr>
		        <tr>
                    <th colspan="6" align="right">                        
                        <table>
                            ...
                            <tr id="trFOVIAL_COTRANS" runat="server">                                 
                                <td></td>
                                <td></td>
                                <td><dx:ASPxLabel ID="ASPxLabel27" runat="server" Text="FOVIAL + COTRANS" /></td> 
                                <td>
                                    <dx:ASPxSpinEdit ID="speFOVIAL_COTRANS" runat="server" DisplayFormatString="#,##0.00" Width="120px" ClientEnabled="false" HorizontalAlign="Right" >	
                                        <SpinButtons ShowIncrementButtons="False"></SpinButtons>
                                        <DisabledStyle BackColor="WhiteSmoke" ForeColor="Black"></DisabledStyle>
                                    </dx:ASPxSpinEdit>
                                </td>   
