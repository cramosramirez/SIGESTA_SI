<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ucVistaDetalleREMESA_ENCA_PRODU.ascx.vb" Inherits="controles_ucVistaDetalleREMESA_ENCA_PRODU" %>
<%@ Register assembly="DevExpress.Web.v14.2, Version=14.2.4.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" namespace="DevExpress.Web" tagprefix="dx" %>
<%@ Register tagprefix="uc1" tagname="ucListaREMESA_DETA_PRODU" Src="~/controlesFinanciero/ucListaREMESA_DETA_PRODU.ascx" %>

<table width="100%" >
    <tr>
        <td align="center">
            <dx:ASPxFormLayout ID="ucVistaDetalleREMESA_ENCA_PRODULayout" ClientInstanceName="ucVistaDetalleREMESA_ENCA_PRODULayout" runat="server" Width="100%">
                <Items>
                                    ...
                                    <dx:LayoutItemNestedControlContainer ID="LayoutItemNestedControlContainer1" runat="server">
                                        ...
                                        <table>
                                            <tr id="trId" runat="server" visible="false">
                                             ...
                                             <tr>
                                                ...
                                                <td>
                                                    <dx:ASPxSpinEdit ID="speCODIPROVEE" AutoPostBack="true" runat="server" Width="150px" NumberType="Integer">			                                            
                                                        <DisabledStyle BackColor="WhiteSmoke" ForeColor="Black"></DisabledStyle>
                                                        <SpinButtons ShowIncrementButtons="false" /> 
			                                        </dx:ASPxSpinEdit>                                                    
                                                </td>
                                                <td><dx:ASPxLabel id="ASPxLabel7" runat="server" Text="Productor:" /></td>
                                                <th colspan="2" ><dx:ASPxTextBox id="txtNOMBRE_PROVEEDOR" runat="server" Width="300px" >
                                                                    <DisabledStyle BackColor="WhiteSmoke" ForeColor="Black"></DisabledStyle>
                                                                 </dx:ASPxTextBox>
                                                </th>
                                            </tr>   
                                        ...
                                        <center>
                                            <table>  
                                                <tr>
                                                    <td align="center">
                                                        <uc1:ucListaREMESA_DETA_PRODU id="ucListaREMESA_DETA_PRODU1" PermitirFiltroEnEncabezado="false" PermitirFilaDeFiltro="false" PermitirEditarInline="true" PermitirEliminarInline="false" PermitirEliminar="false"  runat="server"></uc1:ucListaREMESA_DETA_PRODU>                                    
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td align="right">
