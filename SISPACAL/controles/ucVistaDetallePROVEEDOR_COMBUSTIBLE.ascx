<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ucVistaDetallePROVEEDOR_COMBUSTIBLE.ascx.vb" Inherits="controles_ucVistaDetallePROVEEDOR_COMBUSTIBLE" %>
<TABLE id="VistaDetalle" cellSpacing="0" cellPadding="0" width="100%" border="0">
	<TR runat="server" id="trID_PROVEEDOR_COMBUS">
		<TD width="10"></TD>
		<TD align="right">
			<asp:Label CssClass="Normal" id="lblID_PROVEEDOR_COMBUS" runat="server">Id proveedor combus:</asp:label></TD>
		<TD>
			<asp:TextBox CssClass="TextoLlaveDerecha" id="txtID_PROVEEDOR_COMBUS" runat="server" ReadOnly="True" Width="70px"></asp:textbox></TD>
		<TD width="10"></TD>
	</TR>
	<TR runat="server" id="trNOMBRE_PROVEEDOR_COMBUS">
		<TD width="10"></TD>
		<TD align="right">
			<asp:Label CssClass="Normal" id="lblNOMBRE_PROVEEDOR_COMBUS" runat="server">Nombre proveedor combus:</asp:label></TD>
		<TD>
			<asp:TextBox CssClass="TextoNormalIzquierda" id="txtNOMBRE_PROVEEDOR_COMBUS" runat="server" Width="100px" MaxLength="200"></asp:TextBox><asp:RequiredFieldValidator id="rfvNOMBRE_PROVEEDOR_COMBUS" runat="server" Display="Dynamic" ControlToValidate="txtNOMBRE_PROVEEDOR_COMBUS" ErrorMessage="Nombre proveedor combus es Requerido"></asp:RequiredFieldValidator>
</TD>
		<TD width="10"></TD>
	</TR>
