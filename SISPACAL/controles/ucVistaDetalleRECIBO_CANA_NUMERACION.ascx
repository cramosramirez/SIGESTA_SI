<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ucVistaDetalleRECIBO_CANA_NUMERACION.ascx.vb" Inherits="controles_ucVistaDetalleRECIBO_CANA_NUMERACION" %>
<TABLE id="VistaDetalle" cellSpacing="0" cellPadding="0" width="100%" border="0">
	<TR runat="server" id="trID_RECIBO_CANA_NUM">
		<TD width="10"></TD>
		<TD align="right">
			<asp:Label CssClass="Normal" id="lblID_RECIBO_CANA_NUM" runat="server">Id recibo cana num:</asp:label></TD>
		<TD>
			<asp:TextBox CssClass="TextoLlaveDerecha" id="txtID_RECIBO_CANA_NUM" runat="server" ReadOnly="True" Width="70px"></asp:textbox></TD>
		<TD width="10"></TD>
	</TR>
	<TR runat="server" id="trNUM_INICIAL">
		<TD width="10"></TD>
		<TD align="right">
			<asp:Label CssClass="Normal" id="lblNUM_INICIAL" runat="server">Num inicial:</asp:label></TD>
		<TD>
			<asp:TextBox CssClass="TextoNormalDerecha" id="txtNUM_INICIAL" runat="server" Width="100px"></asp:TextBox><asp:RequiredFieldValidator id="rfvNUM_INICIAL" runat="server" Display="Dynamic" ControlToValidate="txtNUM_INICIAL" ErrorMessage="Num inicial es Requerido"></asp:RequiredFieldValidator>
			<asp:RegularExpressionValidator ID="RegularExpressionValidatorNUM_INICIAL" runat="server" ControlToValidate="txtNUM_INICIAL"
			Display="Dynamic" ErrorMessage="Debe ingresar una numero valida" ValidationExpression="^[+]?\d*$" >*</asp:RegularExpressionValidator>
</TD>
		<TD width="10"></TD>
	</TR>
	<TR runat="server" id="trNUM_FINAL">
		<TD width="10"></TD>
		<TD align="right">
			<asp:Label CssClass="Normal" id="lblNUM_FINAL" runat="server">Num final:</asp:label></TD>
		<TD>
			<asp:TextBox CssClass="TextoNormalDerecha" id="txtNUM_FINAL" runat="server" Width="100px"></asp:TextBox><asp:RequiredFieldValidator id="rfvNUM_FINAL" runat="server" Display="Dynamic" ControlToValidate="txtNUM_FINAL" ErrorMessage="Num final es Requerido"></asp:RequiredFieldValidator>
			<asp:RegularExpressionValidator ID="RegularExpressionValidatorNUM_FINAL" runat="server" ControlToValidate="txtNUM_FINAL"
			Display="Dynamic" ErrorMessage="Debe ingresar una numero valida" ValidationExpression="^[+]?\d*$" >*</asp:RegularExpressionValidator>
</TD>
		<TD width="10"></TD>
	</TR>
