...
''' -----------------------------------------------------------------------------
''' <summary>
''' Clase del Control de Usuario para mostrar un listado de la tabla ZONAS
''' </summary>
''' <remarks>
...
''' </history>
''' -----------------------------------------------------------------------------
Partial Class controles_ucListaZONAS
    Inherits ucListaBase
 
    Private mComponente As New cZONAS
    Public Event Seleccionado(ByVal ZONA As String) 
    Public Event Editando(ByVal ZONA As String) 
...
#Region"Propiedades"
    ...
    Public Property VerDESCRIP_ZONA() As Boolean
        Get
            Return Me.dxgvLista.Columns("DESCRIP_ZONA").Visible
        End Get
        Set(ByVal Value As Boolean)
            Me.dxgvLista.Columns("DESCRIP_ZONA").Visible = Value
        End Set
    End Property
    ...
    Public Property HeaderDESCRIP_ZONA() As String
        Get
            Return Me.dxgvLista.Columns("DESCRIP_ZONA").Caption
        End Get
        Set(ByVal Value As String)
            Me.dxgvLista.Columns("DESCRIP_ZONA").Caption = Value
        End Set
    End Property
...
#End Region
    ...
    ''' -----------------------------------------------------------------------------
    ''' <summary>
    ''' FunciÃ³n que Carga la informaciÃ³n de los registros de la tabla ZONAS
    ''' </summary>
    ''' <remarks>
    ''' </remarks>
    ''' <history>
    ...
    ''' </history>
    ''' -----------------------------------------------------------------------------
    Public Function CargarDatosZONAS_ACTIVAS() As Integer
        Me.odsListaZONAS_ACTIVAS.SelectParameters("recuperarHijas").DefaultValue = "False"
        Me.odsListaZONAS_ACTIVAS.SelectParameters("asColumnaOrden").DefaultValue = ""
        Me.odsListaZONAS_ACTIVAS.SelectParameters("asTipoOrden").DefaultValue = ""
        Me.odsListaZONAS_ACTIVAS.DataBind()
        Me.dxgvLista.DataSourceID = "odsListaZONAS_ACTIVAS"
        Me.dxgvLista.Selection.UnselectAll()
        Me.dxgvLista.Visible = True
        Me.dxgvLista.DataBind()
        Return 1
    ...
    Protected Sub dxgvLista_CustomJSProperties(ByVal sender As Object, ByVal e As DevExpress.Web.ASPxGridViewClientJSPropertiesEventArgs) Handles dxgvLista.CustomJSProperties
        If Me.PermitirSeleccionParaCombo Then
            ...
            For i As Integer = 0 To grid.VisibleRowCount - 1
                keyValues(i) = grid.GetRowValues(i, "ZONA")
                keyNames(i) = grid.GetRowValues(i, "DESCRIP_ZONA")
            Next i
    ...
    Public Function DevolverSeleccionados() As listaZONAS
        Dim mLista As New listaZONAS
        For Each llave As String In Me.dxgvLista.GetSelectedFieldValues("ZONA")
    ...
    Protected Sub dxgvLista_CustomButtonCallback(ByVal sender As Object, ByVal e As DevExpress.Web.ASPxGridViewCustomButtonCallbackEventArgs) Handles dxgvLista.CustomButtonCallback
        If e.ButtonID = "btnEliminar" Then
            Dim lEntidad As ZONAS = CType(Me.dxgvLista.GetRow(e.VisibleIndex), ZONAS)

            If Me.mComponente.EliminarZONAS(lEntidad.ZONA) <> 1 Then
    ...
    Protected Sub dxgvLista_SelectionChanged(sender As Object, e As System.EventArgs) Handles dxgvLista.SelectionChanged
        If dxgvLista.GetSelectedFieldValues("ZONA").Count > 0 Then RaiseEvent Seleccionado(dxgvLista.GetSelectedFieldValues("ZONA")(0).ToString())
    End Sub
End Class
