...
''' -----------------------------------------------------------------------------
''' Project	 : SISPACAL
''' Class	 : ucListaTIPO_DESCUENTO
''' 
''' -----------------------------------------------------------------------------
''' <summary>
''' Clase del Control de Usuario para mostrar un listado de la tabla TIPO_DESCUENTO
''' </summary>
''' <remarks>
...
''' </history>
''' -----------------------------------------------------------------------------
Partial Class controles_ucListaTIPO_DESCUENTO
    Inherits ucBase
 
    Private mComponente As New cTIPO_DESCUENTO
    Public Event Seleccionado(ByVal ID_TIPO_DESCTO As Int32) 
    Public Event Editando(ByVal ID_TIPO_DESCTO As Int32) 
...
#Region"Propiedades"
    ...
    Public Property HeaderNOMBRE_TIPO_DESCTO() As String
        Get
    ...
    Public Property HeaderID_GRUPO_DESC() As String
        Get
...
#End Region
    ...
    Public Function CargarDatos() As Integer
        Dim lTIPO_DESCUENTO As ListaTIPO_DESCUENTO
        lTIPO_DESCUENTO = Me.mComponente.ObtenerLista()
        If lTIPO_DESCUENTO is Nothing Then
            Me.gvLista.Visible = False
            Return -1
        End If
        Me.gvLista.SelectedIndex = -1
        Me.gvLista.Visible = True
        Me.gvLista.DataSource = lTIPO_DESCUENTO
        Me.gvLista.DataBind()
        Return 1
    End Function
    ...
    ''' <summary>
    ''' FunciÃ³n que Carga la informaciÃ³n de los registros de la tabla TIPO_DESCUENTO
    ''' filtrado por la tabla GRUPO_DESCUENTOS
    ''' </summary>
    ...
    ''' </history>
    ''' -----------------------------------------------------------------------------
    Public Function CargarDatosPorGRUPO_DESCUENTOS(ByVal ID_GRUPO_DESC As Int32) As Integer
        Dim lTIPO_DESCUENTO As ListaTIPO_DESCUENTO
        lTIPO_DESCUENTO = Me.mComponente.ObtenerListaPorGRUPO_DESCUENTOS(ID_GRUPO_DESC)
        If lTIPO_DESCUENTO is Nothing Then
            Me.gvLista.Visible = False
            Return -1
        End If
        Me.ViewState("PorGRUPO_DESCUENTOS") = True
        Me.ViewState("ID_GRUPO_DESC") = ID_GRUPO_DESC
        Me.gvLista.SelectedIndex = -1
        Me.gvLista.Visible = True
        Me.gvLista.DataSource = lTIPO_DESCUENTO
        Me.gvLista.DataBind()
    ...
    Private lDdlGRUPO_DESCUENTOSID_GRUPO_DESC As SISPACAL.WebUC.ddlGRUPO_DESCUENTOS
    ...
    Protected Sub gvLista_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles gvLista.RowDataBound
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            Dim mLabelID_TIPO_DESCTO As Label
            mLabelID_TIPO_DESCTO = e.Row.FindControl("Label_ID_TIPO_DESCTO")
            mLabelID_TIPO_DESCTO.Visible = Not Me.PermitirEditar
            lbDetalle.Visible = Me.PermitirEditar
            If Me.VerID_GRUPO_DESC Then
                Dim mDdlGRUPO_DESCUENTOSID_GRUPO_DESC As SISPACAL.WebUC.ddlGRUPO_DESCUENTOS
                mDdlGRUPO_DESCUENTOSID_GRUPO_DESC = e.Row.FindControl("DdlGRUPO_DESCUENTOSID_GRUPO_DESC1")
                If lDdlGRUPO_DESCUENTOSID_GRUPO_DESC Is Nothing Then
                    lDdlGRUPO_DESCUENTOSID_GRUPO_DESC = New SISPACAL.WebUC.ddlGRUPO_DESCUENTOS
                    lDdlGRUPO_DESCUENTOSID_GRUPO_DESC.Recuperar()
                End If
                Dim mGRUPO_DESCUENTOSID_GRUPO_DESC As String
                mGRUPO_DESCUENTOSID_GRUPO_DESC = CType(e.Row.FindControl("Label_ID_GRUPO_DESC1"), Label).Text
                Dim lItem As ListItem = lDdlGRUPO_DESCUENTOSID_GRUPO_DESC.Items.FindByValue(mGRUPO_DESCUENTOSID_GRUPO_DESC)
                If mGRUPO_DESCUENTOSID_GRUPO_DESC <> "" And Not lItem Is Nothing Then
                    mDdlGRUPO_DESCUENTOSID_GRUPO_DESC.Items.Add(New ListItem(lItem.Text, lItem.Value))
                    mDdlGRUPO_DESCUENTOSID_GRUPO_DESC.SelectedValue = mGRUPO_DESCUENTOSID_GRUPO_DESC
                End If
            End If
    ...
    Private Sub gvLista_RowDeleting(ByVal source As System.Object, ByVal e As System.Web.UI.WebControls.GridViewDeleteEventArgs) Handles gvLista.RowDeleting
        If Me.mComponente.EliminarTIPO_DESCUENTO(CInt(CType(Me.gvLista.Rows(e.RowIndex).FindControl("LinkButton1"), LinkButton).ToolTip)) <> 1 Then
            'Si se cometio un error
            Me.AsignarMensaje("Error al Eliminar Registro", True, True)
            e.Cancel = True
        Else
        If Me.ViewState("PorGRUPO_DESCUENTOS") Then
            Me.CargarDatosPorGRUPO_DESCUENTOS(Me.ViewState("ID_GRUPO_DESC"))
            Return
        End If
    ...
    Public Function DevolverSeleccionados() As ListaTIPO_DESCUENTO
        Dim mLista As New ListaTIPO_DESCUENTO
        For Each mRow As GridViewRow In Me.gvLista.Rows
            If CType(mRow.FindControl("CheckBox_Seleccionar"), CheckBox).Checked Then
                ...
                mEntidad.ID_TIPO_DESCTO = CInt(CType(mRow.FindControl("Label_ID_TIPO_DESCTO"), Label).Text)
                mLista.Add(mEntidad)
            End If
        Next
        Return mLista
