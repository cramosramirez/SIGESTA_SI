...
''' -----------------------------------------------------------------------------
''' Project	 : SISPACAL
''' Class	 : ucListaSUPERVISOR
''' 
''' -----------------------------------------------------------------------------
''' <summary>
''' Clase del Control de Usuario para mostrar un listado de la tabla SUPERVISOR
''' </summary>
''' <remarks>
...
''' </history>
''' -----------------------------------------------------------------------------
Partial Class controles_ucListaSUPERVISOR
    Inherits ucBase
 
    Private mComponente As New cSUPERVISOR
    Public Event Seleccionado(ByVal ID_SUPERVISOR As Int32) 
    Public Event Editando(ByVal ID_SUPERVISOR As Int32) 
...
#Region"Propiedades"
    ...
    Public Property HeaderNOMBRE_SUPERVISOR() As String
        Get
...
#End Region
    ...
    Public Function CargarDatos() As Integer
        Dim lSUPERVISOR As ListaSUPERVISOR
        lSUPERVISOR = Me.mComponente.ObtenerLista()
        If lSUPERVISOR is Nothing Then
            Me.gvLista.Visible = False
            Return -1
        End If
        Me.gvLista.SelectedIndex = -1
        Me.gvLista.Visible = True
        Me.gvLista.DataSource = lSUPERVISOR
        Me.gvLista.DataBind()
        Return 1
    End Function
    ...
    Protected Sub gvLista_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles gvLista.RowDataBound
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            Dim mLabelID_SUPERVISOR As Label
            mLabelID_SUPERVISOR = e.Row.FindControl("Label_ID_SUPERVISOR")
            mLabelID_SUPERVISOR.Visible = Not Me.PermitirEditar
    ...
    Private Sub gvLista_RowDeleting(ByVal source As System.Object, ByVal e As System.Web.UI.WebControls.GridViewDeleteEventArgs) Handles gvLista.RowDeleting
        If Me.mComponente.EliminarSUPERVISOR(CInt(CType(Me.gvLista.Rows(e.RowIndex).FindControl("LinkButton1"), LinkButton).ToolTip)) <> 1 Then
    ...
    Public Function DevolverSeleccionados() As ListaSUPERVISOR
        Dim mLista As New ListaSUPERVISOR
        For Each mRow As GridViewRow In Me.gvLista.Rows
            If CType(mRow.FindControl("CheckBox_Seleccionar"), CheckBox).Checked Then
                ...
                mEntidad.ID_SUPERVISOR = CInt(CType(mRow.FindControl("Label_ID_SUPERVISOR"), Label).Text)
                mLista.Add(mEntidad)
            End If
        Next
        Return mLista
