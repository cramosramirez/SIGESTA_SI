...
''' -----------------------------------------------------------------------------
''' Project	 : SISPACAL
''' Class	 : ucVistaDetalleTIPO_TRANSPORTE
''' 
''' -----------------------------------------------------------------------------
''' <summary>
...
''' </history>
''' -----------------------------------------------------------------------------
Partial Class controles_ucVistaDetalleTIPO_TRANSPORTE
    Inherits ucBase
...
#Region"Propiedades"
    ...
    Public Property ID_TIPOTRANS() As Int32
        Get
            Return Me.txtID_TIPOTRANS.Text
        End Get
        Set(ByVal Value As Int32)
            Me._ID_TIPOTRANS = Value
            Me.txtID_TIPOTRANS.Text = CStr(Value)
            If Me._ID_TIPOTRANS > 0 Then
                Me.CargarDatos()
            Else
                Me.LimpiarControles()
                Me.Nuevo()
    ...
    Private mEntidad As TIPO_TRANSPORTE
...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If Not Me.ViewState("ID_TIPOTRANS") Is Nothing Then Me._ID_TIPOTRANS = Me.ViewState("ID_TIPOTRANS")

    End Sub

    ''' -----------------------------------------------------------------------------
    ''' <summary>
    ''' FunciÃ³n que Carga la informaciÃ³n del registro de la tabla TIPO_TRANSPORTE
    ''' </summary>
    ''' <remarks>
    ''' </remarks>
    ''' <history>
    ...
    Private Sub CargarDatos()
        ...
        mEntidad = New TIPO_TRANSPORTE
        mEntidad.ID_TIPOTRANS = ID_TIPOTRANS
 
        If mComponente.ObtenerTIPO_TRANSPORTE(mEntidad) <> 1 Then
            RaiseEvent ErrorEvent("Error al obtener Registro.")
            Return
        End If
        Me.txtID_TIPOTRANS.Text = mEntidad.ID_TIPOTRANS.ToString()
    ...
    ''' -----------------------------------------------------------------------------
    ''' <summary>
    ''' FunciÃ³n que Guarda la informaciÃ³n del registro en la tabla TIPO_TRANSPORTE
    ''' </summary>
    ''' <returns>
    ''' ""                              : Si no existe error
    ...
    Public Function Actualizar() As String
        ...
        Else
            mEntidad = (New cTIPO_TRANSPORTE).ObtenerTIPO_TRANSPORTE(CInt(Me.txtID_TIPOTRANS.Text))
            mEntidad.USUARIO_ACT = Me.ObtenerUsuario
            mEntidad.FECHA_ACT = cFechaHora.ObtenerFechaHora
        End If
        mEntidad.NOMBRE = Me.txtNOMBRE.Text
       
        If mComponente.ActualizarTIPO_TRANSPORTE(mEntidad) <> 1 Then
