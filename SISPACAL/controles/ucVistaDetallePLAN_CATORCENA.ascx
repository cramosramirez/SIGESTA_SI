<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ucVistaDetallePLAN_CATORCENA.ascx.vb" Inherits="controles_ucVistaDetallePLAN_CATORCENA" %>
...
<TABLE id="VistaDetalle" cellSpacing="0" cellPadding="0" width="100%" border="0">
	<TR runat="server" id="trID_PLAN_CATORCENA">
		<TD width="10"></TD>
		<TD align="right">
			<asp:Label CssClass="Normal" id="lblID_PLAN_CATORCENA" runat="server">Id plan catorcena:</asp:label></TD>
		<TD>
			<asp:TextBox CssClass="TextoLlaveDerecha" id="txtID_PLAN_CATORCENA" runat="server" ReadOnly="True" Width="70px"></asp:textbox></TD>
		<TD width="10"></TD>
	</TR>
	...
	<TR runat="server" id="trNO_CATORCENA">
		<TD width="10"></TD>
		<TD align="right">
			<asp:Label CssClass="Normal" id="lblNO_CATORCENA" runat="server">No catorcena:</asp:label></TD>
		<TD>
			<asp:TextBox CssClass="TextoNormalDerecha" id="txtNO_CATORCENA" runat="server" Width="100px"></asp:TextBox><asp:RequiredFieldValidator id="rfvNO_CATORCENA" runat="server" Display="Dynamic" ControlToValidate="txtNO_CATORCENA" ErrorMessage="No catorcena es Requerido"></asp:RequiredFieldValidator>
			<asp:RegularExpressionValidator ID="RegularExpressionValidatorNO_CATORCENA" runat="server" ControlToValidate="txtNO_CATORCENA"
