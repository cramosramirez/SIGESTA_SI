...
''' -----------------------------------------------------------------------------
''' Project	 : SISPACAL
''' Class	 : ucVistaDetalleTIPO_CARGADORA
''' 
''' -----------------------------------------------------------------------------
''' <summary>
...
''' </history>
''' -----------------------------------------------------------------------------
Partial Class controles_ucVistaDetalleTIPO_CARGADORA
    Inherits ucBase
...
#Region"Propiedades"
    ...
    Public Property ID_TIPO_CARGADORA() As Int32
        Get
            Return Me.txtID_TIPO_CARGADORA.Text
        End Get
        Set(ByVal Value As Int32)
            Me._ID_TIPO_CARGADORA = Value
            Me.txtID_TIPO_CARGADORA.Text = CStr(Value)
            If Me._ID_TIPO_CARGADORA > 0 Then
                Me.CargarDatos()
            Else
                Me.LimpiarControles()
                Me.Nuevo()
    ...
    Public Property NOMBRE_TIPO_CARGADORA() As String
        Get
            Return Me.txtNOMBRE_TIPO_CARGADORA.Text
        End Get
        Set(ByVal value As String)
            Me.txtNOMBRE_TIPO_CARGADORA.Text = value.ToString()
        End Set
    End Property
    ...
    Public Property VerNOMBRE_TIPO_CARGADORA() As Boolean
        Get
            Return Me.trNOMBRE_TIPO_CARGADORA.Visible
        End Get
        Set(ByVal value As Boolean)
            Me.trNOMBRE_TIPO_CARGADORA.Visible = value
        End Set
    End Property
    ...
    Private mComponente As New cTIPO_CARGADORA
    Private mEntidad As TIPO_CARGADORA
...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If Not Me.ViewState("ID_TIPO_CARGADORA") Is Nothing Then Me._ID_TIPO_CARGADORA = Me.ViewState("ID_TIPO_CARGADORA")

    End Sub

    ''' -----------------------------------------------------------------------------
    ''' <summary>
    ''' FunciÃ³n que Carga la informaciÃ³n del registro de la tabla TIPO_CARGADORA
    ''' </summary>
    ''' <remarks>
    ''' </remarks>
    ''' <history>
    ...
    Private Sub CargarDatos()
        ...
        mEntidad = New TIPO_CARGADORA
        mEntidad.ID_TIPO_CARGADORA = ID_TIPO_CARGADORA
 
        If mComponente.ObtenerTIPO_CARGADORA(mEntidad) <> 1 Then
            RaiseEvent ErrorEvent("Error al obtener Registro.")
            Return
        End If
        Me.txtID_TIPO_CARGADORA.Text = mEntidad.ID_TIPO_CARGADORA.ToString()
        Me.txtNOMBRE_TIPO_CARGADORA.Text = mEntidad.NOMBRE_TIPO_CARGADORA
    ...
    Private Sub HabilitarEdicion(ByVal edicion As Boolean)
        Me.txtNOMBRE_TIPO_CARGADORA.Enabled = edicion
    ...
    Private Sub Nuevo()
        ...
        If Not Me.ViewState("nuevo") Is Nothing Then Me.ViewState.Remove("nuevo")
        Me.ViewState.Add("nuevo", Me._nuevo)
        Me.txtNOMBRE_TIPO_CARGADORA.Text = ""
    ...
    ''' -----------------------------------------------------------------------------
    ''' <summary>
    ''' FunciÃ³n que Guarda la informaciÃ³n del registro en la tabla TIPO_CARGADORA
    ''' </summary>
    ''' <returns>
    ''' ""                              : Si no existe error
    ...
    Public Function Actualizar() As String
        ...
        mEntidad = New TIPO_CARGADORA
        If Me._nuevo Then
            mEntidad.ID_TIPO_CARGADORA = 0
        Else
            mEntidad.ID_TIPO_CARGADORA = CInt(Me.txtID_TIPO_CARGADORA.Text)
        End If
        mEntidad.NOMBRE_TIPO_CARGADORA = Me.txtNOMBRE_TIPO_CARGADORA.Text
        ...
        If mComponente.ActualizarTIPO_CARGADORA(mEntidad) <> 1 Then
