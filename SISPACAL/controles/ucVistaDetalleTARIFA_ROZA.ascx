<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ucVistaDetalleTARIFA_ROZA.ascx.vb" Inherits="controles_ucVistaDetalleTARIFA_ROZA" %>
<%@ Register TagPrefix="cc1" Namespace="SISPACAL.WebUC" Assembly="SISPACAL_WebUC" %>
<TABLE id="VistaDetalle" cellSpacing="0" cellPadding="0" width="100%" border="0">
	<TR runat="server" id="trID_TARIFA_ROZA">
		<TD width="10"></TD>
		<TD align="right">
			<asp:Label CssClass="Normal" id="lblID_TARIFA_ROZA" runat="server">Id tarifa roza:</asp:label></TD>
		<TD>
			<asp:TextBox CssClass="TextoLlaveDerecha" id="txtID_TARIFA_ROZA" runat="server" ReadOnly="True" Width="70px"></asp:textbox></TD>
		<TD width="10"></TD>
	</TR>
	...
	<TR runat="server" id="trROZA">
		<TD width="10"></TD>
		<TD align="right">
			<asp:Label CssClass="Normal" id="lblROZA" runat="server">Roza:</asp:label></TD>
		<TD>
			<asp:TextBox CssClass="TextoNormalDerecha" id="txtROZA" runat="server" Width="100px"></asp:TextBox><asp:RequiredFieldValidator id="rfvROZA" runat="server" Display="Dynamic" ControlToValidate="txtROZA" ErrorMessage="Roza es Requerido"></asp:RequiredFieldValidator>
			<asp:RegularExpressionValidator ID="RegularExpressionValidatorROZA" runat="server" ControlToValidate="txtROZA"
