...
''' -----------------------------------------------------------------------------
''' Project	 : SISPACAL
''' Class	 : ucListaCUENTA_BANCARIA
''' 
''' -----------------------------------------------------------------------------
''' <summary>
''' Clase del Control de Usuario para mostrar un listado de la tabla CUENTA_BANCARIA
''' </summary>
''' <remarks>
...
''' </history>
''' -----------------------------------------------------------------------------
Partial Class controles_ucListaCUENTA_BANCARIA
    Inherits ucBase
 
    Private mComponente As New cCUENTA_BANCARIA
    Public Event Seleccionado(ByVal ID_CUENTA As Int32) 
    Public Event Editando(ByVal ID_CUENTA As Int32) 
...
#Region"Propiedades"
    ...
    Public Property HeaderNO_CUENTA() As String
        Get
    ...
    Public Property HeaderCUENTA_CONTABLE() As String
        Get
    ...
    Public Property HeaderDESCRIPCION_CUENTA() As String
        Get
...
#End Region
    ...
    Public Function CargarDatos() As Integer
        Dim lCUENTA_BANCARIA As ListaCUENTA_BANCARIA
        lCUENTA_BANCARIA = Me.mComponente.ObtenerLista()
        If lCUENTA_BANCARIA is Nothing Then
            Me.gvLista.Visible = False
            Return -1
        End If
        Me.gvLista.SelectedIndex = -1
        Me.gvLista.Visible = True
        Me.gvLista.DataSource = lCUENTA_BANCARIA
        Me.gvLista.DataBind()
        Return 1
    End Function
    ...
    Public Function CargarDatosPorBANCOS(ByVal CODIBANCO As Int32) As Integer
        Dim lCUENTA_BANCARIA As ListaCUENTA_BANCARIA
        lCUENTA_BANCARIA = Me.mComponente.ObtenerListaPorBANCOS(CODIBANCO)
        If lCUENTA_BANCARIA is Nothing Then
            Me.gvLista.Visible = False
            Return -1
        End If
        Me.ViewState("PorBANCOS") = True
        Me.ViewState("CODIBANCO") = CODIBANCO
        Me.gvLista.SelectedIndex = -1
        Me.gvLista.Visible = True
        Me.gvLista.DataSource = lCUENTA_BANCARIA
        Me.gvLista.DataBind()
    ...
    Private lDdlBANCOSCODIBANCO As SISPACAL.WebUC.ddlBANCOS
    ...
    Protected Sub gvLista_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles gvLista.RowDataBound
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            Dim mLabelID_CUENTA As Label
            mLabelID_CUENTA = e.Row.FindControl("Label_ID_CUENTA")
            mLabelID_CUENTA.Visible = Not Me.PermitirEditar
            lbDetalle.Visible = Me.PermitirEditar
            If Me.VerCODIBANCO Then
                Dim mDdlBANCOSCODIBANCO As SISPACAL.WebUC.ddlBANCOS
                mDdlBANCOSCODIBANCO = e.Row.FindControl("DdlBANCOSCODIBANCO1")
                If lDdlBANCOSCODIBANCO Is Nothing Then
                    lDdlBANCOSCODIBANCO = New SISPACAL.WebUC.ddlBANCOS
                    lDdlBANCOSCODIBANCO.Recuperar()
                End If
                Dim mBANCOSCODIBANCO As String
                mBANCOSCODIBANCO = CType(e.Row.FindControl("Label_CODIBANCO1"), Label).Text
                Dim lItem As ListItem = lDdlBANCOSCODIBANCO.Items.FindByValue(mBANCOSCODIBANCO)
                If mBANCOSCODIBANCO <> "" And Not lItem Is Nothing Then
                    mDdlBANCOSCODIBANCO.Items.Add(New ListItem(lItem.Text, lItem.Value))
                    mDdlBANCOSCODIBANCO.SelectedValue = mBANCOSCODIBANCO
                End If
            End If
    ...
    Private Sub gvLista_RowDeleting(ByVal source As System.Object, ByVal e As System.Web.UI.WebControls.GridViewDeleteEventArgs) Handles gvLista.RowDeleting
        If Me.mComponente.EliminarCUENTA_BANCARIA(CInt(CType(Me.gvLista.Rows(e.RowIndex).FindControl("LinkButton1"), LinkButton).ToolTip)) <> 1 Then
            'Si se cometio un error
            Me.AsignarMensaje("Error al Eliminar Registro", True, True)
            e.Cancel = True
        Else
        If Me.ViewState("PorBANCOS") Then
            Me.CargarDatosPorBANCOS(Me.ViewState("CODIBANCO"))
            Return
        End If
    ...
    Public Function DevolverSeleccionados() As ListaCUENTA_BANCARIA
        Dim mLista As New ListaCUENTA_BANCARIA
        For Each mRow As GridViewRow In Me.gvLista.Rows
            If CType(mRow.FindControl("CheckBox_Seleccionar"), CheckBox).Checked Then
                ...
                mEntidad.ID_CUENTA = CInt(CType(mRow.FindControl("Label_ID_CUENTA"), Label).Text)
                mLista.Add(mEntidad)
            End If
        Next
        Return mLista
