...
''' -----------------------------------------------------------------------------
''' Project	 : SISPACAL
''' Class	 : ucListaAJUSTE_POL
''' 
''' -----------------------------------------------------------------------------
''' <summary>
''' Clase del Control de Usuario para mostrar un listado de la tabla AJUSTE_POL
''' </summary>
''' <remarks>
...
''' </history>
''' -----------------------------------------------------------------------------
Partial Class controles_ucListaAJUSTE_POL
    Inherits ucBase
 
    Private mComponente As New cAJUSTE_POL
    Public Event Seleccionado(ByVal DENSIDAD As Int32) 
    Public Event Editando(ByVal DENSIDAD As Int32) 
...
#Region"Propiedades"
    ...
    Public Property HeaderDENSIDAD() As String
        Get
    ...
    Public Property HeaderDENSIAPARE() As String
        Get
    ...
    Public Property HeaderPESOESP() As String
        Get
...
#End Region
    ...
    ''' -----------------------------------------------------------------------------
    ''' <summary>
    ''' FunciÃ³n que Carga la informaciÃ³n de los registros de la tabla AJUSTE_POL
    ''' </summary>
    ''' <remarks>
    ''' </remarks>
    ''' <history>
    ...
    Public Function CargarDatos() As Integer
        Dim lAJUSTE_POL As ListaAJUSTE_POL
        lAJUSTE_POL = Me.mComponente.ObtenerLista()
        If lAJUSTE_POL is Nothing Then
            Me.gvLista.Visible = False
            Return -1
        End If
        Me.gvLista.SelectedIndex = -1
        Me.gvLista.Visible = True
        Me.gvLista.DataSource = lAJUSTE_POL
        Me.gvLista.DataBind()
        Return 1
    End Function
    ...
    Protected Sub gvLista_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles gvLista.RowDataBound
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            Dim mLabelDENSIDAD As Label
            mLabelDENSIDAD = e.Row.FindControl("Label_DENSIDAD")
            mLabelDENSIDAD.Visible = Not Me.PermitirEditar
    ...
    Private Sub gvLista_RowDeleting(ByVal source As System.Object, ByVal e As System.Web.UI.WebControls.GridViewDeleteEventArgs) Handles gvLista.RowDeleting
        If Me.mComponente.EliminarAJUSTE_POL(CInt(CType(Me.gvLista.Rows(e.RowIndex).FindControl("LinkButton1"), LinkButton).ToolTip)) <> 1 Then
    ...
    Public Function DevolverSeleccionados() As ListaAJUSTE_POL
        Dim mLista As New ListaAJUSTE_POL
        For Each mRow As GridViewRow In Me.gvLista.Rows
            If CType(mRow.FindControl("CheckBox_Seleccionar"), CheckBox).Checked Then
                ...
                mEntidad.DENSIDAD = CInt(CType(mRow.FindControl("Label_DENSIDAD"), Label).Text)
                mLista.Add(mEntidad)
            End If
        Next
        Return mLista
