...
''' -----------------------------------------------------------------------------
''' Project	 : SISPACAL
''' Class	 : ucListaTIPO_TRANSPORTE
''' 
''' -----------------------------------------------------------------------------
''' <summary>
''' Clase del Control de Usuario para mostrar un listado de la tabla TIPO_TRANSPORTE
''' </summary>
''' <remarks>
...
''' </history>
''' -----------------------------------------------------------------------------
Partial Class controles_ucListaTIPO_TRANSPORTE
    Inherits ucBase
 
    Private mComponente As New cTIPO_TRANSPORTE
    Public Event Seleccionado(ByVal ID_TIPOTRANS As Int32) 
    Public Event Editando(ByVal ID_TIPOTRANS As Int32) 
...
#End Region
    ...
    Public Function CargarDatos() As Integer
        Dim lTIPO_TRANSPORTE As ListaTIPO_TRANSPORTE
        lTIPO_TRANSPORTE = Me.mComponente.ObtenerLista()
        If lTIPO_TRANSPORTE is Nothing Then
            Me.gvLista.Visible = False
            Return -1
        End If
        Me.gvLista.SelectedIndex = -1
        Me.gvLista.Visible = True
        Me.gvLista.DataSource = lTIPO_TRANSPORTE
        Me.gvLista.DataBind()
        Return 1
    End Function
    ...
    Protected Sub gvLista_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles gvLista.RowDataBound
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            Dim mLabelID_TIPOTRANS As Label
            mLabelID_TIPOTRANS = e.Row.FindControl("Label_ID_TIPOTRANS")
            mLabelID_TIPOTRANS.Visible = Not Me.PermitirEditar
    ...
    Private Sub gvLista_RowDeleting(ByVal source As System.Object, ByVal e As System.Web.UI.WebControls.GridViewDeleteEventArgs) Handles gvLista.RowDeleting
        If Me.mComponente.EliminarTIPO_TRANSPORTE(CInt(CType(Me.gvLista.Rows(e.RowIndex).FindControl("LinkButton1"), LinkButton).ToolTip)) <> 1 Then
    ...
    Public Function DevolverSeleccionados() As ListaTIPO_TRANSPORTE
        Dim mLista As New ListaTIPO_TRANSPORTE
        For Each mRow As GridViewRow In Me.gvLista.Rows
            If CType(mRow.FindControl("CheckBox_Seleccionar"), CheckBox).Checked Then
                ...
                mEntidad.ID_TIPOTRANS = CInt(CType(mRow.FindControl("Label_ID_TIPOTRANS"), Label).Text)
                mLista.Add(mEntidad)
            End If
        Next
        Return mLista
