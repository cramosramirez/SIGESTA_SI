...
''' -----------------------------------------------------------------------------
''' Project	 : SISPACAL
''' Class	 : ucListaPRODUCTO_COMBUSTIBLE
''' 
''' -----------------------------------------------------------------------------
''' <summary>
''' Clase del Control de Usuario para mostrar un listado de la tabla PRODUCTO_COMBUSTIBLE
''' </summary>
''' <remarks>
...
''' </history>
''' -----------------------------------------------------------------------------
Partial Class controles_ucListaPRODUCTO_COMBUSTIBLE
    Inherits ucBase
...
#End Region
    ...
    Public Function CargarDatos() As Integer
        Dim lPRODUCTO_COMBUSTIBLE As ListaPRODUCTO_COMBUSTIBLE
        lPRODUCTO_COMBUSTIBLE = Me.mComponente.ObtenerLista()
        If lPRODUCTO_COMBUSTIBLE is Nothing Then
            Me.gvLista.Visible = False
            Return -1
        End If
        Me.gvLista.SelectedIndex = -1
        Me.gvLista.Visible = True
        Me.gvLista.DataSource = lPRODUCTO_COMBUSTIBLE
        Me.gvLista.DataBind()
        Return 1
    End Function
    ...
    Protected Sub gvLista_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles gvLista.RowDataBound
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            Dim mLabelID_PRODUCTO As Label
            mLabelID_PRODUCTO = e.Row.FindControl("Label_ID_PRODUCTO")
            mLabelID_PRODUCTO.Visible = Not Me.PermitirEditar
    ...
    Private Sub gvLista_RowDeleting(ByVal source As System.Object, ByVal e As System.Web.UI.WebControls.GridViewDeleteEventArgs) Handles gvLista.RowDeleting
        If Me.mComponente.EliminarPRODUCTO_COMBUSTIBLE(CInt(CType(Me.gvLista.Rows(e.RowIndex).FindControl("LinkButton1"), LinkButton).ToolTip)) <> 1 Then
    ...
    Public Function DevolverSeleccionados() As ListaPRODUCTO_COMBUSTIBLE
        Dim mLista As New ListaPRODUCTO_COMBUSTIBLE
        For Each mRow As GridViewRow In Me.gvLista.Rows
            If CType(mRow.FindControl("CheckBox_Seleccionar"), CheckBox).Checked Then
                ...
                mEntidad.ID_PRODUCTO = CInt(CType(mRow.FindControl("Label_ID_PRODUCTO"), Label).Text)
                mLista.Add(mEntidad)
            End If
        Next
        Return mLista
