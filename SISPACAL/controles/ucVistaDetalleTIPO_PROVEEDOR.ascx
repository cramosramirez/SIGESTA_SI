<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ucVistaDetalleTIPO_PROVEEDOR.ascx.vb" Inherits="controles_ucVistaDetalleTIPO_PROVEEDOR" %>
<TABLE id="VistaDetalle" cellSpacing="0" cellPadding="0" width="100%" border="0">
	<TR runat="server" id="trID_TIPO_PROVEEDOR">
		<TD width="10"></TD>
		<TD align="right">
			<asp:Label CssClass="Normal" id="lblID_TIPO_PROVEEDOR" runat="server">Id tipo proveedor:</asp:label></TD>
		<TD>
			<asp:TextBox CssClass="TextoLlaveDerecha" id="txtID_TIPO_PROVEEDOR" runat="server" ReadOnly="True" Width="70px"></asp:textbox></TD>
		<TD width="10"></TD>
	</TR>
	<TR runat="server" id="trNOMBRE_TIPO_PROVEEDOR">
		<TD width="10"></TD>
		<TD align="right">
			<asp:Label CssClass="Normal" id="lblNOMBRE_TIPO_PROVEEDOR" runat="server">Nombre tipo proveedor:</asp:label></TD>
		<TD>
			<asp:TextBox CssClass="TextoNormalIzquierda" id="txtNOMBRE_TIPO_PROVEEDOR" runat="server" Width="100px" MaxLength="100"></asp:TextBox><asp:RequiredFieldValidator id="rfvNOMBRE_TIPO_PROVEEDOR" runat="server" Display="Dynamic" ControlToValidate="txtNOMBRE_TIPO_PROVEEDOR" ErrorMessage="Nombre tipo proveedor es Requerido"></asp:RequiredFieldValidator>
</TD>
		<TD width="10"></TD>
	</TR>
