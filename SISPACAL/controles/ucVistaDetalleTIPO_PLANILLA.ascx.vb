...
''' -----------------------------------------------------------------------------
''' Project	 : SISPACAL
''' Class	 : ucVistaDetalleTIPO_PLANILLA
''' 
''' -----------------------------------------------------------------------------
''' <summary>
...
''' </history>
''' -----------------------------------------------------------------------------
Partial Class controles_ucVistaDetalleTIPO_PLANILLA
    Inherits ucBase
...
#Region"Propiedades"
    ...
    Public Property ID_TIPO_PLANILLA() As Int32
        Get
            Return Me.txtID_TIPO_PLANILLA.Text
        End Get
        Set(ByVal Value As Int32)
            Me._ID_TIPO_PLANILLA = Value
            Me.txtID_TIPO_PLANILLA.Text = CStr(Value)
            If Me._ID_TIPO_PLANILLA > 0 Then
                Me.CargarDatos()
            Else
                Me.LimpiarControles()
                Me.Nuevo()
    ...
    Public Property NOMBRE_TIPO_PLANILLA() As String
        Get
            Return Me.txtNOMBRE_TIPO_PLANILLA.Text
        End Get
        Set(ByVal value As String)
            Me.txtNOMBRE_TIPO_PLANILLA.Text = value.ToString()
        End Set
    End Property
    ...
    Public Property VerNOMBRE_TIPO_PLANILLA() As Boolean
        Get
            Return Me.trNOMBRE_TIPO_PLANILLA.Visible
        End Get
        Set(ByVal value As Boolean)
            Me.trNOMBRE_TIPO_PLANILLA.Visible = value
        End Set
    End Property
    ...
    Private mEntidad As TIPO_PLANILLA
...
#End Region
    ...
    ''' -----------------------------------------------------------------------------
    ''' <summary>
    ''' FunciÃ³n que Carga la informaciÃ³n del registro de la tabla TIPO_PLANILLA
    ''' </summary>
    ''' <remarks>
    ''' </remarks>
    ''' <history>
    ...
    Private Sub CargarDatos()
        ...
        mEntidad = New TIPO_PLANILLA
        mEntidad.ID_TIPO_PLANILLA = ID_TIPO_PLANILLA
 
        If mComponente.ObtenerTIPO_PLANILLA(mEntidad) <> 1 Then
            RaiseEvent ErrorEvent("Error al obtener Registro.")
            Return
        End If
        Me.txtID_TIPO_PLANILLA.Text = mEntidad.ID_TIPO_PLANILLA.ToString()
        Me.txtNOMBRE_TIPO_PLANILLA.Text = mEntidad.NOMBRE_TIPO_PLANILLA
    ...
    Private Sub HabilitarEdicion(ByVal edicion As Boolean)
        Me.txtNOMBRE_TIPO_PLANILLA.Enabled = edicion
    ...
    Private Sub Nuevo()
        ...
        If Not Me.ViewState("nuevo") Is Nothing Then Me.ViewState.Remove("nuevo")
        Me.ViewState.Add("nuevo", Me._nuevo)
        Me.txtNOMBRE_TIPO_PLANILLA.Text = ""
    ...
    ''' -----------------------------------------------------------------------------
    ''' <summary>
    ''' FunciÃ³n que Guarda la informaciÃ³n del registro en la tabla TIPO_PLANILLA
    ''' </summary>
    ''' <returns>
    ''' ""                              : Si no existe error
    ...
    Public Function Actualizar() As String
        ...
        mEntidad = New TIPO_PLANILLA
        If Me._nuevo Then
            mEntidad.ID_TIPO_PLANILLA = 0
        Else
            mEntidad.ID_TIPO_PLANILLA = CInt(Me.txtID_TIPO_PLANILLA.Text)
        End If
        mEntidad.NOMBRE_TIPO_PLANILLA = Me.txtNOMBRE_TIPO_PLANILLA.Text
        ...
        If mComponente.ActualizarTIPO_PLANILLA(mEntidad) <> 1 Then
