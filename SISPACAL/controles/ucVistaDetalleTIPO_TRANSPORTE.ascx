<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ucVistaDetalleTIPO_TRANSPORTE.ascx.vb" Inherits="controles_ucVistaDetalleTIPO_TRANSPORTE" %>
<TABLE id="VistaDetalle" cellSpacing="0" cellPadding="0" width="100%" border="0">
	<TR runat="server" id="trID_TIPOTRANS">
		<TD width="10"></TD>
		<TD align="right">
			<asp:Label CssClass="Normal" id="lblID_TIPOTRANS" runat="server">Id tipotrans:</asp:label></TD>
		<TD>
			<asp:TextBox CssClass="TextoLlaveDerecha" id="txtID_TIPOTRANS" runat="server" ReadOnly="True" Width="70px"></asp:textbox></TD>
		<TD width="10"></TD>
	</TR>
	<TR runat="server" id="trNOMBRE">
		...
		<TD>
			<asp:TextBox CssClass="TextoNormalIzquierda" id="txtNOMBRE" runat="server" Width="100px" MaxLength="50"></asp:TextBox><asp:RequiredFieldValidator id="rfvNOMBRE" runat="server" Display="Dynamic" ControlToValidate="txtNOMBRE" ErrorMessage="Nombre es Requerido"></asp:RequiredFieldValidator>
</TD>
		<TD width="10"></TD>
	</TR>
