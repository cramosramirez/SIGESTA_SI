...
''' -----------------------------------------------------------------------------
''' Project	 : SISPACAL
''' Class	 : ucListaTIPO_CARGADORA
''' 
''' -----------------------------------------------------------------------------
''' <summary>
''' Clase del Control de Usuario para mostrar un listado de la tabla TIPO_CARGADORA
''' </summary>
''' <remarks>
...
''' </history>
''' -----------------------------------------------------------------------------
Partial Class controles_ucListaTIPO_CARGADORA
    Inherits ucBase
 
    Private mComponente As New cTIPO_CARGADORA
    Public Event Seleccionado(ByVal ID_TIPO_CARGADORA As Int32) 
    Public Event Editando(ByVal ID_TIPO_CARGADORA As Int32) 
...
#Region"Propiedades"
    ...
    Public Property HeaderNOMBRE_TIPO_CARGADORA() As String
        Get
...
#End Region
    ...
    Public Function CargarDatos() As Integer
        Dim lTIPO_CARGADORA As ListaTIPO_CARGADORA
        lTIPO_CARGADORA = Me.mComponente.ObtenerLista()
        If lTIPO_CARGADORA is Nothing Then
            Me.gvLista.Visible = False
            Return -1
        End If
        Me.gvLista.SelectedIndex = -1
        Me.gvLista.Visible = True
        Me.gvLista.DataSource = lTIPO_CARGADORA
        Me.gvLista.DataBind()
        Return 1
    End Function
    ...
    Protected Sub gvLista_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles gvLista.RowDataBound
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            Dim mLabelID_TIPO_CARGADORA As Label
            mLabelID_TIPO_CARGADORA = e.Row.FindControl("Label_ID_TIPO_CARGADORA")
            mLabelID_TIPO_CARGADORA.Visible = Not Me.PermitirEditar
    ...
    Private Sub gvLista_RowDeleting(ByVal source As System.Object, ByVal e As System.Web.UI.WebControls.GridViewDeleteEventArgs) Handles gvLista.RowDeleting
        If Me.mComponente.EliminarTIPO_CARGADORA(CInt(CType(Me.gvLista.Rows(e.RowIndex).FindControl("LinkButton1"), LinkButton).ToolTip)) <> 1 Then
    ...
    Public Function DevolverSeleccionados() As ListaTIPO_CARGADORA
        Dim mLista As New ListaTIPO_CARGADORA
        For Each mRow As GridViewRow In Me.gvLista.Rows
            If CType(mRow.FindControl("CheckBox_Seleccionar"), CheckBox).Checked Then
                ...
                mEntidad.ID_TIPO_CARGADORA = CInt(CType(mRow.FindControl("Label_ID_TIPO_CARGADORA"), Label).Text)
                mLista.Add(mEntidad)
            End If
        Next
        Return mLista
