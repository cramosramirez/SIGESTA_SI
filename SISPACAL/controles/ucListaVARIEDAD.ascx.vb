...
''' -----------------------------------------------------------------------------
''' Project	 : SISPACAL
''' Class	 : ucListaVARIEDAD
''' 
''' -----------------------------------------------------------------------------
''' <summary>
''' Clase del Control de Usuario para mostrar un listado de la tabla VARIEDAD
''' </summary>
''' <remarks>
...
''' </history>
''' -----------------------------------------------------------------------------
Partial Class controles_ucListaVARIEDAD
    Inherits ucBase
 
    Private mComponente As New cVARIEDAD
    Public Event Seleccionado(ByVal CODIVARIEDA As String) 
    Public Event Editando(ByVal CODIVARIEDA As String) 
...
#Region"Propiedades"
    ...
    Public Property HeaderNOM_VARIEDAD() As String
        Get
    ...
    Public Property HeaderDESCRP_VARIEDAD() As String
        Get
...
#End Region
    ...
    Public Function CargarDatos() As Integer
        Dim lVARIEDAD As ListaVARIEDAD
        lVARIEDAD = Me.mComponente.ObtenerLista()
        If lVARIEDAD is Nothing Then
            Me.gvLista.Visible = False
            Return -1
        End If
        Me.gvLista.SelectedIndex = -1
        Me.gvLista.Visible = True
        Me.gvLista.DataSource = lVARIEDAD
        Me.gvLista.DataBind()
        Return 1
    End Function
    ...
    Protected Sub gvLista_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles gvLista.RowDataBound
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            Dim mLabelCODIVARIEDA As Label
            mLabelCODIVARIEDA = e.Row.FindControl("Label_CODIVARIEDA")
            mLabelCODIVARIEDA.Visible = Not Me.PermitirEditar
    ...
    Private Sub gvLista_RowDeleting(ByVal source As System.Object, ByVal e As System.Web.UI.WebControls.GridViewDeleteEventArgs) Handles gvLista.RowDeleting
        If Me.mComponente.EliminarVARIEDAD(CType(Me.gvLista.Rows(e.RowIndex).FindControl("LinkButton1"), LinkButton).ToolTip) <> 1 Then
    ...
    Public Function DevolverSeleccionados() As ListaVARIEDAD
        Dim mLista As New ListaVARIEDAD
        For Each mRow As GridViewRow In Me.gvLista.Rows
            If CType(mRow.FindControl("CheckBox_Seleccionar"), CheckBox).Checked Then
                ...
                mEntidad.CODIVARIEDA = CInt(CType(mRow.FindControl("Label_CODIVARIEDA"), Label).Text)
                mLista.Add(mEntidad)
            End If
        Next
        Return mLista
