...
''' -----------------------------------------------------------------------------
''' Project	 : SISPACAL
''' Class	 : ucListaUBICACION
''' 
''' -----------------------------------------------------------------------------
''' <summary>
''' Clase del Control de Usuario para mostrar un listado de la tabla UBICACION
''' </summary>
''' <remarks>
...
''' </history>
''' -----------------------------------------------------------------------------
Partial Class controles_ucListaUBICACION
    Inherits ucBase
 
    Private mComponente As New cUBICACION
    Public Event Seleccionado(ByVal CODIUBICACION As String) 
    Public Event Editando(ByVal CODIUBICACION As String) 
...
#Region"Propiedades"
    ...
    Public Property HeaderDEPARTAMENTO() As String
        Get
    ...
    Public Property HeaderMUNICIPIO() As String
        Get
    ...
    Public Property HeaderCANTON() As String
        Get
    ...
    Public Property HeaderKILOMETRO() As String
        Get
...
#End Region
    ...
    Public Function CargarDatos() As Integer
        Dim lUBICACION As ListaUBICACION
        lUBICACION = Me.mComponente.ObtenerLista()
        If lUBICACION is Nothing Then
            Me.gvLista.Visible = False
            Return -1
        End If
        Me.gvLista.SelectedIndex = -1
        Me.gvLista.Visible = True
        Me.gvLista.DataSource = lUBICACION
        Me.gvLista.DataBind()
        Return 1
    End Function
    ...
    ''' </history>
    ''' -----------------------------------------------------------------------------
    Public Function CargarDatosPorTARIFA(ByVal CODITARIFA As String) As Integer
        Dim lUBICACION As ListaUBICACION
        lUBICACION = Me.mComponente.ObtenerListaPorTARIFA(CODITARIFA)
        If lUBICACION is Nothing Then
            Me.gvLista.Visible = False
            Return -1
        End If
        Me.ViewState("PorTARIFA") = True
        Me.ViewState("CODITARIFA") = CODITARIFA
        Me.gvLista.SelectedIndex = -1
        Me.gvLista.Visible = True
        Me.gvLista.DataSource = lUBICACION
        Me.gvLista.DataBind()
    ...
    Private lDdlTARIFACODITARIFA As SISPACAL.WebUC.ddlTARIFA
    ...
    Protected Sub gvLista_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles gvLista.RowDataBound
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            Dim mLabelCODIUBICACION As Label
            mLabelCODIUBICACION = e.Row.FindControl("Label_CODIUBICACION")
            mLabelCODIUBICACION.Visible = Not Me.PermitirEditar
            lbDetalle.Visible = Me.PermitirEditar
            If Me.VerCODITARIFA Then
                Dim mDdlTARIFACODITARIFA As SISPACAL.WebUC.ddlTARIFA
                mDdlTARIFACODITARIFA = e.Row.FindControl("DdlTARIFACODITARIFA1")
                If lDdlTARIFACODITARIFA Is Nothing Then
                    lDdlTARIFACODITARIFA = New SISPACAL.WebUC.ddlTARIFA
                    lDdlTARIFACODITARIFA.Recuperar()
                End If
                Dim mTARIFACODITARIFA As String
                mTARIFACODITARIFA = CType(e.Row.FindControl("Label_CODITARIFA1"), Label).Text
                Dim lItem As ListItem = lDdlTARIFACODITARIFA.Items.FindByValue(mTARIFACODITARIFA)
                If mTARIFACODITARIFA <> "" And Not lItem Is Nothing Then
                    mDdlTARIFACODITARIFA.Items.Add(New ListItem(lItem.Text, lItem.Value))
                    mDdlTARIFACODITARIFA.SelectedValue = mTARIFACODITARIFA
                End If
            End If
    ...
    Private Sub gvLista_RowDeleting(ByVal source As System.Object, ByVal e As System.Web.UI.WebControls.GridViewDeleteEventArgs) Handles gvLista.RowDeleting
        If Me.mComponente.EliminarUBICACION(CType(Me.gvLista.Rows(e.RowIndex).FindControl("LinkButton1"), LinkButton).ToolTip) <> 1 Then
            'Si se cometio un error
            Me.AsignarMensaje("Error al Eliminar Registro", True, True)
            e.Cancel = True
        Else
        If Me.ViewState("PorTARIFA") Then
            Me.CargarDatosPorTARIFA(Me.ViewState("CODITARIFA"))
            Return
        End If
    ...
    Public Function DevolverSeleccionados() As ListaUBICACION
        Dim mLista As New ListaUBICACION
        For Each mRow As GridViewRow In Me.gvLista.Rows
            If CType(mRow.FindControl("CheckBox_Seleccionar"), CheckBox).Checked Then
                ...
                mEntidad.CODIUBICACION = CInt(CType(mRow.FindControl("Label_CODIUBICACION"), Label).Text)
                mLista.Add(mEntidad)
            End If
        Next
        Return mLista
