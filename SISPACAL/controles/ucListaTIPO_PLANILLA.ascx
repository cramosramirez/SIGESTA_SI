<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ucListaTIPO_PLANILLA.ascx.vb" Inherits="controles_ucListaTIPO_PLANILLA" %>
	   ...
	   <Columns>
         <asp:TemplateField ShowHeader="False" Visible="False">
             <ItemTemplate>
	   	   ...
	   	   <asp:TemplateField HeaderText="Id tipo planilla" ItemStyle-HorizontalAlign="Right"> 
	   	   	   <ItemTemplate> 
                 <asp:LinkButton ID="LinkButtonDetalle" runat="server" CommandArgument='<%# DataBinder.Eval(Container, "DataItem.ID_TIPO_PLANILLA") %>'
                     CommandName="Editar" Text='<%# DataBinder.Eval(Container, "DataItem.ID_TIPO_PLANILLA") %>'></asp:LinkButton>
	   	   	   	   <asp:Label id="Label_ID_TIPO_PLANILLA" runat="server" Visible="False" Text='<%# DataBinder.Eval(Container, "DataItem.ID_TIPO_PLANILLA") %>'>
	   	   	   	   </asp:Label>
	   	   	   </ItemTemplate> 
	   	   </asp:TemplateField> 
	   	   <asp:BoundField DataField="NOMBRE_TIPO_PLANILLA" HeaderText="Nombre tipo planilla"  ItemStyle-HorizontalAlign="Left"></asp:BoundField>
	   	   ...
	   	   <asp:TemplateField>
	   	   	   <ItemTemplate>
	   	   	   	   <asp:LinkButton ID="LinkButton1" runat="server" CommandName="Delete" CausesValidation="False" ToolTip='<%# DataBinder.Eval(Container, "DataItem.ID_TIPO_PLANILLA") %>'>
