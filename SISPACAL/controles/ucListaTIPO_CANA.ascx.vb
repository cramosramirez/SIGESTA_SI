...
''' -----------------------------------------------------------------------------
''' Project	 : SISPACAL
''' Class	 : ucListaTIPO_CANA
''' 
''' -----------------------------------------------------------------------------
''' <summary>
''' Clase del Control de Usuario para mostrar un listado de la tabla TIPO_CANA
''' </summary>
''' <remarks>
...
''' </history>
''' -----------------------------------------------------------------------------
Partial Class controles_ucListaTIPO_CANA
    Inherits ucBase
 
    Private mComponente As New cTIPO_CANA
    Public Event Seleccionado(ByVal ID_TIPO_CANA As Int32) 
    Public Event Editando(ByVal ID_TIPO_CANA As Int32) 
...
#Region"Propiedades"
    ...
    Public Property HeaderNOMBRE_CANA() As String
        Get
...
#End Region
    ...
    Public Function CargarDatos() As Integer
        Dim lTIPO_CANA As ListaTIPO_CANA
        lTIPO_CANA = Me.mComponente.ObtenerLista()
        If lTIPO_CANA is Nothing Then
            Me.gvLista.Visible = False
            Return -1
        End If
        Me.gvLista.SelectedIndex = -1
        Me.gvLista.Visible = True
        Me.gvLista.DataSource = lTIPO_CANA
        Me.gvLista.DataBind()
        Return 1
    End Function
    ...
    Protected Sub gvLista_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles gvLista.RowDataBound
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            Dim mLabelID_TIPO_CANA As Label
            mLabelID_TIPO_CANA = e.Row.FindControl("Label_ID_TIPO_CANA")
            mLabelID_TIPO_CANA.Visible = Not Me.PermitirEditar
    ...
    Private Sub gvLista_RowDeleting(ByVal source As System.Object, ByVal e As System.Web.UI.WebControls.GridViewDeleteEventArgs) Handles gvLista.RowDeleting
        If Me.mComponente.EliminarTIPO_CANA(CInt(CType(Me.gvLista.Rows(e.RowIndex).FindControl("LinkButton1"), LinkButton).ToolTip)) <> 1 Then
    ...
    Public Function DevolverSeleccionados() As ListaTIPO_CANA
        Dim mLista As New ListaTIPO_CANA
        For Each mRow As GridViewRow In Me.gvLista.Rows
            If CType(mRow.FindControl("CheckBox_Seleccionar"), CheckBox).Checked Then
                ...
                mEntidad.ID_TIPO_CANA = CInt(CType(mRow.FindControl("Label_ID_TIPO_CANA"), Label).Text)
                mLista.Add(mEntidad)
            End If
        Next
        Return mLista
