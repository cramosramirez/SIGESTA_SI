...
''' -----------------------------------------------------------------------------
''' Project	 : SISPACAL
''' Class	 : ucListaCHEQUE_PARTIDA
''' 
''' -----------------------------------------------------------------------------
''' <summary>
''' Clase del Control de Usuario para mostrar un listado de la tabla CHEQUE_PARTIDA
''' </summary>
''' <remarks>
...
''' </history>
''' -----------------------------------------------------------------------------
Partial Class controles_ucListaCHEQUE_PARTIDA
    Inherits ucBase
 
    Private mComponente As New cCHEQUE_PARTIDA
    Public Event Seleccionado(ByVal ID_CHEQUE_PARTIDA As Int32) 
    Public Event Editando(ByVal ID_CHEQUE_PARTIDA As Int32) 
...
#Region"Propiedades"
    ...
    Public Property HeaderID_CHEQUE_PARTIDA() As String
        Get
    ...
    Public Property HeaderDESCRIPCION_ADICIONAL() As String
        Get
    ...
    Public Property HeaderDEBE() As String
        Get
    ...
    Public Property HeaderHABER() As String
        Get
...
#End Region
    ...
    Public Function CargarDatos() As Integer
        Dim lCHEQUE_PARTIDA As ListaCHEQUE_PARTIDA
        lCHEQUE_PARTIDA = Me.mComponente.ObtenerLista()
        If lCHEQUE_PARTIDA is Nothing Then
            Me.gvLista.Visible = False
            Return -1
        End If
        Me.gvLista.SelectedIndex = -1
        Me.gvLista.Visible = True
        Me.gvLista.DataSource = lCHEQUE_PARTIDA
        Me.gvLista.DataBind()
        Return 1
    End Function
    ...
    ''' <summary>
    ''' FunciÃ³n que Carga la informaciÃ³n de los registros de la tabla CHEQUE_PARTIDA
    ''' filtrado por la tabla CHEQUE_PLANILLA
    ''' </summary>
    ...
    ''' </history>
    ''' -----------------------------------------------------------------------------
    Public Function CargarDatosPorCHEQUE_PLANILLA(ByVal ID_CHEQUE_PLANILLA As Int32) As Integer
        Dim lCHEQUE_PARTIDA As ListaCHEQUE_PARTIDA
        lCHEQUE_PARTIDA = Me.mComponente.ObtenerListaPorCHEQUE_PLANILLA(ID_CHEQUE_PLANILLA)
        If lCHEQUE_PARTIDA is Nothing Then
            Me.gvLista.Visible = False
            Return -1
        End If
        Me.ViewState("PorCHEQUE_PLANILLA") = True
        Me.ViewState("ID_CHEQUE_PLANILLA") = ID_CHEQUE_PLANILLA
        Me.gvLista.SelectedIndex = -1
        Me.gvLista.Visible = True
        Me.gvLista.DataSource = lCHEQUE_PARTIDA
        Me.gvLista.DataBind()
    ...
    Private lDdlCHEQUE_PLANILLAID_CHEQUE_PLANILLA As SISPACAL.WebUC.ddlCHEQUE_PLANILLA
    ...
    Protected Sub gvLista_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles gvLista.RowDataBound
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            Dim mLabelID_CHEQUE_PARTIDA As Label
            mLabelID_CHEQUE_PARTIDA = e.Row.FindControl("Label_ID_CHEQUE_PARTIDA")
            mLabelID_CHEQUE_PARTIDA.Visible = Not Me.PermitirEditar
            lbDetalle.Visible = Me.PermitirEditar
            If Me.VerID_CHEQUE_PLANILLA Then
                Dim mDdlCHEQUE_PLANILLAID_CHEQUE_PLANILLA As SISPACAL.WebUC.ddlCHEQUE_PLANILLA
                mDdlCHEQUE_PLANILLAID_CHEQUE_PLANILLA = e.Row.FindControl("DdlCHEQUE_PLANILLAID_CHEQUE_PLANILLA1")
                If lDdlCHEQUE_PLANILLAID_CHEQUE_PLANILLA Is Nothing Then
                    lDdlCHEQUE_PLANILLAID_CHEQUE_PLANILLA = New SISPACAL.WebUC.ddlCHEQUE_PLANILLA
                    lDdlCHEQUE_PLANILLAID_CHEQUE_PLANILLA.Recuperar()
                End If
                Dim mCHEQUE_PLANILLAID_CHEQUE_PLANILLA As String
                mCHEQUE_PLANILLAID_CHEQUE_PLANILLA = CType(e.Row.FindControl("Label_ID_CHEQUE_PLANILLA1"), Label).Text
                Dim lItem As ListItem = lDdlCHEQUE_PLANILLAID_CHEQUE_PLANILLA.Items.FindByValue(mCHEQUE_PLANILLAID_CHEQUE_PLANILLA)
                If mCHEQUE_PLANILLAID_CHEQUE_PLANILLA <> "" And Not lItem Is Nothing Then
                    mDdlCHEQUE_PLANILLAID_CHEQUE_PLANILLA.Items.Add(New ListItem(lItem.Text, lItem.Value))
                    mDdlCHEQUE_PLANILLAID_CHEQUE_PLANILLA.SelectedValue = mCHEQUE_PLANILLAID_CHEQUE_PLANILLA
                End If
            End If
    ...
    Private Sub gvLista_RowDeleting(ByVal source As System.Object, ByVal e As System.Web.UI.WebControls.GridViewDeleteEventArgs) Handles gvLista.RowDeleting
        If Me.mComponente.EliminarCHEQUE_PARTIDA(CInt(CType(Me.gvLista.Rows(e.RowIndex).FindControl("LinkButton1"), LinkButton).ToolTip)) <> 1 Then
            'Si se cometio un error
            Me.AsignarMensaje("Error al Eliminar Registro", True, True)
            e.Cancel = True
        Else
        If Me.ViewState("PorCHEQUE_PLANILLA") Then
            Me.CargarDatosPorCHEQUE_PLANILLA(Me.ViewState("ID_CHEQUE_PLANILLA"))
            Return
        End If
    ...
    Public Function DevolverSeleccionados() As ListaCHEQUE_PARTIDA
        Dim mLista As New ListaCHEQUE_PARTIDA
        For Each mRow As GridViewRow In Me.gvLista.Rows
            If CType(mRow.FindControl("CheckBox_Seleccionar"), CheckBox).Checked Then
                ...
                mEntidad.ID_CHEQUE_PARTIDA = CInt(CType(mRow.FindControl("Label_ID_CHEQUE_PARTIDA"), Label).Text)
                mLista.Add(mEntidad)
            End If
        Next
        Return mLista
