...
''' -----------------------------------------------------------------------------
''' Project	 : SISPACAL
''' Class	 : ucListaPROVEEDOR_CODIGOREL
''' 
''' -----------------------------------------------------------------------------
''' <summary>
''' Clase del Control de Usuario para mostrar un listado de la tabla PROVEEDOR_CODIGOREL
''' </summary>
''' <remarks>
...
''' </history>
''' -----------------------------------------------------------------------------
Partial Class controles_ucListaPROVEEDOR_CODIGOREL
    Inherits ucListaBase
 
    Private mComponente As New cPROVEEDOR_CODIGOREL
    Public Event Seleccionado(ByVal ID_PROVEE_CODIGOREL As Int32) 
    Public Event Editando(ByVal ID_PROVEE_CODIGOREL As Int32) 
...
#Region"Propiedades"
    ...
    Public Property VerID_PROVEE_CODIGOREL() As Boolean
        Get
            Return Me.dxgvLista.Columns("ID_PROVEE_CODIGOREL").Visible
        End Get
        Set(ByVal Value As Boolean)
            Me.dxgvLista.Columns("ID_PROVEE_CODIGOREL").Visible = Value
        End Set
    End Property
    ...
    Public Property VerCODIPROVEEDOR_REL() As Boolean
        Get
            Return Me.dxgvLista.Columns("CODIPROVEEDOR_REL").Visible
        End Get
        Set(ByVal Value As Boolean)
            Me.dxgvLista.Columns("CODIPROVEEDOR_REL").Visible = Value
        End Set
    End Property
    ...
    Public Property HeaderID_PROVEE_CODIGOREL() As String
        Get
            Return Me.dxgvLista.Columns("ID_PROVEE_CODIGOREL").Caption
        End Get
        Set(ByVal Value As String)
            Me.dxgvLista.Columns("ID_PROVEE_CODIGOREL").Caption = Value
        End Set
    End Property
    ...
    Public Property HeaderCODIPROVEEDOR_REL() As String
        Get
            Return Me.dxgvLista.Columns("CODIPROVEEDOR_REL").Caption
        End Get
        Set(ByVal Value As String)
            Me.dxgvLista.Columns("CODIPROVEEDOR_REL").Caption = Value
        End Set
    End Property
...
#End Region
    ...
    Protected Sub dxgvLista_CustomJSProperties(ByVal sender As Object, ByVal e As DevExpress.Web.ASPxGridViewClientJSPropertiesEventArgs) Handles dxgvLista.CustomJSProperties
        If Me.PermitirSeleccionParaCombo Then
            ...
            For i As Integer = 0 To grid.VisibleRowCount - 1
                keyValues(i) = grid.GetRowValues(i, "ID_PROVEE_CODIGOREL")
    ...
    Public Function DevolverSeleccionados() As listaPROVEEDOR_CODIGOREL
        Dim mLista As New listaPROVEEDOR_CODIGOREL
        For Each llave As Decimal In Me.dxgvLista.GetSelectedFieldValues("ID_PROVEE_CODIGOREL")
            Dim lEntidad As New PROVEEDOR_CODIGOREL
            lEntidad.ID_PROVEE_CODIGOREL = llave
            mLista.Add(lEntidad)
        Next
        Return mLista
    End Function
    ...
    Protected Sub dxgvLista_CustomButtonCallback(ByVal sender As Object, ByVal e As DevExpress.Web.ASPxGridViewCustomButtonCallbackEventArgs) Handles dxgvLista.CustomButtonCallback
        If e.ButtonID = "btnEliminar" Then
            Dim lEntidad As PROVEEDOR_CODIGOREL = CType(Me.dxgvLista.GetRow(e.VisibleIndex), PROVEEDOR_CODIGOREL)

            If Me.mComponente.EliminarPROVEEDOR_CODIGOREL(lEntidad.ID_PROVEE_CODIGOREL) <> 1 Then
