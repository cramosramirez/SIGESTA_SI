...
''' -----------------------------------------------------------------------------
''' Project	 : SISPACAL
''' Class	 : ucListaTIPO_PROVEEDOR
''' 
''' -----------------------------------------------------------------------------
''' <summary>
''' Clase del Control de Usuario para mostrar un listado de la tabla TIPO_PROVEEDOR
''' </summary>
''' <remarks>
...
''' </history>
''' -----------------------------------------------------------------------------
Partial Class controles_ucListaTIPO_PROVEEDOR
    Inherits ucBase
 
    Private mComponente As New cTIPO_PROVEEDOR
    Public Event Seleccionado(ByVal ID_TIPO_PROVEEDOR As Int32) 
    Public Event Editando(ByVal ID_TIPO_PROVEEDOR As Int32) 
...
#Region"Propiedades"
    ...
    Public Property HeaderNOMBRE_TIPO_PROVEEDOR() As String
        Get
...
#End Region
    ...
    ''' -----------------------------------------------------------------------------
    ''' <summary>
    ''' FunciÃ³n que Carga la informaciÃ³n de los registros de la tabla TIPO_PROVEEDOR
    ''' </summary>
    ''' <remarks>
    ''' </remarks>
    ''' <history>
    ...
    Public Function CargarDatos() As Integer
        Dim lTIPO_PROVEEDOR As ListaTIPO_PROVEEDOR
        lTIPO_PROVEEDOR = Me.mComponente.ObtenerLista()
        If lTIPO_PROVEEDOR is Nothing Then
            Me.gvLista.Visible = False
            Return -1
        End If
        Me.gvLista.SelectedIndex = -1
        Me.gvLista.Visible = True
        Me.gvLista.DataSource = lTIPO_PROVEEDOR
        Me.gvLista.DataBind()
        Return 1
    End Function
    ...
    Protected Sub gvLista_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles gvLista.RowDataBound
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            Dim mLabelID_TIPO_PROVEEDOR As Label
            mLabelID_TIPO_PROVEEDOR = e.Row.FindControl("Label_ID_TIPO_PROVEEDOR")
            mLabelID_TIPO_PROVEEDOR.Visible = Not Me.PermitirEditar
    ...
    Private Sub gvLista_RowDeleting(ByVal source As System.Object, ByVal e As System.Web.UI.WebControls.GridViewDeleteEventArgs) Handles gvLista.RowDeleting
        If Me.mComponente.EliminarTIPO_PROVEEDOR(CInt(CType(Me.gvLista.Rows(e.RowIndex).FindControl("LinkButton1"), LinkButton).ToolTip)) <> 1 Then
    ...
    Public Function DevolverSeleccionados() As ListaTIPO_PROVEEDOR
        Dim mLista As New ListaTIPO_PROVEEDOR
        For Each mRow As GridViewRow In Me.gvLista.Rows
            If CType(mRow.FindControl("CheckBox_Seleccionar"), CheckBox).Checked Then
                ...
                mEntidad.ID_TIPO_PROVEEDOR = CInt(CType(mRow.FindControl("Label_ID_TIPO_PROVEEDOR"), Label).Text)
                mLista.Add(mEntidad)
            End If
        Next
        Return mLista
