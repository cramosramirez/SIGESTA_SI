...
''' -----------------------------------------------------------------------------
''' <summary>
''' Clase del Control de Usuario para mostrar un listado de la tabla ZAFGAS
''' </summary>
''' <remarks>
...
''' </history>
''' -----------------------------------------------------------------------------
Partial Class controles_ucListaZAFGAS
    Inherits ucBase
 
    Private mComponente As New cZAFGAS
    Public Event Seleccionado(ByVal MEDIO As String) 
    Public Event Editando(ByVal MEDIO As String) 
...
#Region"Propiedades"
    ...
    Public Property HeaderMEDIO() As String
        Get
    ...
    Public Property HeaderGASBASE() As String
        Get
    ...
    Public Property HeaderGASPRECIO() As String
        Get
...
#End Region
    ...
    ''' -----------------------------------------------------------------------------
    ''' <summary>
    ''' FunciÃ³n que Carga la informaciÃ³n de los registros de la tabla ZAFGAS
    ''' </summary>
    ''' <remarks>
    ''' </remarks>
    ''' <history>
    ...
    Public Function CargarDatos() As Integer
        Dim lZAFGAS As ListaZAFGAS
        lZAFGAS = Me.mComponente.ObtenerLista()
        If lZAFGAS is Nothing Then
            Me.gvLista.Visible = False
            Return -1
        End If
        Me.gvLista.SelectedIndex = -1
        Me.gvLista.Visible = True
        Me.gvLista.DataSource = lZAFGAS
        Me.gvLista.DataBind()
        Return 1
    End Function
    ...
    Protected Sub gvLista_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles gvLista.RowDataBound
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            Dim mLabelMEDIO As Label
            mLabelMEDIO = e.Row.FindControl("Label_MEDIO")
            mLabelMEDIO.Visible = Not Me.PermitirEditar
    ...
    Private Sub gvLista_RowDeleting(ByVal source As System.Object, ByVal e As System.Web.UI.WebControls.GridViewDeleteEventArgs) Handles gvLista.RowDeleting
        If Me.mComponente.EliminarZAFGAS(CType(Me.gvLista.Rows(e.RowIndex).FindControl("LinkButton1"), LinkButton).ToolTip) <> 1 Then
    ...
    Public Function DevolverSeleccionados() As ListaZAFGAS
        Dim mLista As New ListaZAFGAS
        For Each mRow As GridViewRow In Me.gvLista.Rows
            If CType(mRow.FindControl("CheckBox_Seleccionar"), CheckBox).Checked Then
                ...
                mEntidad.MEDIO = CInt(CType(mRow.FindControl("Label_MEDIO"), Label).Text)
                mLista.Add(mEntidad)
            End If
        Next
        Return mLista
