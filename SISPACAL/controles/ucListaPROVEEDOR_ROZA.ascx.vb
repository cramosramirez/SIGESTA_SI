...
''' -----------------------------------------------------------------------------
''' Project	 : SISPACAL
''' Class	 : ucListaPROVEEDOR_ROZA
''' 
''' -----------------------------------------------------------------------------
''' <summary>
''' Clase del Control de Usuario para mostrar un listado de la tabla PROVEEDOR_ROZA
''' </summary>
''' <remarks>
...
''' </history>
''' -----------------------------------------------------------------------------
Partial Class controles_ucListaPROVEEDOR_ROZA
    Inherits ucListaBase
 
    Private mComponente As New cPROVEEDOR_ROZA
    Public Event Seleccionado(ByVal ID_PROVEEDOR_ROZA As Int32) 
    Public Event Editando(ByVal ID_PROVEEDOR_ROZA As Int32) 
...
#Region"Propiedades"
    ...
    Public Property VerNOMBRE_PROVEEDOR_ROZA() As Boolean
        Get
            Return Me.dxgvLista.Columns("NOMBRE_PROVEEDOR_ROZA").Visible
        End Get
        Set(ByVal Value As Boolean)
            Me.dxgvLista.Columns("NOMBRE_PROVEEDOR_ROZA").Visible = Value
        End Set
    End Property
    ...
    Public Property VerES_CONTRIBUYENTE() As Boolean
        Get
            Return Me.dxgvLista.Columns("ES_CONTRIBUYENTE").Visible
        End Get
        Set(ByVal Value As Boolean)
            Me.dxgvLista.Columns("ES_CONTRIBUYENTE").Visible = Value
        End Set
    End Property

    Public Property VerFACTOR_PAGO() As Boolean
        Get
            Return Me.dxgvLista.Columns("FACTOR_PAGO").Visible
        End Get
        Set(ByVal Value As Boolean)
            Me.dxgvLista.Columns("FACTOR_PAGO").Visible = Value
        End Set
    End Property
    ...
    Public Property HeaderNOMBRE_PROVEEDOR_ROZA() As String
        Get
            Return Me.dxgvLista.Columns("NOMBRE_PROVEEDOR_ROZA").Caption
        End Get
        Set(ByVal Value As String)
            Me.dxgvLista.Columns("NOMBRE_PROVEEDOR_ROZA").Caption = Value
        End Set
    End Property
    ...
    Public Property HeaderES_CONTRIBUYENTE() As String
        Get
            Return Me.dxgvLista.Columns("ES_CONTRIBUYENTE").Caption
        End Get
        Set(ByVal Value As String)
            Me.dxgvLista.Columns("ES_CONTRIBUYENTE").Caption = Value
        End Set
    End Property

    Public Property HeaderFACTOR_PAGO() As String
        Get
            Return Me.dxgvLista.Columns("FACTOR_PAGO").Caption
        End Get
        Set(ByVal Value As String)
            Me.dxgvLista.Columns("FACTOR_PAGO").Caption = Value
        End Set
    End Property
...
#End Region
    ...
    Protected Sub dxgvLista_CustomJSProperties(ByVal sender As Object, ByVal e As DevExpress.Web.ASPxGridViewClientJSPropertiesEventArgs) Handles dxgvLista.CustomJSProperties
        If Me.PermitirSeleccionParaCombo Then
            ...
            For i As Integer = 0 To grid.VisibleRowCount - 1
                keyValues(i) = grid.GetRowValues(i, "ID_PROVEEDOR_ROZA")
                keyNames(i) = grid.GetRowValues(i, "NOMBRE_PROVEEDOR_ROZA")
            Next i
    ...
    Public Function DevolverSeleccionados() As listaPROVEEDOR_ROZA
        Dim mLista As New listaPROVEEDOR_ROZA
        For Each llave As Decimal In Me.dxgvLista.GetSelectedFieldValues("ID_PROVEEDOR_ROZA")
            Dim lEntidad As New PROVEEDOR_ROZA
            lEntidad.ID_PROVEEDOR_ROZA = llave
            mLista.Add(lEntidad)
        Next
        Return mLista
    End Function
    ...
    Protected Sub dxgvLista_CustomButtonCallback(ByVal sender As Object, ByVal e As DevExpress.Web.ASPxGridViewCustomButtonCallbackEventArgs) Handles dxgvLista.CustomButtonCallback
        If e.ButtonID = "btnEliminar" Then
            Dim lEntidad As PROVEEDOR_ROZA = CType(Me.dxgvLista.GetRow(e.VisibleIndex), PROVEEDOR_ROZA)

            If Me.mComponente.EliminarPROVEEDOR_ROZA(lEntidad.ID_PROVEEDOR_ROZA) <> 1 Then
    ...
    Protected Sub dxgvLista_CustomUnboundColumnData(sender As Object, e As DevExpress.Web.ASPxGridViewColumnDataEventArgs) Handles dxgvLista.CustomUnboundColumnData
        If e.Column.FieldName = "TIPO_ROZA" Then
