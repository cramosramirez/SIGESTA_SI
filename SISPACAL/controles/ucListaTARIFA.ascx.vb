...
''' -----------------------------------------------------------------------------
''' <summary>
''' Clase del Control de Usuario para mostrar un listado de la tabla TARIFA
''' </summary>
''' <remarks>
...
''' </history>
''' -----------------------------------------------------------------------------
Partial Class controles_ucListaTARIFA
    Inherits ucBase
 
    Private mComponente As New cTARIFA
    Public Event Seleccionado(ByVal CODITARIFA As String) 
    Public Event Editando(ByVal CODITARIFA As String) 
...
#Region"Propiedades"
    ...
    Public Property HeaderCODITARIFA() As String
        Get
    ...
    Public Property HeaderCORTA() As String
        Get
    ...
    Public Property HeaderLARGA() As String
        Get
...
#End Region
    ...
    Public Function CargarDatos() As Integer
        Dim lTARIFA As ListaTARIFA
        lTARIFA = Me.mComponente.ObtenerLista()
        If lTARIFA is Nothing Then
            Me.gvLista.Visible = False
            Return -1
        End If
        Me.gvLista.SelectedIndex = -1
        Me.gvLista.Visible = True
        Me.gvLista.DataSource = lTARIFA
        Me.gvLista.DataBind()
        Return 1
    End Function
    ...
    Protected Sub gvLista_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles gvLista.RowDataBound
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            Dim mLabelCODITARIFA As Label
            mLabelCODITARIFA = e.Row.FindControl("Label_CODITARIFA")
            mLabelCODITARIFA.Visible = Not Me.PermitirEditar
    ...
    Private Sub gvLista_RowDeleting(ByVal source As System.Object, ByVal e As System.Web.UI.WebControls.GridViewDeleteEventArgs) Handles gvLista.RowDeleting
        If Me.mComponente.EliminarTARIFA(CType(Me.gvLista.Rows(e.RowIndex).FindControl("LinkButton1"), LinkButton).ToolTip) <> 1 Then
    ...
    Public Function DevolverSeleccionados() As ListaTARIFA
        Dim mLista As New ListaTARIFA
        For Each mRow As GridViewRow In Me.gvLista.Rows
            If CType(mRow.FindControl("CheckBox_Seleccionar"), CheckBox).Checked Then
                Dim mEntidad As New TARIFA
                mEntidad.CODITARIFA = CInt(CType(mRow.FindControl("Label_CODITARIFA"), Label).Text)
                mLista.Add(mEntidad)
            End If
        Next
        Return mLista
