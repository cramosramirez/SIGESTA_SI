...
''' -----------------------------------------------------------------------------
''' Project	 : SISPACAL
''' Class	 : ucListaTARIFA_ROZA
''' 
''' -----------------------------------------------------------------------------
''' <summary>
''' Clase del Control de Usuario para mostrar un listado de la tabla TARIFA_ROZA
''' </summary>
''' <remarks>
...
''' </history>
''' -----------------------------------------------------------------------------
Partial Class controles_ucListaTARIFA_ROZA
    Inherits ucBase
 
    Private mComponente As New cTARIFA_ROZA
    Public Event Seleccionado(ByVal ID_TARIFA_ROZA As Int32) 
    Public Event Editando(ByVal ID_TARIFA_ROZA As Int32) 
...
#Region"Propiedades"
    ...
    Public Property VerCARGA_SIN_TRIPULACION() As Boolean
        Get
    ...
    Public Property HeaderID_TARIFA_ROZA() As String
        Get
    ...
    Public Property HeaderROZA() As String
        Get
    ...
    Public Property HeaderCARGA_SIN_TRIPULACION() As String
        Get
...
#End Region
    ...
    ''' -----------------------------------------------------------------------------
    ''' <summary>
    ''' FunciÃ³n que Carga la informaciÃ³n de los registros de la tabla TARIFA_ROZA
    ''' </summary>
    ''' <remarks>
    ''' </remarks>
    ''' <history>
    ...
    Public Function CargarDatos() As Integer
        Dim lTARIFA_ROZA As ListaTARIFA_ROZA
        lTARIFA_ROZA = Me.mComponente.ObtenerLista()
        If lTARIFA_ROZA is Nothing Then
            Me.gvLista.Visible = False
            Return -1
        End If
        Me.gvLista.SelectedIndex = -1
        Me.gvLista.Visible = True
        Me.gvLista.DataSource = lTARIFA_ROZA
        Me.gvLista.DataBind()
        Return 1
    End Function
    ...
    Public Function CargarDatosPorLOTES(ByVal ACCESLOTE As String) As Integer
        Dim lTARIFA_ROZA As ListaTARIFA_ROZA
        lTARIFA_ROZA = Me.mComponente.ObtenerListaPorLOTES(ACCESLOTE)
        If lTARIFA_ROZA is Nothing Then
            Me.gvLista.Visible = False
            Return -1
        End If
    ...
    Protected Sub gvLista_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles gvLista.RowDataBound
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            Dim mLabelID_TARIFA_ROZA As Label
            mLabelID_TARIFA_ROZA = e.Row.FindControl("Label_ID_TARIFA_ROZA")
            mLabelID_TARIFA_ROZA.Visible = Not Me.PermitirEditar
    ...
    Private Sub gvLista_RowDeleting(ByVal source As System.Object, ByVal e As System.Web.UI.WebControls.GridViewDeleteEventArgs) Handles gvLista.RowDeleting
        If Me.mComponente.EliminarTARIFA_ROZA(CInt(CType(Me.gvLista.Rows(e.RowIndex).FindControl("LinkButton1"), LinkButton).ToolTip)) <> 1 Then
    ...
    Public Function DevolverSeleccionados() As ListaTARIFA_ROZA
        Dim mLista As New ListaTARIFA_ROZA
        For Each mRow As GridViewRow In Me.gvLista.Rows
            If CType(mRow.FindControl("CheckBox_Seleccionar"), CheckBox).Checked Then
                ...
                mEntidad.ID_TARIFA_ROZA = CInt(CType(mRow.FindControl("Label_ID_TARIFA_ROZA"), Label).Text)
                mLista.Add(mEntidad)
            End If
        Next
        Return mLista
