...
''' -----------------------------------------------------------------------------
''' Project	 : SISPACAL
''' Class	 : ucListaORDEN_COMBUSTIBLE_NUMERACION
''' 
''' -----------------------------------------------------------------------------
''' <summary>
''' Clase del Control de Usuario para mostrar un listado de la tabla ORDEN_COMBUSTIBLE_NUMERACION
''' </summary>
''' <remarks>
...
''' </history>
''' -----------------------------------------------------------------------------
Partial Class controles_ucListaORDEN_COMBUSTIBLE_NUMERACION
    Inherits ucBase
 
    Private mComponente As New cORDEN_COMBUSTIBLE_NUMERACION
    Public Event Seleccionado(ByVal ID_ORDEN_COMBUSTIBLE_NUM As Int32) 
    Public Event Editando(ByVal ID_ORDEN_COMBUSTIBLE_NUM As Int32) 
...
#Region"Propiedades"
    ...
    Public Property HeaderSERIE_ORDEN_COMBUSTIBLE() As String
        Get
    ...
    Public Property HeaderNO_INICIAL() As String
        Get
    ...
    Public Property HeaderNO_FINAL() As String
        Get
...
#End Region
    ...
    Public Function CargarDatos() As Integer
        Dim lORDEN_COMBUSTIBLE_NUMERACION As ListaORDEN_COMBUSTIBLE_NUMERACION
        lORDEN_COMBUSTIBLE_NUMERACION = Me.mComponente.ObtenerLista()
        If lORDEN_COMBUSTIBLE_NUMERACION is Nothing Then
            Me.gvLista.Visible = False
            Return -1
        End If
        Me.gvLista.SelectedIndex = -1
        Me.gvLista.Visible = True
        Me.gvLista.DataSource = lORDEN_COMBUSTIBLE_NUMERACION
        Me.gvLista.DataBind()
        Return 1
    End Function
    ...
    Public Function CargarDatosPorZAFRA(ByVal ID_ZAFRA As Int32) As Integer
        Dim lORDEN_COMBUSTIBLE_NUMERACION As ListaORDEN_COMBUSTIBLE_NUMERACION
        lORDEN_COMBUSTIBLE_NUMERACION = Me.mComponente.ObtenerListaPorZAFRA(ID_ZAFRA)
        If lORDEN_COMBUSTIBLE_NUMERACION is Nothing Then
            Me.gvLista.Visible = False
            Return -1
        End If
    ...
    Protected Sub gvLista_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles gvLista.RowDataBound
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            Dim mLabelID_ORDEN_COMBUSTIBLE_NUM As Label
            mLabelID_ORDEN_COMBUSTIBLE_NUM = e.Row.FindControl("Label_ID_ORDEN_COMBUSTIBLE_NUM")
            mLabelID_ORDEN_COMBUSTIBLE_NUM.Visible = Not Me.PermitirEditar
    ...
    Private Sub gvLista_RowDeleting(ByVal source As System.Object, ByVal e As System.Web.UI.WebControls.GridViewDeleteEventArgs) Handles gvLista.RowDeleting
        If Me.mComponente.EliminarORDEN_COMBUSTIBLE_NUMERACION(CInt(CType(Me.gvLista.Rows(e.RowIndex).FindControl("LinkButton1"), LinkButton).ToolTip)) <> 1 Then
    ...
    Public Function DevolverSeleccionados() As ListaORDEN_COMBUSTIBLE_NUMERACION
        Dim mLista As New ListaORDEN_COMBUSTIBLE_NUMERACION
        For Each mRow As GridViewRow In Me.gvLista.Rows
            If CType(mRow.FindControl("CheckBox_Seleccionar"), CheckBox).Checked Then
                ...
                mEntidad.ID_ORDEN_COMBUSTIBLE_NUM = CInt(CType(mRow.FindControl("Label_ID_ORDEN_COMBUSTIBLE_NUM"), Label).Text)
                mLista.Add(mEntidad)
            End If
        Next
        Return mLista
