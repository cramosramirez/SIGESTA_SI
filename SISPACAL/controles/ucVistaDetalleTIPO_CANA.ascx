<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ucVistaDetalleTIPO_CANA.ascx.vb" Inherits="controles_ucVistaDetalleTIPO_CANA" %>
<TABLE id="VistaDetalle" cellSpacing="0" cellPadding="0" width="100%" border="0">
	<TR runat="server" id="trID_TIPO_CANA">
		<TD width="10"></TD>
		<TD align="right">
			<asp:Label CssClass="Normal" id="lblID_TIPO_CANA" runat="server">Id tipo cana:</asp:label></TD>
		<TD>
			<asp:TextBox CssClass="TextoLlaveDerecha" id="txtID_TIPO_CANA" runat="server" ReadOnly="True" Width="70px"></asp:textbox></TD>
		<TD width="10"></TD>
	</TR>
	<TR runat="server" id="trNOMBRE_CANA">
		<TD width="10"></TD>
		<TD align="right">
			<asp:Label CssClass="Normal" id="lblNOMBRE_CANA" runat="server">Nombre cana:</asp:label></TD>
		<TD>
			<asp:TextBox CssClass="TextoNormalIzquierda" id="txtNOMBRE_CANA" runat="server" Width="100px" MaxLength="50"></asp:TextBox><asp:RequiredFieldValidator id="rfvNOMBRE_CANA" runat="server" Display="Dynamic" ControlToValidate="txtNOMBRE_CANA" ErrorMessage="Nombre cana es Requerido"></asp:RequiredFieldValidator>
</TD>
		<TD width="10"></TD>
	</TR>
