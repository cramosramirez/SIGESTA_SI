<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ucVistaDetalleAPLICACION_DESCTO.ascx.vb" Inherits="controles_ucVistaDetalleAPLICACION_DESCTO" %>
<TABLE id="VistaDetalle" cellSpacing="0" cellPadding="0" width="100%" border="0">
	<TR runat="server" id="trID_APLICACION_DESCTO">
		<TD width="10"></TD>
		<TD align="right">
			<asp:Label CssClass="Normal" id="lblID_APLICACION_DESCTO" runat="server">Id aplicacion descto:</asp:label></TD>
		<TD>
			<asp:TextBox CssClass="TextoLlaveDerecha" id="txtID_APLICACION_DESCTO" runat="server" ReadOnly="True" Width="70px"></asp:textbox></TD>
		<TD width="10"></TD>
	</TR>
	<TR runat="server" id="trNOMBRE_APLICACION_DESCTO">
		<TD width="10"></TD>
		<TD align="right">
			<asp:Label CssClass="Normal" id="lblNOMBRE_APLICACION_DESCTO" runat="server">Nombre aplicacion descto:</asp:label></TD>
		<TD>
			<asp:TextBox CssClass="TextoNormalIzquierda" id="txtNOMBRE_APLICACION_DESCTO" runat="server" Width="100px" MaxLength="10"></asp:TextBox><asp:RequiredFieldValidator id="rfvNOMBRE_APLICACION_DESCTO" runat="server" Display="Dynamic" ControlToValidate="txtNOMBRE_APLICACION_DESCTO" ErrorMessage="Nombre aplicacion descto es Requerido"></asp:RequiredFieldValidator>
</TD>
		<TD width="10"></TD>
	</TR>
