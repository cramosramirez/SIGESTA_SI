<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ucVistaDetalleTIPO_PLANILLA.ascx.vb" Inherits="controles_ucVistaDetalleTIPO_PLANILLA" %>
<TABLE id="VistaDetalle" cellSpacing="0" cellPadding="0" width="100%" border="0">
	<TR runat="server" id="trID_TIPO_PLANILLA">
		<TD width="10"></TD>
		<TD align="right">
			<asp:Label CssClass="Normal" id="lblID_TIPO_PLANILLA" runat="server">Id tipo planilla:</asp:label></TD>
		<TD>
			<asp:TextBox CssClass="TextoLlaveDerecha" id="txtID_TIPO_PLANILLA" runat="server" ReadOnly="True" Width="70px"></asp:textbox></TD>
		<TD width="10"></TD>
	</TR>
	<TR runat="server" id="trNOMBRE_TIPO_PLANILLA">
		<TD width="10"></TD>
		<TD align="right">
			<asp:Label CssClass="Normal" id="lblNOMBRE_TIPO_PLANILLA" runat="server">Nombre tipo planilla:</asp:label></TD>
		<TD>
			<asp:TextBox CssClass="TextoNormalIzquierda" id="txtNOMBRE_TIPO_PLANILLA" runat="server" Width="100px" MaxLength="100"></asp:TextBox><asp:RequiredFieldValidator id="rfvNOMBRE_TIPO_PLANILLA" runat="server" Display="Dynamic" ControlToValidate="txtNOMBRE_TIPO_PLANILLA" ErrorMessage="Nombre tipo planilla es Requerido"></asp:RequiredFieldValidator>
</TD>
		<TD width="10"></TD>
	</TR>
