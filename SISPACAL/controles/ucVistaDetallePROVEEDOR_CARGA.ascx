<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ucVistaDetallePROVEEDOR_CARGA.ascx.vb" Inherits="controles_ucVistaDetallePROVEEDOR_CARGA" %>
<TABLE id="VistaDetalle" cellSpacing="0" cellPadding="0" width="100%" border="0">
	<TR runat="server" id="trID_PROVEEDOR_CARGA">
		<TD width="10"></TD>
		<TD align="right">
			<asp:Label CssClass="Normal" id="lblID_PROVEEDOR_CARGA" runat="server">Id proveedor carga:</asp:label></TD>
		<TD>
			<asp:TextBox CssClass="TextoLlaveDerecha" id="txtID_PROVEEDOR_CARGA" runat="server" ReadOnly="True" Width="70px"></asp:textbox></TD>
		<TD width="10"></TD>
	</TR>
	<TR runat="server" id="trNOMBRE_PROVEEDOR_CARGA">
		<TD width="10"></TD>
		<TD align="right">
			<asp:Label CssClass="Normal" id="lblNOMBRE_PROVEEDOR_CARGA" runat="server">Nombre proveedor carga:</asp:label></TD>
		<TD>
			<asp:TextBox CssClass="TextoNormalIzquierda" id="txtNOMBRE_PROVEEDOR_CARGA" runat="server" Width="100px" MaxLength="200"></asp:TextBox><asp:RequiredFieldValidator id="rfvNOMBRE_PROVEEDOR_CARGA" runat="server" Display="Dynamic" ControlToValidate="txtNOMBRE_PROVEEDOR_CARGA" ErrorMessage="Nombre proveedor carga es Requerido"></asp:RequiredFieldValidator>
</TD>
		<TD width="10"></TD>
	</TR>
