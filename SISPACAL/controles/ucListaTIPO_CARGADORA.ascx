<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ucListaTIPO_CARGADORA.ascx.vb" Inherits="controles_ucListaTIPO_CARGADORA" %>
	   ...
	   <Columns>
         <asp:TemplateField ShowHeader="False" Visible="False">
             <ItemTemplate>
	   	   ...
	   	   <asp:TemplateField HeaderText="Id tipo cargadora" ItemStyle-HorizontalAlign="Right"> 
	   	   	   <ItemTemplate> 
                 <asp:LinkButton ID="LinkButtonDetalle" runat="server" CommandArgument='<%# DataBinder.Eval(Container, "DataItem.ID_TIPO_CARGADORA") %>'
                     CommandName="Editar" Text='<%# DataBinder.Eval(Container, "DataItem.ID_TIPO_CARGADORA") %>'></asp:LinkButton>
	   	   	   	   <asp:Label id="Label_ID_TIPO_CARGADORA" runat="server" Visible="False" Text='<%# DataBinder.Eval(Container, "DataItem.ID_TIPO_CARGADORA") %>'>
	   	   	   	   </asp:Label>
	   	   	   </ItemTemplate> 
	   	   </asp:TemplateField> 
	   	   <asp:BoundField DataField="NOMBRE_TIPO_CARGADORA" HeaderText="Nombre tipo cargadora"  ItemStyle-HorizontalAlign="Left"></asp:BoundField>
	   	   ...
	   	   <asp:TemplateField>
	   	   	   <ItemTemplate>
	   	   	   	   <asp:LinkButton ID="LinkButton1" runat="server" CommandName="Delete" CausesValidation="False" ToolTip='<%# DataBinder.Eval(Container, "DataItem.ID_TIPO_CARGADORA") %>'>
