...
''' -----------------------------------------------------------------------------
''' <summary>
''' Clase del Control de Usuario para mostrar un listado de la tabla PERFIL
''' </summary>
''' <remarks>
...
''' </history>
''' -----------------------------------------------------------------------------
Partial Class controles_ucListaPERFIL
    Inherits ucListaBase
 
    Private mComponente As New cPERFIL
    Public Event Seleccionado(ByVal ID_PERFIL As Int32) 
    Public Event Editando(ByVal ID_PERFIL As Int32) 
...
#Region"Propiedades"
    ...
    Public Property VerNOMBRE_PERFIL() As Boolean
        Get
            Return Me.dxgvLista.Columns("NOMBRE_PERFIL").Visible
        End Get
        Set(ByVal Value As Boolean)
            Me.dxgvLista.Columns("NOMBRE_PERFIL").Visible = Value
        End Set
    End Property
    ...
    Public Property HeaderNOMBRE_PERFIL() As String
        Get
            Return Me.dxgvLista.Columns("NOMBRE_PERFIL").Caption
        End Get
        Set(ByVal Value As String)
            Me.dxgvLista.Columns("NOMBRE_PERFIL").Caption = Value
        End Set
    End Property
...
#End Region
    ...
    Protected Sub dxgvLista_CustomJSProperties(ByVal sender As Object, ByVal e As DevExpress.Web.ASPxGridViewClientJSPropertiesEventArgs) Handles dxgvLista.CustomJSProperties
        If Me.PermitirSeleccionParaCombo Then
            ...
            For i As Integer = 0 To grid.VisibleRowCount - 1
                keyValues(i) = grid.GetRowValues(i, "ID_PERFIL")
                keyNames(i) = grid.GetRowValues(i, "NOMBRE_PERFIL")
            Next i
    ...
    Public Function DevolverSeleccionados() As listaPERFIL
        Dim mLista As New listaPERFIL
        For Each llave As Decimal In Me.dxgvLista.GetSelectedFieldValues("ID_PERFIL")
            Dim lEntidad As New PERFIL
            lEntidad.ID_PERFIL = llave
            mLista.Add(lEntidad)
        Next
        Return mLista
    End Function
    ...
    Protected Sub dxgvLista_CustomButtonCallback(ByVal sender As Object, ByVal e As DevExpress.Web.ASPxGridViewCustomButtonCallbackEventArgs) Handles dxgvLista.CustomButtonCallback
        If e.ButtonID = "btnEliminar" Then
            Dim lEntidad As PERFIL = CType(Me.dxgvLista.GetRow(e.VisibleIndex), PERFIL)

            If Me.mComponente.EliminarPERFIL(lEntidad.ID_PERFIL) <> 1 Then
