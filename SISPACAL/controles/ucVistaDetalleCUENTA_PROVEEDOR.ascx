<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ucVistaDetalleCUENTA_PROVEEDOR.ascx.vb" Inherits="controles_ucVistaDetalleCUENTA_PROVEEDOR" %>
<%@ Register TagPrefix="cc1" Namespace="SISPACAL.WebUC" Assembly="SISPACAL_WebUC" %>
<TABLE id="VistaDetalle" cellSpacing="0" cellPadding="0" width="100%" border="0">
	<TR runat="server" id="trID_CUENTA_PROVEEDOR">
		<TD width="10"></TD>
		<TD align="right">
			<asp:Label CssClass="Normal" id="lblID_CUENTA_PROVEEDOR" runat="server">Id cuenta proveedor:</asp:label></TD>
		<TD>
			<asp:TextBox CssClass="TextoLlaveDerecha" id="txtID_CUENTA_PROVEEDOR" runat="server" ReadOnly="True" Width="70px"></asp:textbox></TD>
		<TD width="10"></TD>
	</TR>
	<TR runat="server" id="trCUENTA">
		<TD width="10"></TD>
		<TD align="right">
			<asp:Label CssClass="Normal" id="lblCUENTA" runat="server">Cuenta:</asp:label></TD>
		<TD>
			<asp:TextBox CssClass="TextoNormalIzquierda" id="txtCUENTA" runat="server" Width="100px" MaxLength="20"></asp:TextBox><asp:RequiredFieldValidator id="rfvCUENTA" runat="server" Display="Dynamic" ControlToValidate="txtCUENTA" ErrorMessage="Cuenta es Requerido"></asp:RequiredFieldValidator>
</TD>
		<TD width="10"></TD>
	</TR>
	<TR runat="server" id="trCODIGO">
		...
		<TD>
			<asp:TextBox CssClass="TextoNormalIzquierda" id="txtCODIGO" runat="server" Width="100px" MaxLength="10"></asp:TextBox><asp:RequiredFieldValidator id="rfvCODIGO" runat="server" Display="Dynamic" ControlToValidate="txtCODIGO" ErrorMessage="Codigo es Requerido"></asp:RequiredFieldValidator>
</TD>
		<TD width="10"></TD>
	</TR>
