...
''' -----------------------------------------------------------------------------
''' Project	 : SISPACAL
''' Class	 : ucListaRECIBO_CANA_NUMERACION
''' 
''' -----------------------------------------------------------------------------
''' <summary>
''' Clase del Control de Usuario para mostrar un listado de la tabla RECIBO_CANA_NUMERACION
''' </summary>
''' <remarks>
...
''' </history>
''' -----------------------------------------------------------------------------
Partial Class controles_ucListaRECIBO_CANA_NUMERACION
    Inherits ucBase
 
    Private mComponente As New cRECIBO_CANA_NUMERACION
    Public Event Seleccionado(ByVal ID_RECIBO_CANA_NUM As Int32) 
    Public Event Editando(ByVal ID_RECIBO_CANA_NUM As Int32) 
...
#Region"Propiedades"
    ...
    Public Property HeaderID_RECIBO_CANA_NUM() As String
        Get
    ...
    Public Property HeaderNUM_INICIAL() As String
        Get
    ...
    Public Property HeaderNUM_FINAL() As String
        Get
    ...
    Public Property HeaderULT_NUM_ASIGNADO() As String
        Get
...
#End Region
    ...
    Public Function CargarDatos() As Integer
        Dim lRECIBO_CANA_NUMERACION As ListaRECIBO_CANA_NUMERACION
        lRECIBO_CANA_NUMERACION = Me.mComponente.ObtenerLista()
        If lRECIBO_CANA_NUMERACION is Nothing Then
            Me.gvLista.Visible = False
            Return -1
        End If
        Me.gvLista.SelectedIndex = -1
        Me.gvLista.Visible = True
        Me.gvLista.DataSource = lRECIBO_CANA_NUMERACION
        Me.gvLista.DataBind()
        Return 1
    End Function
    ...
    Protected Sub gvLista_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles gvLista.RowDataBound
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            Dim mLabelID_RECIBO_CANA_NUM As Label
            Dim lReciboNumeracion As RECIBO_CANA_NUMERACION
            mLabelID_RECIBO_CANA_NUM = e.Row.FindControl("Label_ID_RECIBO_CANA_NUM")
            lReciboNumeracion = (New cRECIBO_CANA_NUMERACION).ObtenerRECIBO_CANA_NUMERACION(Convert.ToInt32(mLabelID_RECIBO_CANA_NUM.Text))
            mLabelID_RECIBO_CANA_NUM.Visible = Not Me.PermitirEditar
            ...
            If Me.PermitirSeleccionar Then
                ...
                End If
            End If
            If VerULT_NUM_ASIGNADO Then
                If lReciboNumeracion IsNot Nothing Then
                    Dim lblULT_NUM_ASIGNADO As Label = CType(e.Row.FindControl("lblULT_NUM_ASIGNADO"), Label)
                    If lReciboNumeracion.ULT_NUM_ASIGNADO > -1 Then
                        lblULT_NUM_ASIGNADO.Text = lReciboNumeracion.ULT_NUM_ASIGNADO.ToString()
                    End If
                End If
            End If
        End If
    ...
    Private Sub gvLista_RowDeleting(ByVal source As System.Object, ByVal e As System.Web.UI.WebControls.GridViewDeleteEventArgs) Handles gvLista.RowDeleting
        If Me.mComponente.EliminarRECIBO_CANA_NUMERACION(CInt(CType(Me.gvLista.Rows(e.RowIndex).FindControl("LinkButton1"), LinkButton).ToolTip)) <> 1 Then
    ...
    Public Function DevolverSeleccionados() As ListaRECIBO_CANA_NUMERACION
        Dim mLista As New ListaRECIBO_CANA_NUMERACION
        For Each mRow As GridViewRow In Me.gvLista.Rows
            If CType(mRow.FindControl("CheckBox_Seleccionar"), CheckBox).Checked Then
                Dim mEntidad As New RECIBO_CANA_NUMERACION
                mEntidad.ID_RECIBO_CANA_NUM = CInt(CType(mRow.FindControl("Label_ID_RECIBO_CANA_NUM"), Label).Text)
                mLista.Add(mEntidad)
            End If
        Next
        Return mLista
