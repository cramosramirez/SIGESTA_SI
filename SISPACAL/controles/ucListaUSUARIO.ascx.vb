...
#Region"Propiedades"
    ...
    Public Property VerID_PERFIL() As Boolean
        Get
            Return Me.dxgvLista.Columns("ID_PERFIL").Visible
        End Get
        Set(ByVal Value As Boolean)
            Me.dxgvLista.Columns("ID_PERFIL").Visible = Value
        End Set
    End Property
    ...
    Public Property VerCLAVE() As Boolean
        Get
            Return Me.dxgvLista.Columns("CLAVE").Visible
        End Get
        Set(ByVal Value As Boolean)
            Me.dxgvLista.Columns("CLAVE").Visible = Value
        End Set
    End Property
    ...
    Public Property VerBLOQUEADO() As Boolean
        Get
            Return Me.dxgvLista.Columns("BLOQUEADO").Visible
        End Get
        Set(ByVal Value As Boolean)
            Me.dxgvLista.Columns("BLOQUEADO").Visible = Value
        End Set
    End Property
    ...
    Public Property VerFECHA_ULTACCESO() As Boolean
        Get
            Return Me.dxgvLista.Columns("FECHA_ULTACCESO").Visible
        End Get
        Set(ByVal Value As Boolean)
            Me.dxgvLista.Columns("FECHA_ULTACCESO").Visible = Value
        End Set
    End Property
    ...
    Public Property HeaderID_PERFIL() As String
        Get
            Return Me.dxgvLista.Columns("ID_PERFIL").Caption
        End Get
        Set(ByVal Value As String)
            Me.dxgvLista.Columns("ID_PERFIL").Caption = Value
        End Set
    End Property
    ...
    Public Property HeaderCLAVE() As String
        Get
            Return Me.dxgvLista.Columns("CLAVE").Caption
        End Get
        Set(ByVal Value As String)
            Me.dxgvLista.Columns("CLAVE").Caption = Value
        End Set
    End Property
    ...
    Public Property HeaderBLOQUEADO() As String
        Get
            Return Me.dxgvLista.Columns("BLOQUEADO").Caption
        End Get
        Set(ByVal Value As String)
            Me.dxgvLista.Columns("BLOQUEADO").Caption = Value
        End Set
    End Property
    ...
    Public Property HeaderFECHA_ULTACCESO() As String
        Get
            Return Me.dxgvLista.Columns("FECHA_ULTACCESO").Caption
        End Get
        Set(ByVal Value As String)
            Me.dxgvLista.Columns("FECHA_ULTACCESO").Caption = Value
        End Set
    End Property
...
#End Region
    ...
    Public Function CargarDatosPorPERFIL(ByVal ID_PERFIL As Int32) As Integer
        Me.odsListaPorPERFIL.SelectParameters("ID_PERFIL").DefaultValue = ID_PERFIL.ToString()
        Me.odsListaPorPERFIL.SelectParameters("recuperarHijas").DefaultValue = "False"
        Me.odsListaPorPERFIL.SelectParameters("recuperarForaneas").DefaultValue = "False"
        Me.odsListaPorPERFIL.SelectParameters("asColumnaOrden").DefaultValue = ""
        Me.odsListaPorPERFIL.SelectParameters("asTipoOrden").DefaultValue = ""
        Me.odsListaPorPERFIL.DataBind()
        Me.dxgvLista.DataSourceID = "odsListaPorPERFIL"
        Me.dxgvLista.Selection.UnselectAll()
        Me.dxgvLista.Visible = True
        Me.dxgvLista.DataBind()
        Return 1
    ...
    Protected Sub dxgvLista_CustomJSProperties(ByVal sender As Object, ByVal e As DevExpress.Web.ASPxGridViewClientJSPropertiesEventArgs) Handles dxgvLista.CustomJSProperties
        If Me.PermitirSeleccionParaCombo Then
            ...
            For i As Integer = 0 To grid.VisibleRowCount - 1
                ...
                keyNames(i) = grid.GetRowValues(i, "ID_PERFIL")
            Next i
    ...
    Public Function DevolverSeleccionados() As listaUSUARIO
        ...
        For Each llave As Decimal In Me.dxgvLista.GetSelectedFieldValues("USUARIO")
    ...
    Protected Sub dxgvLista_CustomButtonCallback(ByVal sender As Object, ByVal e As DevExpress.Web.ASPxGridViewCustomButtonCallbackEventArgs) Handles dxgvLista.CustomButtonCallback
        If e.ButtonID = "btnEliminar" Then
            Dim lEntidad As USUARIO = CType(Me.dxgvLista.GetRow(e.VisibleIndex), USUARIO)

            If Me.mComponente.EliminarUSUARIO(lEntidad.USUARIO) <> 1 Then
    ...
    Protected Sub dxgvLista_CustomUnboundColumnData(sender As Object, e As DevExpress.Web.ASPxGridViewColumnDataEventArgs) Handles dxgvLista.CustomUnboundColumnData
        If e.Column.FieldName = "NOMBRE_PERFIL" Then
            If e.GetListSourceFieldValue("ID_PERFIL") IsNot Nothing AndAlso e.GetListSourceFieldValue("ID_PERFIL") > 0 Then
                Dim lEntidad As PERFIL = (New cPERFIL).ObtenerPERFIL(CInt(e.GetListSourceFieldValue("ID_PERFIL")))
                If lEntidad IsNot Nothing Then e.Value = lEntidad.NOMBRE_PERFIL
            End If
        End If
    End Sub
End Class
