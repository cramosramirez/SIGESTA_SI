<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ucVistaDetalleTIPO_LECTURA.ascx.vb" Inherits="controles_ucVistaDetalleTIPO_LECTURA" %>
<%@ Register TagPrefix="cc1" Namespace="SISPACAL.WebUC" Assembly="SISPACAL_WebUC" %>
<TABLE id="VistaDetalle" cellSpacing="0" cellPadding="0" width="100%" border="0">
	<TR runat="server" id="trID_TIPO_LECTURA">
		<TD width="10"></TD>
		<TD align="right">
			<asp:Label CssClass="Normal" id="lblID_TIPO_LECTURA" runat="server">Id tipo lectura:</asp:label></TD>
		<TD>
			<asp:TextBox CssClass="TextoLlaveDerecha" id="txtID_TIPO_LECTURA" runat="server" ReadOnly="True" Width="70px"></asp:textbox></TD>
		<TD width="10"></TD>
	</TR>
	<TR runat="server" id="trNOMBRE_TIPO_LECTURA">
		<TD width="10"></TD>
		<TD align="right">
			<asp:Label CssClass="Normal" id="lblNOMBRE_TIPO_LECTURA" runat="server">Nombre tipo lectura:</asp:label></TD>
		<TD>
			<asp:TextBox CssClass="TextoNormalIzquierda" id="txtNOMBRE_TIPO_LECTURA" runat="server" Width="100px" MaxLength="50"></asp:TextBox><asp:RequiredFieldValidator id="rfvNOMBRE_TIPO_LECTURA" runat="server" Display="Dynamic" ControlToValidate="txtNOMBRE_TIPO_LECTURA" ErrorMessage="Nombre tipo lectura es Requerido"></asp:RequiredFieldValidator>
</TD>
		<TD width="10"></TD>
	</TR>
	<TR runat="server" id="trID_EQUIPO">
		<TD width="10"></TD>
		<TD align="right">
			<asp:Label CssClass="Normal" id="lblID_EQUIPO" runat="server">Equipo medicion:</asp:label></TD>
		<TD>
			<cc1:ddlEQUIPO_MEDICION id="ddlEQUIPO_MEDICIONID_EQUIPO" runat="server" CssClass="DDLClass"></cc1:ddlEQUIPO_MEDICION></TD>
		<TD width="10"></TD>
	</TR>
