...
''' -----------------------------------------------------------------------------
''' Project	 : SISPACAL
''' Class	 : ucListaPROVEEDOR_COMBUSTIBLE
''' 
''' -----------------------------------------------------------------------------
''' <summary>
''' Clase del Control de Usuario para mostrar un listado de la tabla PROVEEDOR_COMBUSTIBLE
''' </summary>
''' <remarks>
...
''' </history>
''' -----------------------------------------------------------------------------
Partial Class controles_ucListaPROVEEDOR_COMBUSTIBLE
    Inherits ucBase
 
    Private mComponente As New cPROVEEDOR_COMBUSTIBLE
    Public Event Seleccionado(ByVal ID_PROVEEDOR_COMBUS As Int32) 
    Public Event Editando(ByVal ID_PROVEEDOR_COMBUS As Int32) 
...
#Region"Propiedades"
    ...
    Public Property HeaderNOMBRE_PROVEEDOR_COMBUS() As String
        Get
...
#End Region
    ...
    Public Function CargarDatos() As Integer
        Dim lPROVEEDOR_COMBUSTIBLE As ListaPROVEEDOR_COMBUSTIBLE
        lPROVEEDOR_COMBUSTIBLE = Me.mComponente.ObtenerLista()
        If lPROVEEDOR_COMBUSTIBLE is Nothing Then
            Me.gvLista.Visible = False
            Return -1
        End If
        Me.gvLista.SelectedIndex = -1
        Me.gvLista.Visible = True
        Me.gvLista.DataSource = lPROVEEDOR_COMBUSTIBLE
        Me.gvLista.DataBind()
        Return 1
    End Function
    ...
    Protected Sub gvLista_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles gvLista.RowDataBound
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            Dim mLabelID_PROVEEDOR_COMBUS As Label
            mLabelID_PROVEEDOR_COMBUS = e.Row.FindControl("Label_ID_PROVEEDOR_COMBUS")
            mLabelID_PROVEEDOR_COMBUS.Visible = Not Me.PermitirEditar
    ...
    Private Sub gvLista_RowDeleting(ByVal source As System.Object, ByVal e As System.Web.UI.WebControls.GridViewDeleteEventArgs) Handles gvLista.RowDeleting
        If Me.mComponente.EliminarPROVEEDOR_COMBUSTIBLE(CInt(CType(Me.gvLista.Rows(e.RowIndex).FindControl("LinkButton1"), LinkButton).ToolTip)) <> 1 Then
    ...
    Public Function DevolverSeleccionados() As ListaPROVEEDOR_COMBUSTIBLE
        Dim mLista As New ListaPROVEEDOR_COMBUSTIBLE
        For Each mRow As GridViewRow In Me.gvLista.Rows
            If CType(mRow.FindControl("CheckBox_Seleccionar"), CheckBox).Checked Then
                ...
                mEntidad.ID_PROVEEDOR_COMBUS = CInt(CType(mRow.FindControl("Label_ID_PROVEEDOR_COMBUS"), Label).Text)
                mLista.Add(mEntidad)
            End If
        Next
        Return mLista
