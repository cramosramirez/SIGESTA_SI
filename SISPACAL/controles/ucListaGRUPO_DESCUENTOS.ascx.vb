...
''' -----------------------------------------------------------------------------
''' Project	 : SISPACAL
''' Class	 : ucListaGRUPO_DESCUENTOS
''' 
''' -----------------------------------------------------------------------------
''' <summary>
''' Clase del Control de Usuario para mostrar un listado de la tabla GRUPO_DESCUENTOS
''' </summary>
''' <remarks>
...
''' </history>
''' -----------------------------------------------------------------------------
Partial Class controles_ucListaGRUPO_DESCUENTOS
    Inherits ucBase
 
    Private mComponente As New cGRUPO_DESCUENTOS
    Public Event Seleccionado(ByVal ID_GRUPO_DESC As Int32) 
    Public Event Editando(ByVal ID_GRUPO_DESC As Int32) 
...
#Region"Propiedades"
    ...
    Public Property HeaderNOMBRE_GRUPO_DESC() As String
        Get
...
#End Region
    ...
    Public Function CargarDatos() As Integer
        Dim lGRUPO_DESCUENTOS As ListaGRUPO_DESCUENTOS
        lGRUPO_DESCUENTOS = Me.mComponente.ObtenerLista()
        If lGRUPO_DESCUENTOS is Nothing Then
            Me.gvLista.Visible = False
            Return -1
        End If
        Me.gvLista.SelectedIndex = -1
        Me.gvLista.Visible = True
        Me.gvLista.DataSource = lGRUPO_DESCUENTOS
        Me.gvLista.DataBind()
        Return 1
    End Function
    ...
    Protected Sub gvLista_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles gvLista.RowDataBound
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            Dim mLabelID_GRUPO_DESC As Label
            mLabelID_GRUPO_DESC = e.Row.FindControl("Label_ID_GRUPO_DESC")
            mLabelID_GRUPO_DESC.Visible = Not Me.PermitirEditar
    ...
    Private Sub gvLista_RowDeleting(ByVal source As System.Object, ByVal e As System.Web.UI.WebControls.GridViewDeleteEventArgs) Handles gvLista.RowDeleting
        If Me.mComponente.EliminarGRUPO_DESCUENTOS(CInt(CType(Me.gvLista.Rows(e.RowIndex).FindControl("LinkButton1"), LinkButton).ToolTip)) <> 1 Then
    ...
    Public Function DevolverSeleccionados() As ListaGRUPO_DESCUENTOS
        Dim mLista As New ListaGRUPO_DESCUENTOS
        For Each mRow As GridViewRow In Me.gvLista.Rows
            If CType(mRow.FindControl("CheckBox_Seleccionar"), CheckBox).Checked Then
                ...
                mEntidad.ID_GRUPO_DESC = CInt(CType(mRow.FindControl("Label_ID_GRUPO_DESC"), Label).Text)
                mLista.Add(mEntidad)
            End If
        Next
        Return mLista
