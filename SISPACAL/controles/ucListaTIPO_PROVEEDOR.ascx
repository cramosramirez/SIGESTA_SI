<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ucListaTIPO_PROVEEDOR.ascx.vb" Inherits="controles_ucListaTIPO_PROVEEDOR" %>
	   ...
	   <Columns>
         <asp:TemplateField ShowHeader="False" Visible="False">
             <ItemTemplate>
	   	   ...
	   	   <asp:TemplateField HeaderText="Id tipo proveedor" ItemStyle-HorizontalAlign="Right"> 
	   	   	   <ItemTemplate> 
                 <asp:LinkButton ID="LinkButtonDetalle" runat="server" CommandArgument='<%# DataBinder.Eval(Container, "DataItem.ID_TIPO_PROVEEDOR") %>'
                     CommandName="Editar" Text='<%# DataBinder.Eval(Container, "DataItem.ID_TIPO_PROVEEDOR") %>'></asp:LinkButton>
	   	   	   	   <asp:Label id="Label_ID_TIPO_PROVEEDOR" runat="server" Visible="False" Text='<%# DataBinder.Eval(Container, "DataItem.ID_TIPO_PROVEEDOR") %>'>
	   	   	   	   </asp:Label>
	   	   	   </ItemTemplate> 
	   	   </asp:TemplateField> 
	   	   <asp:BoundField DataField="NOMBRE_TIPO_PROVEEDOR" HeaderText="Nombre tipo proveedor"  ItemStyle-HorizontalAlign="Left"></asp:BoundField>
	   	   ...
	   	   <asp:TemplateField>
	   	   	   <ItemTemplate>
	   	   	   	   <asp:LinkButton ID="LinkButton1" runat="server" CommandName="Delete" CausesValidation="False" ToolTip='<%# DataBinder.Eval(Container, "DataItem.ID_TIPO_PROVEEDOR") %>'>
