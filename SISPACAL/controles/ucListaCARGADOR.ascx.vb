...
''' -----------------------------------------------------------------------------
''' Project	 : SISPACAL
''' Class	 : ucListaCARGADOR
''' 
''' -----------------------------------------------------------------------------
''' <summary>
''' Clase del Control de Usuario para mostrar un listado de la tabla CARGADOR
''' </summary>
''' <remarks>
...
''' </history>
''' -----------------------------------------------------------------------------
Partial Class controles_ucListaOPERADOR
    Inherits ucListaBase

    Private mComponente As New cCARGADOR
    Public Event Seleccionado(ByVal ID_CARGADOR As Int32)
    Public Event Editando(ByVal ID_CARGADOR As Int32)
...
#Region "Propiedades"
    ...
    Public Property VerNOMBRE_CARGADOR() As Boolean
        Get
            Return Me.dxgvLista.Columns("NOMBRE_CARGADOR").Visible
        End Get
        Set(ByVal Value As Boolean)
            Me.dxgvLista.Columns("NOMBRE_CARGADOR").Visible = Value
        End Set
    End Property
    ...
    Public Property VerES_EMPLEADO_INGENIO() As Boolean
        Get
            Return Me.dxgvLista.Columns("ES_EMPLEADO_INGENIO").Visible
        End Get
        Set(ByVal Value As Boolean)
            Me.dxgvLista.Columns("ES_EMPLEADO_INGENIO").Visible = Value
        End Set
    End Property
    ...
    Public Property HeaderNOMBRE_CARGADOR() As String
        Get
            Return Me.dxgvLista.Columns("NOMBRE_CARGADOR").Caption
        End Get
        Set(ByVal Value As String)
            Me.dxgvLista.Columns("NOMBRE_CARGADOR").Caption = Value
        End Set
    End Property
    ...
    Public Property HeaderES_EMPLEADO_INGENIO() As String
        Get
            Return Me.dxgvLista.Columns("ES_EMPLEADO_INGENIO").Caption
        End Get
        Set(ByVal Value As String)
            Me.dxgvLista.Columns("ES_EMPLEADO_INGENIO").Caption = Value
        End Set
    End Property
...
#End Region
    ...
    ''' -----------------------------------------------------------------------------
    ''' <summary>
    ''' FunciÃ³n que Carga la informaciÃ³n de los registros de la tabla CARGADOR
    ''' </summary>
    ''' <remarks>
    ''' </remarks>
    ''' <history>
    ...
    Protected Sub dxgvLista_CustomJSProperties(ByVal sender As Object, ByVal e As DevExpress.Web.ASPxGridViewClientJSPropertiesEventArgs) Handles dxgvLista.CustomJSProperties
        If Me.PermitirSeleccionParaCombo Then
            ...
            For i As Integer = 0 To grid.VisibleRowCount - 1
                keyValues(i) = grid.GetRowValues(i, "ID_CARGADOR")
                keyNames(i) = grid.GetRowValues(i, "NOMBRE_CARGADOR")
            Next i
    ...
    Public Function DevolverSeleccionados() As listaCARGADOR
        Dim mLista As New listaCARGADOR
        For Each llave As Decimal In Me.dxgvLista.GetSelectedFieldValues("ID_CARGADOR")
            Dim lEntidad As New CARGADOR
            lEntidad.ID_CARGADOR = llave
            mLista.Add(lEntidad)
        Next
        Return mLista
    End Function
    ...
    Protected Sub dxgvLista_CustomButtonCallback(ByVal sender As Object, ByVal e As DevExpress.Web.ASPxGridViewCustomButtonCallbackEventArgs) Handles dxgvLista.CustomButtonCallback
        If e.ButtonID = "btnEliminar" Then
            Dim lEntidad As CARGADOR = CType(Me.dxgvLista.GetRow(e.VisibleIndex), CARGADOR)

            If Me.mComponente.EliminarCARGADOR(lEntidad.ID_CARGADOR) <> 1 Then
