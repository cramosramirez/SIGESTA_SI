...
''' -----------------------------------------------------------------------------
''' <summary>
''' Clase del Control de Usuario para mostrar un listado de la tabla BANCOS
''' </summary>
''' <remarks>
...
''' </history>
''' -----------------------------------------------------------------------------
Partial Class controles_ucListaBANCOS
    Inherits ucBase
 
    Private mComponente As New cBANCOS
    Public Event Seleccionado(ByVal CODIBANCO As Int32) 
    Public Event Editando(ByVal CODIBANCO As Int32) 
...
#Region"Propiedades"
    ...
    Public Property HeaderNOMBRE_BANCO() As String
        Get
...
#End Region
    ...
    Public Function CargarDatos() As Integer
        Dim lBANCOS As ListaBANCOS
        lBANCOS = Me.mComponente.ObtenerLista()
        If lBANCOS is Nothing Then
            Me.gvLista.Visible = False
            Return -1
        End If
        Me.gvLista.SelectedIndex = -1
        Me.gvLista.Visible = True
        Me.gvLista.DataSource = lBANCOS
        Me.gvLista.DataBind()
        Return 1
    End Function
    ...
    Protected Sub gvLista_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles gvLista.RowDataBound
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            Dim mLabelCODIBANCO As Label
            mLabelCODIBANCO = e.Row.FindControl("Label_CODIBANCO")
            mLabelCODIBANCO.Visible = Not Me.PermitirEditar
    ...
    Private Sub gvLista_RowDeleting(ByVal source As System.Object, ByVal e As System.Web.UI.WebControls.GridViewDeleteEventArgs) Handles gvLista.RowDeleting
        If Me.mComponente.EliminarBANCOS(CInt(CType(Me.gvLista.Rows(e.RowIndex).FindControl("LinkButton1"), LinkButton).ToolTip)) <> 1 Then
    ...
    Public Function DevolverSeleccionados() As ListaBANCOS
        Dim mLista As New ListaBANCOS
        For Each mRow As GridViewRow In Me.gvLista.Rows
            If CType(mRow.FindControl("CheckBox_Seleccionar"), CheckBox).Checked Then
                ...
                mEntidad.CODIBANCO = CInt(CType(mRow.FindControl("Label_CODIBANCO"), Label).Text)
                mLista.Add(mEntidad)
            End If
        Next
        Return mLista
