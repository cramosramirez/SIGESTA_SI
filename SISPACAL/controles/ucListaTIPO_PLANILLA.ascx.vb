...
''' -----------------------------------------------------------------------------
''' Project	 : SISPACAL
''' Class	 : ucListaTIPO_PLANILLA
''' 
''' -----------------------------------------------------------------------------
''' <summary>
''' Clase del Control de Usuario para mostrar un listado de la tabla TIPO_PLANILLA
''' </summary>
''' <remarks>
...
''' </history>
''' -----------------------------------------------------------------------------
Partial Class controles_ucListaTIPO_PLANILLA
    Inherits ucBase
 
    Private mComponente As New cTIPO_PLANILLA
    Public Event Seleccionado(ByVal ID_TIPO_PLANILLA As Int32) 
    Public Event Editando(ByVal ID_TIPO_PLANILLA As Int32) 
...
#Region"Propiedades"
    ...
    Public Property VerNOMBRE_TIPO_PLANILLA() As Boolean
        Get
    ...
    Public Property HeaderNOMBRE_TIPO_PLANILLA() As String
        Get
...
#End Region
    ...
    ''' -----------------------------------------------------------------------------
    ''' <summary>
    ''' FunciÃ³n que Carga la informaciÃ³n de los registros de la tabla TIPO_PLANILLA
    ''' </summary>
    ''' <remarks>
    ''' </remarks>
    ''' <history>
    ...
    Public Function CargarDatos() As Integer
        Dim lTIPO_PLANILLA As ListaTIPO_PLANILLA
        lTIPO_PLANILLA = Me.mComponente.ObtenerLista()
        If lTIPO_PLANILLA is Nothing Then
            Me.gvLista.Visible = False
            Return -1
        End If
        Me.gvLista.SelectedIndex = -1
        Me.gvLista.Visible = True
        Me.gvLista.DataSource = lTIPO_PLANILLA
        Me.gvLista.DataBind()
        Return 1
    End Function
    ...
    Protected Sub gvLista_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles gvLista.RowDataBound
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            mLabelID_TIPO_PLANILLA = e.Row.FindControl("Label_ID_TIPO_PLANILLA")
            mLabelID_TIPO_PLANILLA.Visible = Not Me.PermitirEditar
    ...
    Private Sub gvLista_RowDeleting(ByVal source As System.Object, ByVal e As System.Web.UI.WebControls.GridViewDeleteEventArgs) Handles gvLista.RowDeleting
        If Me.mComponente.EliminarTIPO_PLANILLA(CInt(CType(Me.gvLista.Rows(e.RowIndex).FindControl("LinkButton1"), LinkButton).ToolTip)) <> 1 Then
    ...
    Public Function DevolverSeleccionados() As ListaTIPO_PLANILLA
        Dim mLista As New ListaTIPO_PLANILLA
        For Each mRow As GridViewRow In Me.gvLista.Rows
            If CType(mRow.FindControl("CheckBox_Seleccionar"), CheckBox).Checked Then
                ...
                mEntidad.ID_TIPO_PLANILLA = CInt(CType(mRow.FindControl("Label_ID_TIPO_PLANILLA"), Label).Text)
                mLista.Add(mEntidad)
            End If
        Next
        Return mLista
