...
''' -----------------------------------------------------------------------------
''' Project	 : SISPACAL
''' Class	 : ucListaEQUIPO_MEDICION
''' 
''' -----------------------------------------------------------------------------
''' <summary>
''' Clase del Control de Usuario para mostrar un listado de la tabla EQUIPO_MEDICION
''' </summary>
''' <remarks>
...
''' </history>
''' -----------------------------------------------------------------------------
Partial Class controles_ucListaEQUIPO_MEDICION
    Inherits ucBase
 
    Private mComponente As New cEQUIPO_MEDICION
    Public Event Seleccionado(ByVal ID_EQUIPO As Int32) 
    Public Event Editando(ByVal ID_EQUIPO As Int32) 
...
#Region"Propiedades"
    ...
    Public Property HeaderNOMBRE_EQUIPO() As String
        Get
    ...
    Public Property HeaderPUERTO() As String
        Get
    ...
    Public Property HeaderBITS_POR_SEGUNDO() As String
        Get
    ...
    Public Property HeaderBITS_DATOS() As String
        Get
    ...
    Public Property HeaderPARIDAD() As String
        Get
    ...
    Public Property HeaderBITS_PARADA() As String
        Get
    ...
    Public Property HeaderCONTROL_FLUJO() As String
        Get
    ...
    Public Property HeaderHABILITADO() As String
        Get
...
#End Region
    ...
    ''' -----------------------------------------------------------------------------
    ''' <summary>
    ''' FunciÃ³n que Carga la informaciÃ³n de los registros de la tabla EQUIPO_MEDICION
    ''' </summary>
    ''' <remarks>
    ''' </remarks>
    ''' <history>
    ...
    Public Function CargarDatos() As Integer
        Dim lEQUIPO_MEDICION As ListaEQUIPO_MEDICION
        lEQUIPO_MEDICION = Me.mComponente.ObtenerLista()
        If lEQUIPO_MEDICION is Nothing Then
            Me.gvLista.Visible = False
            Return -1
        End If
        Me.gvLista.SelectedIndex = -1
        Me.gvLista.Visible = True
        Me.gvLista.DataSource = lEQUIPO_MEDICION
        Me.gvLista.DataBind()
        Return 1
    End Function
    ...
    Protected Sub gvLista_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles gvLista.RowDataBound
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            Dim mLabelID_EQUIPO As Label
            mLabelID_EQUIPO = e.Row.FindControl("Label_ID_EQUIPO")
            mLabelID_EQUIPO.Visible = Not Me.PermitirEditar
    ...
    Private Sub gvLista_RowDeleting(ByVal source As System.Object, ByVal e As System.Web.UI.WebControls.GridViewDeleteEventArgs) Handles gvLista.RowDeleting
        If Me.mComponente.EliminarEQUIPO_MEDICION(CInt(CType(Me.gvLista.Rows(e.RowIndex).FindControl("LinkButton1"), LinkButton).ToolTip)) <> 1 Then
    ...
    Public Function DevolverSeleccionados() As ListaEQUIPO_MEDICION
        Dim mLista As New ListaEQUIPO_MEDICION
        For Each mRow As GridViewRow In Me.gvLista.Rows
            If CType(mRow.FindControl("CheckBox_Seleccionar"), CheckBox).Checked Then
                Dim mEntidad As New EQUIPO_MEDICION
                mEntidad.ID_EQUIPO = CInt(CType(mRow.FindControl("Label_ID_EQUIPO"), Label).Text)
                mLista.Add(mEntidad)
            End If
        Next
        Return mLista
