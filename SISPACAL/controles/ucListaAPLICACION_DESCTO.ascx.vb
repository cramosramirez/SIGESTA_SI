...
''' -----------------------------------------------------------------------------
''' Project	 : SISPACAL
''' Class	 : ucListaAPLICACION_DESCTO
''' 
''' -----------------------------------------------------------------------------
''' <summary>
''' Clase del Control de Usuario para mostrar un listado de la tabla APLICACION_DESCTO
''' </summary>
''' <remarks>
...
''' </history>
''' -----------------------------------------------------------------------------
Partial Class controles_ucListaAPLICACION_DESCTO
    Inherits ucBase
 
    Private mComponente As New cAPLICACION_DESCTO
    Public Event Seleccionado(ByVal ID_APLICACION_DESCTO As Int32) 
    Public Event Editando(ByVal ID_APLICACION_DESCTO As Int32) 
...
#Region"Propiedades"
    ...
    Public Property HeaderNOMBRE_APLICACION_DESCTO() As String
        Get
...
#End Region
    ...
    Public Function CargarDatos() As Integer
        Dim lAPLICACION_DESCTO As ListaAPLICACION_DESCTO
        lAPLICACION_DESCTO = Me.mComponente.ObtenerLista()
        If lAPLICACION_DESCTO is Nothing Then
            Me.gvLista.Visible = False
            Return -1
        End If
        Me.gvLista.SelectedIndex = -1
        Me.gvLista.Visible = True
        Me.gvLista.DataSource = lAPLICACION_DESCTO
        Me.gvLista.DataBind()
        Return 1
    End Function
    ...
    Protected Sub gvLista_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles gvLista.RowDataBound
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            Dim mLabelID_APLICACION_DESCTO As Label
            mLabelID_APLICACION_DESCTO = e.Row.FindControl("Label_ID_APLICACION_DESCTO")
            mLabelID_APLICACION_DESCTO.Visible = Not Me.PermitirEditar
    ...
    Private Sub gvLista_RowDeleting(ByVal source As System.Object, ByVal e As System.Web.UI.WebControls.GridViewDeleteEventArgs) Handles gvLista.RowDeleting
        If Me.mComponente.EliminarAPLICACION_DESCTO(CInt(CType(Me.gvLista.Rows(e.RowIndex).FindControl("LinkButton1"), LinkButton).ToolTip)) <> 1 Then
    ...
    Public Function DevolverSeleccionados() As ListaAPLICACION_DESCTO
        Dim mLista As New ListaAPLICACION_DESCTO
        For Each mRow As GridViewRow In Me.gvLista.Rows
            If CType(mRow.FindControl("CheckBox_Seleccionar"), CheckBox).Checked Then
                ...
                mEntidad.ID_APLICACION_DESCTO = CInt(CType(mRow.FindControl("Label_ID_APLICACION_DESCTO"), Label).Text)
                mLista.Add(mEntidad)
            End If
        Next
        Return mLista
