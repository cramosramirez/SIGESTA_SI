<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ucVistaDetalleLECTURA_POR_PERFIL.ascx.vb" Inherits="controles_ucVistaDetalleLECTURA_POR_PERFIL" %>
<%@ Register TagPrefix="cc1" Namespace="SISPACAL.WebUC" Assembly="SISPACAL_WebUC" %>
<TABLE id="VistaDetalle" cellSpacing="0" cellPadding="0" width="100%" border="0">
	<TR runat="server" id="trID_LECTURA_PERFIL">
		<TD width="10"></TD>
		<TD align="right">
			<asp:Label CssClass="Normal" id="lblID_LECTURA_PERFIL" runat="server">Id lectura perfil:</asp:label></TD>
		<TD>
			<asp:TextBox CssClass="TextoLlaveDerecha" id="txtID_LECTURA_PERFIL" runat="server" ReadOnly="True" Width="70px"></asp:textbox></TD>
		<TD width="10"></TD>
	</TR>
	<TR runat="server" id="trID_PERFIL">
		<TD width="10"></TD>
		<TD align="right">
			<asp:Label CssClass="Normal" id="lblID_PERFIL" runat="server">Perfil:</asp:label></TD>
		<TD>
			<cc1:ddlPERFIL id="ddlPERFILID_PERFIL" runat="server" CssClass="DDLClass"></cc1:ddlPERFIL></TD>
		<TD width="10"></TD>
	</TR>
	<TR runat="server" id="trID_TIPO_LECTURA">
		<TD width="10"></TD>
		<TD align="right">
			<asp:Label CssClass="Normal" id="lblID_TIPO_LECTURA" runat="server">Tipo lectura:</asp:label></TD>
		<TD>
			<cc1:ddlTIPO_LECTURA id="ddlTIPO_LECTURAID_TIPO_LECTURA" runat="server" CssClass="DDLClass"></cc1:ddlTIPO_LECTURA></TD>
		<TD width="10"></TD>
	</TR>
