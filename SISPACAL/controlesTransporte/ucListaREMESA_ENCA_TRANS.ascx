<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ucListaREMESA_ENCA_TRANS.ascx.vb" Inherits="controles_ucListaREMESA_ENCA_TRANS" %>
...
<dx:ASPxGridView ID="dxgvLista" runat="server" AutoGenerateColumns="False" DataSourceID="odsLista" Width="100%" KeyFieldName="ID_REMESA_ENCA">
    ...
    <Columns>
        ...
        <dx:GridViewDataTextColumn FieldName="CODTRANSPORT" VisibleIndex="3" Caption="Codigo" />
        <dx:GridViewDataTextColumn FieldName="CODIBANCO" VisibleIndex="4" Caption="Codibanco" Visible="false" />
        <dx:GridViewDataTextColumn FieldName="NOMBRE_TRANSPORTISTA" VisibleIndex="4" Caption="Transportista" UnboundType="String" Width="300px" />
...
<asp:ObjectDataSource ID="odsLista" runat="server" 
    SelectMethod="ObtenerLista" InsertMethod="AgregarREMESA_ENCA_TRANS" DeleteMethod="EliminarREMESA_ENCA_TRANS" UpdateMethod="ActualizarREMESA_ENCA_TRANS"
    TypeName="SISPACAL.BL.cREMESA_ENCA_TRANS">
    <SelectParameters>
...
<asp:ObjectDataSource ID="odsListaPorTRANSPORTISTA" runat="server" 
    SelectMethod="ObtenerListaPorTRANSPORTISTA" InsertMethod="AgregarREMESA_ENCA_TRANS" DeleteMethod="EliminarREMESA_ENCA_TRANS" UpdateMethod="ActualizarREMESA_ENCA_TRANS"
    TypeName="SISPACAL.BL.cREMESA_ENCA_TRANS">
    <SelectParameters>
        <asp:Parameter Name="CODTRANSPORT" Type="Int32" />
        <asp:Parameter DefaultValue="False" Name="recuperarHijas" Type="Boolean" />
...
<asp:ObjectDataSource ID="odsListaPorBANCOS" runat="server" 
    SelectMethod="ObtenerListaPorBANCOS" InsertMethod="AgregarREMESA_ENCA_TRANS" DeleteMethod="EliminarREMESA_ENCA_TRANS" UpdateMethod="ActualizarREMESA_ENCA_TRANS"
    TypeName="SISPACAL.BL.cREMESA_ENCA_TRANS">
    <SelectParameters>
        <asp:Parameter Name="CODIBANCO" Type="Int32" />
        <asp:Parameter DefaultValue="False" Name="recuperarHijas" Type="Boolean" />
