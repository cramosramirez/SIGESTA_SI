...
''' -----------------------------------------------------------------------------
''' Project	 : SISPACAL
''' Class	 : ucListaPRE_ANALISIS_DETA_TRANS
''' 
''' -----------------------------------------------------------------------------
''' <summary>
''' Clase del Control de Usuario para mostrar un listado de la tabla PRE_ANALISIS_DETA_TRANS
''' </summary>
''' <remarks>
...
''' </history>
''' -----------------------------------------------------------------------------
Partial Class controles_ucListaPRE_ANALISIS_DETA_TRANS
    Inherits ucListaBase
 
    Private mComponente As New cPRE_ANALISIS_DETA_TRANS
...
#Region"Propiedades"
    ...
    Public Property VerUNIDADES() As Boolean
        Get
            Return Me.dxgvLista.Columns("UNIDADES").Visible
        End Get
        Set(ByVal Value As Boolean)
            Me.dxgvLista.Columns("UNIDADES").Visible = Value
        End Set
    End Property
    ...
    Public Property HeaderUNIDADES() As String
        Get
            Return Me.dxgvLista.Columns("UNIDADES").Caption
        End Get
        Set(ByVal Value As String)
            Me.dxgvLista.Columns("UNIDADES").Caption = Value
        End Set
    End Property
...
#End Region
    ...
    ''' -----------------------------------------------------------------------------
    ''' <summary>
    ''' FunciÃ³n que Carga la informaciÃ³n de los registros de la tabla PRE_ANALISIS_DETA_TRANS
    ''' </summary>
    ''' <remarks>
    ''' </remarks>
    ''' <history>
    ...
    ''' <summary>
    ''' FunciÃ³n que Carga la informaciÃ³n de los registros de la tabla PRE_ANALISIS_DETA_TRANS
    ''' filtrado por la tabla PRE_ANALISIS_ENCA_TRANS
    ''' </summary>
    ...
    ''' </history>
    ''' -----------------------------------------------------------------------------
    Public Function CargarDatosPorPRE_ANALISIS_ENCA_TRANS(ByVal ID_ENCA As Int32) As Integer
        Me.odsListaPorPRE_ANALISIS_ENCA_TRANS.SelectParameters("ID_ENCA").DefaultValue = ID_ENCA.ToString()
        Me.odsListaPorPRE_ANALISIS_ENCA_TRANS.SelectParameters("recuperarForaneas").DefaultValue = "False"
        Me.odsListaPorPRE_ANALISIS_ENCA_TRANS.SelectParameters("asColumnaOrden").DefaultValue = ""
        Me.odsListaPorPRE_ANALISIS_ENCA_TRANS.SelectParameters("asTipoOrden").DefaultValue = ""
        Me.odsListaPorPRE_ANALISIS_ENCA_TRANS.DataBind()
        Me.dxgvLista.DataSourceID = "odsListaPorPRE_ANALISIS_ENCA_TRANS"
        Me.dxgvLista.Selection.UnselectAll()
        Me.dxgvLista.Visible = True
        Me.dxgvLista.DataBind()
        Return 1
    ...
    Public Function DevolverSeleccionados() As listaPRE_ANALISIS_DETA_TRANS
        Dim mLista As New listaPRE_ANALISIS_DETA_TRANS
    ...
    Protected Sub dxgvLista_CustomButtonCallback(ByVal sender As Object, ByVal e As DevExpress.Web.ASPxGridViewCustomButtonCallbackEventArgs) Handles dxgvLista.CustomButtonCallback
        If e.ButtonID = "btnEliminar" Then
            Dim lEntidad As PRE_ANALISIS_DETA_TRANS = CType(Me.dxgvLista.GetRow(e.VisibleIndex), PRE_ANALISIS_DETA_TRANS)

            If Me.mComponente.EliminarPRE_ANALISIS_DETA_TRANS(lEntidad.ID_DETA) <> 1 Then
    ...
    Protected Sub dxgvLista_HtmlDataCellPrepared(sender As Object, e As DevExpress.Web.ASPxGridViewTableDataCellEventArgs) Handles dxgvLista.HtmlDataCellPrepared
        If e.DataColumn.FieldName = "DESCRIPCION" Then
            If e.CellValue.ToString.Contains("RESUMEN SERVICIO") OrElse _
                e.CellValue = "VALOR TOTAL" OrElse _
                e.CellValue = "UTILIDAD NETA" OrElse _
                e.CellValue = "UTILIDAD POR UNIDAD" OrElse _
                e.CellValue = "UTILIDAD POR UNIDAD." OrElse _
                e.CellValue = "UTILIDAD POR VIAJE" Then
                e.Cell.Font.Bold = True
                e.Cell.Font.Size = FontUnit.Small
                e.Cell.BackColor = Drawing.Color.FromArgb(146, 208, 80)
            End If
        End If
        If e.DataColumn.FieldName = "MONTO" Then
            If e.GetValue("DESCRIPCION").ToString.Contains("RESUMEN SERVICIO") OrElse _
            e.GetValue("DESCRIPCION") = "VALOR TOTAL" OrElse _
            e.GetValue("DESCRIPCION") = "UTILIDAD NETA" OrElse _
            e.GetValue("DESCRIPCION") = "UTILIDAD POR UNIDAD" OrElse _
            e.GetValue("DESCRIPCION") = "UTILIDAD POR UNIDAD." OrElse _
            e.GetValue("DESCRIPCION") = "UTILIDAD POR VIAJE" Then
                e.Cell.Font.Bold = True
                e.Cell.Font.Size = FontUnit.Small
                e.Cell.BackColor = Drawing.Color.FromArgb(146, 208, 80)
            End If
