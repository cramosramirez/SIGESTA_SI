...
''' -----------------------------------------------------------------------------
''' Project	 : SISPACAL
''' Class	 : ucListaCCF_DETA_TRANS
''' 
''' -----------------------------------------------------------------------------
''' <summary>
''' Clase del Control de Usuario para mostrar un listado de la tabla CCF_DETA_TRANS_TRANS
''' </summary>
''' <remarks>
...
''' </history>
''' -----------------------------------------------------------------------------
Partial Class controles_ucListaCCF_DETA_TRANS
    Inherits ucListaBase

    Private mComponente As New cCCF_DETA_TRANS
    Public Event Seleccionado(ByVal ID_CCF_DETA_TRANS As Int32)
    Public Event Editando(ByVal ID_CCF_DETA_TRANS As Int32)
...
#Region "Propiedades"
    ...
    Public Property VerID_CCF_DETA_TRANS() As Boolean
        Get
            Return Me.dxgvLista.Columns("ID_CCF_DETA_TRANS").Visible
        End Get
        Set(ByVal Value As Boolean)
            Me.dxgvLista.Columns("ID_CCF_DETA_TRANS").Visible = Value
        End Set
    End Property
    ...
    Public Property HeaderID_CCF_DETA_TRANS() As String
        Get
            Return Me.dxgvLista.Columns("ID_CCF_DETA_TRANS").Caption
        End Get
        Set(ByVal Value As String)
            Me.dxgvLista.Columns("ID_CCF_DETA_TRANS").Caption = Value
        End Set
    End Property
...
#End Region
    ...
    Public Function CargarDatosCache(ByVal nombreSesion As String) As Integer
        ...
        Me.odsCCF_DETA_TRANScache.SelectParameters("nombreSesion_ucListaCCF_DETA_TRANS").DefaultValue = nombreSesion
        Me.odsCCF_DETA_TRANScache.DataBind()
        Me.dxgvLista.DataSourceID = "odsCCF_DETA_TRANScache"
    ...
    ''' -----------------------------------------------------------------------------
    ''' <summary>
    ''' FunciÃ³n que Carga la informaciÃ³n de los registros de la tabla CCF_DETA_TRANS
    ''' </summary>
    ''' <remarks>
    ''' </remarks>
    ''' <history>
    ...
    ''' </history>
    ''' -----------------------------------------------------------------------------
    Public Function CargarDatosPorCCF_ENCA(ByVal ID_CCF_TRANS As Int32) As Integer
        Me.odsListaPorCCF_ENCA.SelectParameters("ID_CCF_TRANS").DefaultValue = ID_CCF_TRANS.ToString()
    ...
    Protected Sub dxgvLista_CustomJSProperties(ByVal sender As Object, ByVal e As DevExpress.Web.ASPxGridViewClientJSPropertiesEventArgs) Handles dxgvLista.CustomJSProperties
        If Me.PermitirSeleccionParaCombo Then
            ...
            For i As Integer = 0 To grid.VisibleRowCount - 1
                keyValues(i) = grid.GetRowValues(i, "ID_CCF_DETA_TRANS")
                keyNames(i) = grid.GetRowValues(i, "ID_CCF_TRANS")
            Next i
    ...
    Protected Sub dxgvLista_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles dxgvLista.Init
        ...
        End If
        dxgvLista.ForceDataRowType(GetType(listaCCF_DETA_TRANS))
    End Sub
    ...
    Protected Sub dxgvLista_RowCommand(ByVal sender As Object, ByVal e As DevExpress.Web.ASPxGridViewRowCommandEventArgs) Handles dxgvLista.RowCommand
        ...
        If e.CommandArgs.CommandName = "Eliminar" Then
            Dim b As New cCCF_DETA_TRANScache
    ...
    Public Function DevolverSeleccionados() As listaCCF_DETA_TRANS
        Dim mLista As New listaCCF_DETA_TRANS
        For Each llave As Decimal In Me.dxgvLista.GetSelectedFieldValues("ID_CCF_DETA_TRANS")
            Dim lEntidad As New CCF_DETA_TRANS
            lEntidad.ID_CCF_DETA_TRANS = llave
            mLista.Add(lEntidad)
        Next
        Return mLista
    End Function
    ...
    Protected Sub dxgvLista_CustomButtonCallback(ByVal sender As Object, ByVal e As DevExpress.Web.ASPxGridViewCustomButtonCallbackEventArgs) Handles dxgvLista.CustomButtonCallback
        If e.ButtonID = "btnEliminar" Then
            Dim lEntidad As CCF_DETA_TRANS = CType(Me.dxgvLista.GetRow(e.VisibleIndex), CCF_DETA_TRANS)

            If Me.mComponente.EliminarCCF_DETA_TRANS(lEntidad.ID_CCF_DETA_TRANS) <> 1 Then
