<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ucListaCCF_DETA_TRANS.ascx.vb" Inherits="controles_ucListaCCF_DETA_TRANS" %>
...
<script type="text/javascript">
    ...
    function OnEndCallbackGrid(s, e) {
        cpMantCCF_ENCA_TRANS.PerformCallback('');
    }
</script>

<dx:ASPxGridView ID="dxgvLista" runat="server" AutoGenerateColumns="False" Width="100%" KeyFieldName="ID_CCF_DETA_TRANS">
    ...
    <Columns>
        ...
        <dx:GridViewDataTextColumn FieldName="ID_CCF_DETA_TRANS" ReadOnly="True" VisibleIndex="2" Caption="Id ccf deta" Visible="false" />
        ...
        <dx:GridViewDataTextColumn VisibleIndex="11" Name="Eliminar" Caption=" " Width="20px"  CellStyle-HorizontalAlign="Center" >
            <DataItemTemplate>
                <asp:ImageButton ID="lbtnEliminar" runat="server" AlternateText="Eliminar" ToolTip="Eliminar" CommandName="Eliminar" ImageUrl="~/imagenes/eliminar.png"  CommandArgument='<%# Bind("ID_CCF_DETA_TRANS")%>'></asp:ImageButton>                             
            </DataItemTemplate>
...
<asp:ObjectDataSource ID="odsCCF_DETA_TRANScache" runat="server" TypeName="cCCF_DETA_TRANScache"     
    SelectMethod="ObtenerLista" 
    UpdateMethod="Actualizar" DeleteMethod="Eliminar">       
     <SelectParameters>             
        <asp:Parameter Name="nombreSesion_ucListaCCF_DETA_TRANS" Type="String" />
     </SelectParameters>     
     <UpdateParameters>    
        <asp:Parameter Name="ID_CCF_DETA_TRANS" Type="Int32" />
...
<asp:ObjectDataSource ID="odsLista" runat="server" 
    SelectMethod="ObtenerLista" InsertMethod="AgregarCCF_DETA_TRANS" DeleteMethod="EliminarCCF_DETA_TRANS" UpdateMethod="ActualizarCCF_DETA_TRANS"
    TypeName="SISPACAL.BL.cCCF_DETA_TRANS">
    <SelectParameters>
    ...
    <InsertParameters>
        <asp:Parameter DefaultValue="0" Name="ID_CCF_DETA_TRANS" Type="Int32" />
...
<asp:ObjectDataSource ID="odsListaPorCCF_ENCA" runat="server" 
    SelectMethod="ObtenerListaPorCCF_ENCA" InsertMethod="AgregarCCF_DETA_TRANS" DeleteMethod="EliminarCCF_DETA_TRANS" UpdateMethod="ActualizarCCF_DETA_TRANS"
    TypeName="SISPACAL.BL.cCCF_DETA_TRANS">
    <SelectParameters>
        <asp:Parameter Name="ID_CCF_ENCA" Type="Int32" />
        <asp:Parameter DefaultValue="False" Name="recuperarForaneas" Type="Boolean" />
...
<asp:ObjectDataSource ID="odsListaPorPRODUCTO" runat="server" 
    SelectMethod="ObtenerListaPorPRODUCTO" InsertMethod="AgregarCCF_DETA_TRANS" DeleteMethod="EliminarCCF_DETA_TRANS" UpdateMethod="ActualizarCCF_DETA_TRANS"
    TypeName="SISPACAL.BL.cCCF_DETA_TRANS">
    <SelectParameters>
        <asp:Parameter Name="ID_PRODUCTO" Type="Int32" />
        <asp:Parameter DefaultValue="False" Name="recuperarForaneas" Type="Boolean" />
