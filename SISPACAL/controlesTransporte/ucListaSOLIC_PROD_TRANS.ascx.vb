...
''' -----------------------------------------------------------------------------
''' Project	 : SISPACAL
''' Class	 : ucListaSOLIC_PROD_TRANS
''' 
''' -----------------------------------------------------------------------------
''' <summary>
''' Clase del Control de Usuario para mostrar un listado de la tabla SOLIC_PROD_TRANS
''' </summary>
''' <remarks>
...
''' </history>
''' -----------------------------------------------------------------------------
Partial Class controles_ucListaSOLIC_PROD_TRANS
    Inherits ucListaBase
 
    Private mComponente As New cSOLIC_PROD_TRANS
    Public Event Seleccionado(ByVal ID_SOLIC_PROD_TRANS As Int32) 
    Public Event Editando(ByVal ID_SOLIC_PROD_TRANS As Int32)
    Public Event Eliminando(ByVal ID_SOLIC_PROD_TRANS As Int32)
...
#Region"Propiedades"
    ...
    Public Property VerID_SOLIC_PROD_TRANS() As Boolean
        Get
            Return Me.dxgvLista.Columns("ID_SOLIC_PROD_TRANS").Visible
        End Get
        Set(ByVal Value As Boolean)
            Me.dxgvLista.Columns("ID_SOLIC_PROD_TRANS").Visible = Value
        End Set
    End Property
    ...
    Public Property HeaderID_SOLIC_PROD_TRANS() As String
        Get
            Return Me.dxgvLista.Columns("ID_SOLIC_PROD_TRANS").Caption
        End Get
        Set(ByVal Value As String)
            Me.dxgvLista.Columns("ID_SOLIC_PROD_TRANS").Caption = Value
        End Set
    End Property
...
#End Region
    ...
    Public Function CargarDatosCache(ByVal nombreSesion As String) As Integer
        ...
        Me.odsSolicProdTransCache.SelectParameters("nombreSesion_uclistaSOLIC_PROD_TRANS").DefaultValue = nombreSesion
        Me.odsSolicProdTransCache.DataBind()
        Me.dxgvLista.DataSourceID = "odsSolicProdTransCache"
    ...
    ''' -----------------------------------------------------------------------------
    ''' <summary>
    ''' FunciÃ³n que Carga la informaciÃ³n de los registros de la tabla SOLIC_PROD_TRANS
    ''' </summary>
    ''' <remarks>
    ''' </remarks>
    ''' <history>
    ...
    ''' <summary>
    ''' FunciÃ³n que Carga la informaciÃ³n de los registros de la tabla SOLIC_PROD_TRANS
    ''' filtrado por la tabla SOLIC_ENCA_TRANS
    ''' </summary>
    ...
    ''' </history>
    ''' -----------------------------------------------------------------------------
    Public Function CargarDatosPorSOLIC_ENCA_TRANS(ByVal ID_SOLICITUD As Int32) As Integer
        Me.odsListaPorSOLIC_ENCA_TRANS.SelectParameters("ID_SOLICITUD").DefaultValue = ID_SOLICITUD.ToString()
        Me.odsListaPorSOLIC_ENCA_TRANS.SelectParameters("recuperarForaneas").DefaultValue = "False"
        Me.odsListaPorSOLIC_ENCA_TRANS.SelectParameters("asColumnaOrden").DefaultValue = ""
        Me.odsListaPorSOLIC_ENCA_TRANS.SelectParameters("asTipoOrden").DefaultValue = ""
        Me.odsListaPorSOLIC_ENCA_TRANS.DataBind()
        Me.dxgvLista.DataSourceID = "odsListaPorSOLIC_ENCA_TRANS"
        Me.dxgvLista.Selection.UnselectAll()
        Me.dxgvLista.Visible = True
        Me.dxgvLista.DataBind()
        Return 1
    ...
    Protected Sub dxgvLista_CustomJSProperties(ByVal sender As Object, ByVal e As DevExpress.Web.ASPxGridViewClientJSPropertiesEventArgs) Handles dxgvLista.CustomJSProperties
        If Me.PermitirSeleccionParaCombo Then
            ...
            For i As Integer = 0 To grid.VisibleRowCount - 1
                keyValues(i) = grid.GetRowValues(i, "ID_SOLIC_PROD_TRANS")
    ...
    Protected Sub dxgvLista_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles dxgvLista.Init
        ...
        End If
        dxgvLista.ForceDataRowType(GetType(listaSOLIC_PROD_TRANS))
    End Sub
    ...
    Protected Sub dxgvLista_RowCommand(ByVal sender As Object, ByVal e As DevExpress.Web.ASPxGridViewRowCommandEventArgs) Handles dxgvLista.RowCommand
        ...
        If e.CommandArgs.CommandName = "Eliminar" Then
            Dim b As New cSOLIC_PROD_TRANScache
    ...
    Public Function DevolverSeleccionados() As listaSOLIC_PROD_TRANS
        Dim mLista As New listaSOLIC_PROD_TRANS
        For Each llave As Decimal In Me.dxgvLista.GetSelectedFieldValues("ID_SOLIC_PROD_TRANS")
            Dim lEntidad As New SOLIC_PROD_TRANS
            lEntidad.ID_SOLIC_PROD_TRANS = llave
            mLista.Add(lEntidad)
        Next
        Return mLista
    End Function
    ...
    Protected Sub dxgvLista_CustomButtonCallback(ByVal sender As Object, ByVal e As DevExpress.Web.ASPxGridViewCustomButtonCallbackEventArgs) Handles dxgvLista.CustomButtonCallback
        If e.ButtonID = "btnEliminar" Then
            Dim lEntidad As SOLIC_PROD_TRANS = CType(Me.dxgvLista.GetRow(e.VisibleIndex), SOLIC_PROD_TRANS)

            If Me.mComponente.EliminarSOLIC_PROD_TRANS(lEntidad.ID_SOLIC_PROD_TRANS) <> 1 Then
    ...
    Private Function ObtenerSubTotal() As Decimal
        ...
        If Session(Me.REFERENCIA) IsNot Nothing Then
            For Each lProducto As SOLIC_PROD_TRANS In DirectCast(Session(Me.REFERENCIA), listaSOLIC_PROD_TRANS)
                subTOTAL += lProducto.SUB_TOTAL
            Next
        End If
        Return subTOTAL
    End Function
