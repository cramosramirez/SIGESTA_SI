...
''' -----------------------------------------------------------------------------
''' Project	 : SISPACAL
''' Class	 : ucListaCCF_ENCA_TRANS
''' 
''' -----------------------------------------------------------------------------
''' <summary>
''' Clase del Control de Usuario para mostrar un listado de la tabla CCF_ENCA_TRANS
''' </summary>
''' <remarks>
...
''' </history>
''' -----------------------------------------------------------------------------
Partial Class controles_ucListaCCF_ENCA_TRANS
    Inherits ucListaBase
 
    Private mComponente As New cCCF_ENCA_TRANS
    Public Event Seleccionado(ByVal ID_CCF_TRANS As Int32) 
    Public Event Editando(ByVal ID_CCF_TRANS As Int32) 
...
#Region"Propiedades"
    ...
    Public Property VerID_CCF_TRANS() As Boolean
        Get
            Return Me.dxgvLista.Columns("ID_CCF_TRANS").Visible
        End Get
        Set(ByVal Value As Boolean)
            Me.dxgvLista.Columns("ID_CCF_TRANS").Visible = Value
        End Set
    End Property
    ...
    Public Property VerUID_CCF() As Boolean
        Get
            Return Me.dxgvLista.Columns("UID_CCF").Visible
        End Get
        Set(ByVal Value As Boolean)
            Me.dxgvLista.Columns("UID_CCF").Visible = Value
        End Set
    End Property
    ...
    Public Property HeaderID_CCF_TRANS() As String
        Get
            Return Me.dxgvLista.Columns("ID_CCF_TRANS").Caption
        End Get
        Set(ByVal Value As String)
            Me.dxgvLista.Columns("ID_CCF_TRANS").Caption = Value
        End Set
    End Property
    ...
    Public Property HeaderUID_CCF() As String
        Get
            Return Me.dxgvLista.Columns("UID_CCF").Caption
        End Get
        Set(ByVal Value As String)
            Me.dxgvLista.Columns("UID_CCF").Caption = Value
        End Set
    End Property
...
#End Region
    ...
    Public Function CargarDatosPorSOLIC_ENCA_TRANS(ByVal ID_SOLICITUD As Int32) As Integer
        ...
        Me.odsListaPorSOLIC_ENCA_TRANS.SelectParameters("recuperarHijas").DefaultValue = "False"
    ...
    Protected Sub dxgvLista_CustomJSProperties(ByVal sender As Object, ByVal e As DevExpress.Web.ASPxGridViewClientJSPropertiesEventArgs) Handles dxgvLista.CustomJSProperties
        If Me.PermitirSeleccionParaCombo Then
            ...
            For i As Integer = 0 To grid.VisibleRowCount - 1
                keyValues(i) = grid.GetRowValues(i, "ID_CCF_TRANS")
    ...
    Public Function DevolverSeleccionados() As listaCCF_ENCA_TRANS
        Dim mLista As New listaCCF_ENCA_TRANS
        For Each llave As Decimal In Me.dxgvLista.GetSelectedFieldValues("ID_CCF_TRANS")
            Dim lEntidad As New CCF_ENCA_TRANS
            lEntidad.ID_CCF_TRANS = llave
            mLista.Add(lEntidad)
        Next
        Return mLista
    End Function
    ...
    Protected Sub dxgvLista_CustomButtonCallback(ByVal sender As Object, ByVal e As DevExpress.Web.ASPxGridViewCustomButtonCallbackEventArgs) Handles dxgvLista.CustomButtonCallback
        If e.ButtonID = "btnEliminar" Then
            Dim lEntidad As CCF_ENCA_TRANS = CType(Me.dxgvLista.GetRow(e.VisibleIndex), CCF_ENCA_TRANS)

            If Me.mComponente.EliminarCCF_ENCA_TRANS(lEntidad.ID_CCF_TRANS) <> 1 Then
    ...
    Protected Sub dxgvLista_CustomUnboundColumnData(sender As Object, e As DevExpress.Web.ASPxGridViewColumnDataEventArgs) Handles dxgvLista.CustomUnboundColumnData
        ...
        ElseIf e.Column.FieldName = "NUM_SOLICITUD" Then
            Dim lEntidad As SOLIC_ENCA_TRANS = (New cSOLIC_ENCA_TRANS).ObtenerSOLIC_ENCA_TRANS(e.GetListSourceFieldValue("ID_SOLICITUD"))
            If lEntidad IsNot Nothing Then e.Value = lEntidad.NUM_SOLIC_ZAFRA.ToString
