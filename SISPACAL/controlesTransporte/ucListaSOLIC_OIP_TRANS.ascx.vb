...
''' -----------------------------------------------------------------------------
''' Project	 : SISPACAL
''' Class	 : ucListaSOLIC_OIP_TRANS
''' 
''' -----------------------------------------------------------------------------
''' <summary>
''' Clase del Control de Usuario para mostrar un listado de la tabla SOLIC_OIP_TRANS
''' </summary>
''' <remarks>
...
''' </history>
''' -----------------------------------------------------------------------------
Partial Class controles_ucListaSOLIC_OIP_TRANS
    Inherits ucListaBase
 
    Private mComponente As New cSOLIC_OIP_TRANS
    Public Event Seleccionado(ByVal ID_OIP_TRANS As Int32) 
    Public Event Editando(ByVal ID_OIP_TRANS As Int32) 
...
#Region"Propiedades"
    ...
    Public Property VerID_OIP_TRANS() As Boolean
        Get
            Return Me.dxgvLista.Columns("ID_OIP_TRANS").Visible
        End Get
        Set(ByVal Value As Boolean)
            Me.dxgvLista.Columns("ID_OIP_TRANS").Visible = Value
        End Set
    End Property
    ...
    Public Property VerCUOTA_CORTE() As Boolean
        Get
            Return Me.dxgvLista.Columns("CUOTA_CORTE").Visible
        End Get
        Set(ByVal Value As Boolean)
            Me.dxgvLista.Columns("CUOTA_CORTE").Visible = Value
        End Set
    End Property

    Public Property VerUID_OIP_TRANS() As Boolean
        Get
            Return Me.dxgvLista.Columns("UID_OIP_TRANS").Visible
        End Get
        Set(ByVal Value As Boolean)
            Me.dxgvLista.Columns("UID_OIP_TRANS").Visible = Value
        End Set
    End Property

    Public Property VerPORC_DESC() As Boolean
        Get
            Return Me.dxgvLista.Columns("PORC_DESC").Visible
        End Get
        Set(ByVal Value As Boolean)
            Me.dxgvLista.Columns("PORC_DESC").Visible = Value
        End Set
    End Property

    Public Property VerPORC_DESCEFECTIVO() As Boolean
        Get
            Return Me.dxgvLista.Columns("PORC_DESCEFECTIVO").Visible
        End Get
        Set(ByVal Value As Boolean)
            Me.dxgvLista.Columns("PORC_DESCEFECTIVO").Visible = Value
        End Set
    End Property

    Public Property VerNUM_OIP_ZAFRA() As Boolean
        Get
            Return Me.dxgvLista.Columns("NUM_OIP_ZAFRA").Visible
        End Get
        Set(ByVal Value As Boolean)
            Me.dxgvLista.Columns("NUM_OIP_ZAFRA").Visible = Value
        End Set
    End Property

    Public Property VerREFERENCIA_GF() As Boolean
        Get
            Return Me.dxgvLista.Columns("REFERENCIA_GF").Visible
        End Get
        Set(ByVal Value As Boolean)
            Me.dxgvLista.Columns("REFERENCIA_GF").Visible = Value
        End Set
    End Property
    ...
    Public Property HeaderID_OIP_TRANS() As String
        Get
            Return Me.dxgvLista.Columns("ID_OIP_TRANS").Caption
        End Get
        Set(ByVal Value As String)
            Me.dxgvLista.Columns("ID_OIP_TRANS").Caption = Value
        End Set
    End Property
    ...
    Public Property HeaderCUOTA_CORTE() As String
        Get
            Return Me.dxgvLista.Columns("CUOTA_CORTE").Caption
        End Get
        Set(ByVal Value As String)
            Me.dxgvLista.Columns("CUOTA_CORTE").Caption = Value
        End Set
    End Property

    Public Property HeaderUID_OIP_TRANS() As String
        Get
            Return Me.dxgvLista.Columns("UID_OIP_TRANS").Caption
        End Get
        Set(ByVal Value As String)
            Me.dxgvLista.Columns("UID_OIP_TRANS").Caption = Value
        End Set
    End Property

    Public Property HeaderPORC_DESC() As String
        Get
            Return Me.dxgvLista.Columns("PORC_DESC").Caption
        End Get
        Set(ByVal Value As String)
            Me.dxgvLista.Columns("PORC_DESC").Caption = Value
        End Set
    End Property

    Public Property HeaderPORC_DESCEFECTIVO() As String
        Get
            Return Me.dxgvLista.Columns("PORC_DESCEFECTIVO").Caption
        End Get
        Set(ByVal Value As String)
            Me.dxgvLista.Columns("PORC_DESCEFECTIVO").Caption = Value
        End Set
    End Property

    Public Property HeaderNUM_OIP_ZAFRA() As String
        Get
            Return Me.dxgvLista.Columns("NUM_OIP_ZAFRA").Caption
        End Get
        Set(ByVal Value As String)
            Me.dxgvLista.Columns("NUM_OIP_ZAFRA").Caption = Value
        End Set
    End Property

    Public Property HeaderREFERENCIA_GF() As String
        Get
            Return Me.dxgvLista.Columns("REFERENCIA_GF").Caption
        End Get
        Set(ByVal Value As String)
            Me.dxgvLista.Columns("REFERENCIA_GF").Caption = Value
        End Set
    End Property
...
#End Region
    ...
    ''' -----------------------------------------------------------------------------
    ''' <summary>
    ''' FunciÃ³n que Carga la informaciÃ³n de los registros de la tabla SOLIC_OIP_TRANS
    ''' </summary>
    ''' <remarks>
    ''' </remarks>
    ''' <history>
    ...
    Protected Sub dxgvLista_CustomJSProperties(ByVal sender As Object, ByVal e As DevExpress.Web.ASPxGridViewClientJSPropertiesEventArgs) Handles dxgvLista.CustomJSProperties
        If Me.PermitirSeleccionParaCombo Then
            ...
            For i As Integer = 0 To grid.VisibleRowCount - 1
                keyValues(i) = grid.GetRowValues(i, "ID_OIP_TRANS")
    ...
    Public Function DevolverSeleccionados() As listaSOLIC_OIP_TRANS
        Dim mLista As New listaSOLIC_OIP_TRANS
        For Each llave As Decimal In Me.dxgvLista.GetSelectedFieldValues("ID_OIP_TRANS")
            Dim lEntidad As New SOLIC_OIP_TRANS
            lEntidad.ID_OIP_TRANS = llave
            mLista.Add(lEntidad)
        Next
        Return mLista
    End Function
    ...
    Protected Sub dxgvLista_CustomButtonCallback(ByVal sender As Object, ByVal e As DevExpress.Web.ASPxGridViewCustomButtonCallbackEventArgs) Handles dxgvLista.CustomButtonCallback
        If e.ButtonID = "btnEliminar" Then
            Dim lEntidad As SOLIC_OIP_TRANS = CType(Me.dxgvLista.GetRow(e.VisibleIndex), SOLIC_OIP_TRANS)

            If Me.mComponente.EliminarSOLIC_OIP_TRANS(lEntidad.ID_OIP_TRANS) <> 1 Then
