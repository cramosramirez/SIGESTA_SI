...
''' -----------------------------------------------------------------------------
''' Project	 : SISPACAL
''' Class	 : ucListaREMESA_DETA_TRANS
''' 
''' -----------------------------------------------------------------------------
''' <summary>
''' Clase del Control de Usuario para mostrar un listado de la tabla REMESA_DETA_TRANS
''' </summary>
''' <remarks>
...
''' </history>
''' -----------------------------------------------------------------------------
Partial Class controles_ucListaREMESA_DETA_TRANS
    Inherits ucListaBase
 
    Private mComponente As New cREMESA_DETA_TRANS
...
#End Region
    ...
    Public Function CargarDatosCache(ByVal nombreSesion As String) As Integer
        ...
        Me.odsREMESA_DETA_TRANScache.SelectParameters("nombreSesion_ucListaREMESA_DETA_TRANS").DefaultValue = nombreSesion
        Me.odsREMESA_DETA_TRANScache.DataBind()
        Me.dxgvLista.DataSourceID = "odsREMESA_DETA_TRANScache"
    ...
    ''' -----------------------------------------------------------------------------
    ''' <summary>
    ''' FunciÃ³n que Carga la informaciÃ³n de los registros de la tabla REMESA_DETA_TRANS
    ''' </summary>
    ''' <remarks>
    ''' </remarks>
    ''' <history>
    ...
    ''' <summary>
    ''' FunciÃ³n que Carga la informaciÃ³n de los registros de la tabla REMESA_DETA_TRANS
    ''' filtrado por la tabla REMESA_ENCA_TRANS
    ''' </summary>
    ...
    ''' </history>
    ''' -----------------------------------------------------------------------------
    Public Function CargarDatosPorREMESA_ENCA_TRANS(ByVal ID_REMESA_ENCA As Int32) As Integer
        Me.odsListaPorREMESA_ENCA_TRANS.SelectParameters("ID_REMESA_ENCA").DefaultValue = ID_REMESA_ENCA.ToString()
        Me.odsListaPorREMESA_ENCA_TRANS.SelectParameters("recuperarForaneas").DefaultValue = "False"
        Me.odsListaPorREMESA_ENCA_TRANS.SelectParameters("asColumnaOrden").DefaultValue = ""
        Me.odsListaPorREMESA_ENCA_TRANS.SelectParameters("asTipoOrden").DefaultValue = ""
        Me.odsListaPorREMESA_ENCA_TRANS.DataBind()
        Me.dxgvLista.DataSourceID = "odsListaPorREMESA_ENCA_TRANS"
        Me.dxgvLista.Selection.UnselectAll()
        Me.dxgvLista.Visible = True
        Me.dxgvLista.DataBind()
        Return 1
    ...
    ''' <summary>
    ''' FunciÃ³n que Carga la informaciÃ³n de los registros de la tabla REMESA_DETA_TRANS
    ''' filtrado por la tabla CREDITO_ENCA_TRANS
    ''' </summary>
    ...
    ''' </history>
    ''' -----------------------------------------------------------------------------
    Public Function CargarDatosPorCREDITO_ENCA_TRANS(ByVal ID_CREDITO_ENCA As Int32) As Integer
        Me.odsListaPorCREDITO_ENCA_TRANS.SelectParameters("ID_CREDITO_ENCA").DefaultValue = ID_CREDITO_ENCA.ToString()
        Me.odsListaPorCREDITO_ENCA_TRANS.SelectParameters("recuperarForaneas").DefaultValue = "False"
        Me.odsListaPorCREDITO_ENCA_TRANS.SelectParameters("asColumnaOrden").DefaultValue = ""
        Me.odsListaPorCREDITO_ENCA_TRANS.SelectParameters("asTipoOrden").DefaultValue = ""
        Me.odsListaPorCREDITO_ENCA_TRANS.DataBind()
        Me.dxgvLista.DataSourceID = "odsListaPorCREDITO_ENCA_TRANS"
        Me.dxgvLista.Selection.UnselectAll()
        Me.dxgvLista.Visible = True
        Me.dxgvLista.DataBind()
        Return 1
    ...
    Protected Sub dxgvLista_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles dxgvLista.Init
        ...
        End If
        dxgvLista.ForceDataRowType(GetType(listaREMESA_DETA_TRANS))
    End Sub
    ...
    Public Function DevolverSeleccionados() As listaREMESA_DETA_TRANS
        Dim mLista As New listaREMESA_DETA_TRANS
    ...
    Protected Sub dxgvLista_CustomButtonCallback(ByVal sender As Object, ByVal e As DevExpress.Web.ASPxGridViewCustomButtonCallbackEventArgs) Handles dxgvLista.CustomButtonCallback
        If e.ButtonID = "btnEliminar" Then
            Dim lEntidad As REMESA_DETA_TRANS = CType(Me.dxgvLista.GetRow(e.VisibleIndex), REMESA_DETA_TRANS)

            If Me.mComponente.EliminarREMESA_DETA_TRANS(lEntidad.ID_REMESA_DETA) <> 1 Then
    ...
    Protected Sub dxgvLista_CustomUnboundColumnData(sender As Object, e As DevExpress.Web.ASPxGridViewColumnDataEventArgs) Handles dxgvLista.CustomUnboundColumnData
        ...
        If idCrediEnca <> e.GetListSourceFieldValue("ID_CREDITO_ENCA") IsNot Nothing Then
            ...
            lEntidad = (New cCREDITO_ENCA_TRANS).ObtenerCREDITO_ENCA_TRANS(idCrediEnca)
