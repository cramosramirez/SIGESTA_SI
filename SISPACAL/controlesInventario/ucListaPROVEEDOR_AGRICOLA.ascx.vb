...
''' -----------------------------------------------------------------------------
''' Project	 : SISPACAL
''' Class	 : ucListaPROVEEDOR_AGRICOLA
''' 
''' -----------------------------------------------------------------------------
''' <summary>
''' Clase del Control de Usuario para mostrar un listado de la tabla PROVEEDOR_AGRICOLA
''' </summary>
''' <remarks>
...
''' </history>
''' -----------------------------------------------------------------------------
Partial Class controles_ucListaPROVEEDOR_AGRICOLA
    Inherits ucListaBase
 
    Private mComponente As New cPROVEEDOR_AGRICOLA
    Public Event Seleccionado(ByVal ID_PROVEE As Int32) 
    Public Event Editando(ByVal ID_PROVEE As Int32) 
...
#End Region
    ...
    Protected Sub dxgvLista_CustomJSProperties(ByVal sender As Object, ByVal e As DevExpress.Web.ASPxGridViewClientJSPropertiesEventArgs) Handles dxgvLista.CustomJSProperties
        If Me.PermitirSeleccionParaCombo Then
            ...
            For i As Integer = 0 To grid.VisibleRowCount - 1
                keyValues(i) = grid.GetRowValues(i, "ID_PROVEE")
    ...
    Public Function DevolverSeleccionados() As listaPROVEEDOR_AGRICOLA
        Dim mLista As New listaPROVEEDOR_AGRICOLA
        For Each llave As Decimal In Me.dxgvLista.GetSelectedFieldValues("ID_PROVEE")
            Dim lEntidad As New PROVEEDOR_AGRICOLA
            lEntidad.ID_PROVEE = llave
            mLista.Add(lEntidad)
        Next
        Return mLista
    End Function
    ...
    Protected Sub dxgvLista_CustomButtonCallback(ByVal sender As Object, ByVal e As DevExpress.Web.ASPxGridViewCustomButtonCallbackEventArgs) Handles dxgvLista.CustomButtonCallback
        If e.ButtonID = "btnEliminar" Then
            Dim lEntidad As PROVEEDOR_AGRICOLA = CType(Me.dxgvLista.GetRow(e.VisibleIndex), PROVEEDOR_AGRICOLA)

            If Me.mComponente.EliminarPROVEEDOR_AGRICOLA(lEntidad.ID_PROVEE) <> 1 Then
