...
''' -----------------------------------------------------------------------------
''' Project	 : SISPACAL
''' Class	 : ucListaCATEGORIA_PROD
''' 
''' -----------------------------------------------------------------------------
''' <summary>
''' Clase del Control de Usuario para mostrar un listado de la tabla CATEGORIA_PROD
''' </summary>
''' <remarks>
...
''' </history>
''' -----------------------------------------------------------------------------
Partial Class controles_ucListaCATEGORIA_PROD
    Inherits ucListaBase
 
    Private mComponente As New cCATEGORIA_PROD
    Public Event Seleccionado(ByVal ID_CATEGORIA As Int32) 
    Public Event Editando(ByVal ID_CATEGORIA As Int32) 
...
#Region"Propiedades"
    ...
    Public Property VerNOMBRE_CATEGORIA() As Boolean
        Get
            Return Me.dxgvLista.Columns("NOMBRE_CATEGORIA").Visible
        End Get
        Set(ByVal Value As Boolean)
            Me.dxgvLista.Columns("NOMBRE_CATEGORIA").Visible = Value
        End Set
    End Property
    ...
    Public Property HeaderNOMBRE_CATEGORIA() As String
        Get
            Return Me.dxgvLista.Columns("NOMBRE_CATEGORIA").Caption
        End Get
        Set(ByVal Value As String)
            Me.dxgvLista.Columns("NOMBRE_CATEGORIA").Caption = Value
        End Set
    End Property
...
#End Region
    ...
    Protected Sub dxgvLista_CustomJSProperties(ByVal sender As Object, ByVal e As DevExpress.Web.ASPxGridViewClientJSPropertiesEventArgs) Handles dxgvLista.CustomJSProperties
        If Me.PermitirSeleccionParaCombo Then
            ...
            For i As Integer = 0 To grid.VisibleRowCount - 1
                keyValues(i) = grid.GetRowValues(i, "ID_CATEGORIA")
                keyNames(i) = grid.GetRowValues(i, "NOMBRE_CATEGORIA")
            Next i
    ...
    Public Function DevolverSeleccionados() As listaCATEGORIA_PROD
        Dim mLista As New listaCATEGORIA_PROD
        For Each llave As Decimal In Me.dxgvLista.GetSelectedFieldValues("ID_CATEGORIA")
            Dim lEntidad As New CATEGORIA_PROD
            lEntidad.ID_CATEGORIA = llave
            mLista.Add(lEntidad)
        Next
        Return mLista
    End Function
    ...
    Protected Sub dxgvLista_CustomButtonCallback(ByVal sender As Object, ByVal e As DevExpress.Web.ASPxGridViewCustomButtonCallbackEventArgs) Handles dxgvLista.CustomButtonCallback
        If e.ButtonID = "btnEliminar" Then
            Dim lEntidad As CATEGORIA_PROD = CType(Me.dxgvLista.GetRow(e.VisibleIndex), CATEGORIA_PROD)

            If Me.mComponente.EliminarCATEGORIA_PROD(lEntidad.ID_CATEGORIA) <> 1 Then
