...
''' -----------------------------------------------------------------------------
''' Project	 : SISPACAL
''' Class	 : ucListaUNIDAD_MEDIDA
''' 
''' -----------------------------------------------------------------------------
''' <summary>
''' Clase del Control de Usuario para mostrar un listado de la tabla UNIDAD_MEDIDA
''' </summary>
''' <remarks>
...
''' </history>
''' -----------------------------------------------------------------------------
Partial Class controles_ucListaUNIDAD_MEDIDA
    Inherits ucListaBase
 
    Private mComponente As New cUNIDAD_MEDIDA
    Public Event Seleccionado(ByVal ID_UNIDAD As Int32) 
    Public Event Editando(ByVal ID_UNIDAD As Int32) 
...
#Region"Propiedades"
    ...
    Public Property VerNOMBRE_UNIDAD() As Boolean
        Get
            Return Me.dxgvLista.Columns("NOMBRE_UNIDAD").Visible
        End Get
        Set(ByVal Value As Boolean)
            Me.dxgvLista.Columns("NOMBRE_UNIDAD").Visible = Value
        End Set
    End Property
    ...
    Public Property HeaderNOMBRE_UNIDAD() As String
        Get
            Return Me.dxgvLista.Columns("NOMBRE_UNIDAD").Caption
        End Get
        Set(ByVal Value As String)
            Me.dxgvLista.Columns("NOMBRE_UNIDAD").Caption = Value
        End Set
    End Property
...
#End Region
    ...
    ''' -----------------------------------------------------------------------------
    ''' <summary>
    ''' FunciÃ³n que Carga la informaciÃ³n de los registros de la tabla UNIDAD_MEDIDA
    ''' </summary>
    ''' <remarks>
    ''' </remarks>
    ''' <history>
    ...
    Protected Sub dxgvLista_CustomJSProperties(ByVal sender As Object, ByVal e As DevExpress.Web.ASPxGridViewClientJSPropertiesEventArgs) Handles dxgvLista.CustomJSProperties
        If Me.PermitirSeleccionParaCombo Then
            ...
            For i As Integer = 0 To grid.VisibleRowCount - 1
                keyValues(i) = grid.GetRowValues(i, "ID_UNIDAD")
                keyNames(i) = grid.GetRowValues(i, "NOMBRE_UNIDAD")
            Next i
    ...
    Public Function DevolverSeleccionados() As listaUNIDAD_MEDIDA
        Dim mLista As New listaUNIDAD_MEDIDA
        For Each llave As Decimal In Me.dxgvLista.GetSelectedFieldValues("ID_UNIDAD")
            Dim lEntidad As New UNIDAD_MEDIDA
            lEntidad.ID_UNIDAD = llave
            mLista.Add(lEntidad)
        Next
        Return mLista
    End Function
    ...
    Protected Sub dxgvLista_CustomButtonCallback(ByVal sender As Object, ByVal e As DevExpress.Web.ASPxGridViewCustomButtonCallbackEventArgs) Handles dxgvLista.CustomButtonCallback
        If e.ButtonID = "btnEliminar" Then
            Dim lEntidad As UNIDAD_MEDIDA = CType(Me.dxgvLista.GetRow(e.VisibleIndex), UNIDAD_MEDIDA)

            If Me.mComponente.EliminarUNIDAD_MEDIDA(lEntidad.ID_UNIDAD) <> 1 Then
