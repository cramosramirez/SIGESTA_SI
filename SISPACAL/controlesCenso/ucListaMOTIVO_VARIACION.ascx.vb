...
''' -----------------------------------------------------------------------------
''' Project	 : SISPACAL
''' Class	 : ucListaMOTIVO_VARIACION
''' 
''' -----------------------------------------------------------------------------
''' <summary>
''' Clase del Control de Usuario para mostrar un listado de la tabla MOTIVO_VARIACION
''' </summary>
''' <remarks>
...
''' </history>
''' -----------------------------------------------------------------------------
Partial Class controles_ucListaMOTIVO_VARIACION
    Inherits ucListaBase
 
    Private mComponente As New cMOTIVO_VARIACION
    Public Event Seleccionado(ByVal ID_MOTIVO_VARIACION As Int32) 
    Public Event Editando(ByVal ID_MOTIVO_VARIACION As Int32) 
...
#Region"Propiedades"
    ...
    Public Property VerDESCRIP_MOTIVO_VARIACION() As Boolean
        Get
            Return Me.dxgvLista.Columns("DESCRIP_MOTIVO_VARIACION").Visible
        End Get
        Set(ByVal Value As Boolean)
            Me.dxgvLista.Columns("DESCRIP_MOTIVO_VARIACION").Visible = Value
        End Set
    End Property
    ...
    Public Property HeaderDESCRIP_MOTIVO_VARIACION() As String
        Get
            Return Me.dxgvLista.Columns("DESCRIP_MOTIVO_VARIACION").Caption
        End Get
        Set(ByVal Value As String)
            Me.dxgvLista.Columns("DESCRIP_MOTIVO_VARIACION").Caption = Value
        End Set
    End Property
...
#End Region
    ...
    Protected Sub dxgvLista_CustomJSProperties(ByVal sender As Object, ByVal e As DevExpress.Web.ASPxGridViewClientJSPropertiesEventArgs) Handles dxgvLista.CustomJSProperties
        If Me.PermitirSeleccionParaCombo Then
            ...
            For i As Integer = 0 To grid.VisibleRowCount - 1
                keyValues(i) = grid.GetRowValues(i, "ID_MOTIVO_VARIACION")
                keyNames(i) = grid.GetRowValues(i, "DESCRIP_MOTIVO_VARIACION")
            Next i
    ...
    Public Function DevolverSeleccionados() As listaMOTIVO_VARIACION
        Dim mLista As New listaMOTIVO_VARIACION
        For Each llave As Decimal In Me.dxgvLista.GetSelectedFieldValues("ID_MOTIVO_VARIACION")
            Dim lEntidad As New MOTIVO_VARIACION
            lEntidad.ID_MOTIVO_VARIACION = llave
            mLista.Add(lEntidad)
        Next
        Return mLista
    End Function
    ...
    Protected Sub dxgvLista_CustomButtonCallback(ByVal sender As Object, ByVal e As DevExpress.Web.ASPxGridViewCustomButtonCallbackEventArgs) Handles dxgvLista.CustomButtonCallback
        If e.ButtonID = "btnEliminar" Then
            Dim lEntidad As MOTIVO_VARIACION = CType(Me.dxgvLista.GetRow(e.VisibleIndex), MOTIVO_VARIACION)

            If Me.mComponente.EliminarMOTIVO_VARIACION(lEntidad.ID_MOTIVO_VARIACION) <> 1 Then
