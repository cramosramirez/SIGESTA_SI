<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ucCriteriosRozaInjiboaRela.ascx.vb" Inherits="controlesCenso_ucCriteriosRozaInjiboaRela" %>
...
<table border="0" >
        ...
        <td>
            <table>
                <tr>
                    ...
                    <td>
                        <table>
                               <tr id="trPROVEEDOR_ROZA_PARTI" runat="server" visible="false">
                                   <td>
                                        <dx:ASPxLabel ID="ASPxLabel4" runat="server" Text="FRENTE DE ROZA:" />           
                                   </td>
                                   <td>
                                        <dx:ASPxComboBox ID="cbxPROVEEDOR_ROZA" ValueType="System.Int32" runat="server" 
                                             TextField="NOMBRE_PROVEEDOR_ROZA" ValueField="ID_PROVEEDOR_ROZA"
                                            Theme="Office2010Blue" Width="220px" >                            
                                        </dx:ASPxComboBox>    
                                   </td>
                               </tr>
    ...
    <tr id="trPROVEEDORES_CARGA" runat="server" visible="false">
        <td><dx:ASPxLabel ID="ASPxLabel11" runat="server" Text="PROVEEDOR CARGA:">
            </dx:ASPxLabel>
        </td>
        <th colspan="2">
            <dx:ASPxComboBox ID="cbxPROVEEDORES_CARGA" ValueType="System.Int32" TextField="NOMBRE_PROVEEDOR_CARGA" ValueField="ID_PROVEEDOR_CARGA" runat="server" DropDownStyle="DropDownList"
                Theme="Office2010Blue" Width="300px" >                
            </dx:ASPxComboBox>           
        </th>
    </tr>
