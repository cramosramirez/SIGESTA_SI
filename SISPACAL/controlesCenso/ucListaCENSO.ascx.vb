...
''' -----------------------------------------------------------------------------
''' <summary>
''' Clase del Control de Usuario para mostrar un listado de la tabla CENSO
''' </summary>
''' <remarks>
...
''' </history>
''' -----------------------------------------------------------------------------
Partial Class controles_ucListaCENSO
    Inherits ucListaBase
 
    Private mComponente As New cCENSO
    Public Event Seleccionado(ByVal ID_CENSO As Int32) 
    Public Event Editando(ByVal ID_CENSO As Int32) 
...
#Region"Propiedades"
    ...
    Public Property VerFECHA_CENSO() As Boolean
        Get
            Return Me.dxgvLista.Columns("FECHA_CENSO").Visible
        End Get
        Set(ByVal Value As Boolean)
            Me.dxgvLista.Columns("FECHA_CENSO").Visible = Value
        End Set
    End Property
    ...
    Public Property HeaderFECHA_CENSO() As String
        Get
            Return Me.dxgvLista.Columns("FECHA_CENSO").Caption
        End Get
        Set(ByVal Value As String)
            Me.dxgvLista.Columns("FECHA_CENSO").Caption = Value
        End Set
    End Property
...
#End Region
    ...
    Protected Sub dxgvLista_CustomJSProperties(ByVal sender As Object, ByVal e As DevExpress.Web.ASPxGridViewClientJSPropertiesEventArgs) Handles dxgvLista.CustomJSProperties
        If Me.PermitirSeleccionParaCombo Then
            ...
            For i As Integer = 0 To grid.VisibleRowCount - 1
                keyValues(i) = grid.GetRowValues(i, "ID_CENSO")
    ...
    Public Function DevolverSeleccionados() As listaCENSO
        Dim mLista As New listaCENSO
        For Each llave As Decimal In Me.dxgvLista.GetSelectedFieldValues("ID_CENSO")
            Dim lEntidad As New CENSO
            lEntidad.ID_CENSO = llave
            mLista.Add(lEntidad)
        Next
        Return mLista
    End Function
    ...
    Protected Sub dxgvLista_CustomButtonCallback(ByVal sender As Object, ByVal e As DevExpress.Web.ASPxGridViewCustomButtonCallbackEventArgs) Handles dxgvLista.CustomButtonCallback
        If e.ButtonID = "btnEliminar" Then
            Dim lEntidad As CENSO = CType(Me.dxgvLista.GetRow(e.VisibleIndex), CENSO)

            If Me.mComponente.EliminarCENSO(lEntidad.ID_CENSO) <> 1 Then
