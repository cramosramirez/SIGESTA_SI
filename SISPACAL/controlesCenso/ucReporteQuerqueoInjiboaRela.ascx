<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ucReporteQuerqueoInjiboaRela.ascx.vb" Inherits="controlesCenso_ucReporteQuerqueoInjiboaRela" %>
<%@ Register Src="~/controles/ucBarraNavegacion.ascx" TagName="ucBarraNavegacion" TagPrefix="uc1" %>
<%@ Register Src="~/controlesCenso/ucCriteriosQuerqueoInjiboaRela.ascx" TagName="ucCriteriosQuerqueoInjiboaRela" TagPrefix="uc1" %>
...
<table id="TableMant" border="0" cellpadding="0" cellspacing="0" width="100%">
    ...
    <tr>
        <td>
            <uc1:ucCriteriosQuerqueoInjiboaRela ID="ucCriteriosQuerqueoInjiboaRela1" runat="server"></uc1:ucCriteriosQuerqueoInjiboaRela>
        </td>
    </tr>
   <tr>
        <td>
