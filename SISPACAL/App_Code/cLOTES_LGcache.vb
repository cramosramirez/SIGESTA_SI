...
Public Class cLOTES_LGcache
    Private _SESION As HttpSessionState

    <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Select, False)>
    Public Function ObtenerLista(ByVal nombreSesion As String) As listaLOTES_LG
        Try
            _SESION = HttpContext.Current.Session
            If _SESION(nombreSesion) Is Nothing Then Return New listaLOTES_LG
            Return TryCast(_SESION(nombreSesion), listaLOTES_LG)
    ...
    Public Function ActualizarLOTES_LG(ByVal ACCESLOTE As String, ByVal ANIOZAFRA As String, ByVal CODIPROVEEDOR As String,
                                    ByVal CODILOTE As String, ByVal CODIAGRON As String, ByVal CODIVARIEDA As String,
                                    ByVal CODIUBICACION As String, ByVal CODICONTRATO As String, ByVal NOMBLOTE As String,
                                    ByVal AREA As Decimal, ByVal TONELADAS As Decimal, ByVal TONEL_TC As Decimal,
                                    ByVal ZONA As String, ByVal SUB_ZONA As String, ByVal EDAD_LOTE As Decimal, ByVal USER_CREA As Int32,
                                    ByVal FECHA_CREA As DateTime, ByVal USER_ACT As Int32, ByVal FECHA_ACT As DateTime,
                                    ByVal ID_MAESTRO As Int32, ByVal TIPO_DERECHO As Int32, ByVal REFERENCIA As String,
                                    ByVal CODISOCIO As String, ByVal ID_LOTE_TRASPASO As Int32, ByVal AREA_CANA As Decimal,
        ...
        End If
        _SESION = HttpContext.Current.Session
        Dim mLotes As listaLOTES_LG = _SESION(REFERENCIA)
