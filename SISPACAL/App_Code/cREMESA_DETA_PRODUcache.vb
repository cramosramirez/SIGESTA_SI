...
Public Class cREMESA_DETA_PRODUcache

    Private _SESION As HttpSessionState


    <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Select, True)> _
    Public Function ObtenerLista(ByVal nombreSesion_ucListaREMESA_DETA_PRODU As String) As listaREMESA_DETA_PRODU
        Try
            Dim lista As listaREMESA_DETA_PRODU
            _SESION = HttpContext.Current.Session
            If _SESION(nombreSesion_ucListaREMESA_DETA_PRODU) Is Nothing Then Return New listaREMESA_DETA_PRODU
            lista = TryCast(_SESION(nombreSesion_ucListaREMESA_DETA_PRODU), listaREMESA_DETA_PRODU)
    ...
    Public Function Actualizar(ByVal ID_REMESA_DETA As Int32, ByVal ID_REMESA_ENCA As Int32, _
        ...
        Try
            _SESION = HttpContext.Current.Session
            Dim mDetalle As listaREMESA_DETA_PRODU = _SESION(REFERENCIA)
