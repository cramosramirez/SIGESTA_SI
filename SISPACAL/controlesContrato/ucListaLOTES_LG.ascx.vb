...
''' </history>
''' -----------------------------------------------------------------------------
Partial Class controles_ucListaLOTES_LG
    Inherits ucListaBase

    Private mComponente As New cLOTES_LG
...
#End Region
    ...
    Public Function DevolverSeleccionados() As listaLOTES_LG
        Dim mLista As New listaLOTES_LG
    ...
    Protected Sub dxgvLista_CustomButtonCallback(ByVal sender As Object, ByVal e As DevExpress.Web.ASPxGridViewCustomButtonCallbackEventArgs) Handles dxgvLista.CustomButtonCallback
        If e.ButtonID = "btnEliminar" Then
            Dim lEntidad As LOTES_LG = CType(Me.dxgvLista.GetRow(e.VisibleIndex), LOTES_LG)

            If Me.mComponente.EliminarLOTES_LG(lEntidad.ACCESLOTE) <> 1 Then
        ...
        Select Case e.Column.FieldName
            Case "NO_CONTRATO"
                If e.GetListSourceFieldValue("CODICONTRATO") IsNot Nothing Then
                    Dim lContrato As CONTRATO_LG = (New cCONTRATO_LG).ObtenerCONTRATO_LG(e.GetListSourceFieldValue("CODICONTRATO"))
            ...
            Case "NOMBRE_AGRONOMO"
                If Me.ViewState("ID_ZAFRA") IsNot Nothing Then
                    ...
                    Else
                        Dim lLotes As LOTES_LG = (New cLOTES_LG).ObtenerLOTES_LG(e.GetListSourceFieldValue("ACCESLOTE"))
