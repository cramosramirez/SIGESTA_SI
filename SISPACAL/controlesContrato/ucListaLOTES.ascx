<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ucListaLOTES.ascx.vb" Inherits="controles_ucListaLOTES" %>
<%@ Register TagPrefix="cc1" Namespace="SISPACAL.WebUC" Assembly="SISPACAL_WebUC" %>
<%@ Register assembly="DevExpress.Web.v14.2, Version=14.2.4.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" namespace="DevExpress.Web" tagprefix="dx" %>

<%@ Register src="ucVistaDetalleLOTES.ascx" tagname="ucVistaDetalleLOTES" tagprefix="uc1" %>
...
<script type="text/javascript">
    ...
    function CallbackLotes(s, e) {        
        cpMantCONTRATO.PerformCallback('TotalizarMZ_TONEL');
    }
</script>
...
<asp:ObjectDataSource ID="odsZAFRA_CONTRATADA_PROVEEDOR_CONTRATADO" runat="server" TypeName="SISPACAL.BL.cLOTES" SelectMethod="ObtenerListaPorZAFRA_CONTRATADA_PROVEEDOR_CONTRATADO" >       
     <SelectParameters>       
...
<asp:ObjectDataSource ID="odsZAFRA_CONTRATADA_PROVEEDOR" runat="server" TypeName="SISPACAL.BL.cLOTES" SelectMethod="ObtenerListaPorZAFRA_CONTRATADA_PROVEEDOR" >       
     <SelectParameters>       
        <asp:Parameter DefaultValue="-1" Name="ID_ZAFRA" Type="Int32" />
        <asp:Parameter DefaultValue="" Name="CODIPROVEEDOR" Type="String" />
        <asp:Parameter DefaultValue="" Name="CODIAGRON" Type="String" />
...
<asp:ObjectDataSource ID="odsListaPorZAFRA_NO_CONTRATO" runat="server" TypeName="SISPACAL.BL.cLOTES" SelectMethod="ObtenerListaPorZAFRA_NO_CONTRATO" >       
     <SelectParameters>       
        <asp:Parameter DefaultValue="-1" Name="ID_ZAFRA" Type="Int32" />
        <asp:Parameter DefaultValue="" Name="NO_CONTRATO" Type="Int32" />        
     </SelectParameters>
</asp:ObjectDataSource>
<asp:ObjectDataSource ID="odsListaPorCriterios2" runat="server" TypeName="SISPACAL.BL.cLOTES" SelectMethod="ObtenerListaPorCriterios2" >       
     <SelectParameters>       
...
<asp:ObjectDataSource ID="odsLotesCache" runat="server" TypeName="cLOTEScache" SelectMethod="ObtenerLista" UpdateMethod="ActualizarLOTES">       
     <SelectParameters>       
...
<asp:ObjectDataSource ID="odsLista" runat="server" 
    SelectMethod="ObtenerLista" InsertMethod="AgregarLOTES" DeleteMethod="EliminarLOTES" UpdateMethod="ActualizarLOTES"
    TypeName="SISPACAL.BL.cLOTES">
    <SelectParameters>
        <asp:Parameter DefaultValue="False" Name="recuperarHijas" Type="Boolean" />
        <asp:Parameter DefaultValue="False" Name="recuperarForaneas" Type="Boolean" />
...
<asp:ObjectDataSource ID="odsListaPorPROVEEDOR" runat="server" 
    SelectMethod="ObtenerListaPorPROVEEDOR" InsertMethod="AgregarLOTES" DeleteMethod="EliminarLOTES" UpdateMethod="ActualizarLOTES"
    TypeName="SISPACAL.BL.cLOTES">
    <SelectParameters>
        <asp:Parameter Name="CODIPROVEEDOR" Type="String" />
        <asp:Parameter DefaultValue="False" Name="recuperarHijas" Type="Boolean" />
...
<asp:ObjectDataSource ID="odsListaPorAGRONOMO" runat="server" 
    SelectMethod="ObtenerListaPorAGRONOMO" InsertMethod="AgregarLOTES" DeleteMethod="EliminarLOTES" UpdateMethod="ActualizarLOTES"
    TypeName="SISPACAL.BL.cLOTES">
    <SelectParameters>
        <asp:Parameter Name="CODIAGRON" Type="String" />
        <asp:Parameter DefaultValue="False" Name="recuperarHijas" Type="Boolean" />
...
<asp:ObjectDataSource ID="odsListaPorVARIEDAD" runat="server" 
    SelectMethod="ObtenerListaPorVARIEDAD" InsertMethod="AgregarLOTES" DeleteMethod="EliminarLOTES" UpdateMethod="ActualizarLOTES"
    TypeName="SISPACAL.BL.cLOTES">
    <SelectParameters>
        <asp:Parameter Name="CODIVARIEDA" Type="String" />
        <asp:Parameter DefaultValue="False" Name="recuperarHijas" Type="Boolean" />
...
<asp:ObjectDataSource ID="odsListaPorUBICACION" runat="server" 
    SelectMethod="ObtenerListaPorUBICACION" InsertMethod="AgregarLOTES" DeleteMethod="EliminarLOTES" UpdateMethod="ActualizarLOTES"
    TypeName="SISPACAL.BL.cLOTES">
    <SelectParameters>
        <asp:Parameter Name="CODIUBICACION" Type="String" />
        <asp:Parameter DefaultValue="False" Name="recuperarHijas" Type="Boolean" />
...
<asp:ObjectDataSource ID="odsListaPorCONTRATO" runat="server" 
    SelectMethod="ObtenerListaPorCONTRATO" InsertMethod="AgregarLOTES" DeleteMethod="EliminarLOTES" UpdateMethod="ActualizarLOTES"
    TypeName="SISPACAL.BL.cLOTES">
    <SelectParameters>
        <asp:Parameter Name="CODICONTRATO" Type="String" />
        <asp:Parameter DefaultValue="False" Name="recuperarHijas" Type="Boolean" />
...
<asp:ObjectDataSource ID="odsListaPorMAESTRO_LOTES" runat="server" 
    SelectMethod="ObtenerListaPorMAESTRO_LOTES" InsertMethod="AgregarLOTES" DeleteMethod="EliminarLOTES" UpdateMethod="ActualizarLOTES"
    TypeName="SISPACAL.BL.cLOTES">
    <SelectParameters>
        <asp:Parameter Name="CODIGO_LOTE" Type="String" />
        <asp:Parameter DefaultValue="False" Name="recuperarHijas" Type="Boolean" />
...
<asp:ObjectDataSource ID="odsListaPorZAFRA" runat="server" 
    SelectMethod="ObtenerListaPorZAFRA" InsertMethod="AgregarLOTES" DeleteMethod="EliminarLOTES" UpdateMethod="ActualizarLOTES"
    TypeName="SISPACAL.BL.cLOTES">
    <SelectParameters>
        <asp:Parameter Name="ID_ZAFRA" Type="Int32" />
        <asp:Parameter DefaultValue="False" Name="recuperarHijas" Type="Boolean" />
