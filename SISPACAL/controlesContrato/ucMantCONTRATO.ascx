<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ucMantCONTRATO.ascx.vb" Inherits="controles_ucMantCONTRATO" %>
<%@ Register TagPrefix="uc1" TagName="ucBarraNavegacion" Src="~/controles/ucBarraNavegacion.ascx" %>
<%@ Register TagPrefix="uc1" TagName="ucListaCONTRATO" Src="~/controlesContrato/ucListaCONTRATO.ascx" %>
<%@ Register TagPrefix="uc1" TagName="ucVistaDetalleCONTRATO" Src="~/controlesContrato/ucVistaDetalleCONTRATO.ascx" %>
...
<script type="text/javascript">
    ...
    function CrearContrato() {
        ldpCargando.Show();
        cpMantCONTRATO.PerformCallback('CrearContrato');
    }
    function GuardarContrato() {
        ldpCargando.Show();
        cpMantCONTRATO.PerformCallback('GuardarContrato');
    }
    function MostrarLotes() {
        ldpCargando.Show();
        cpMantCONTRATO.PerformCallback('MostrarLotes');
    }
    function ObtenerSocio() {
        cpMantCONTRATO.PerformCallback('ObtenerSocio');
    }
    function AgregarLotes(e) {
        ldpCargando.Show();
        cpMantCONTRATO.PerformCallback('AgregarLotes;' + e.toString());
    }
...
<dx:ASPxCallbackPanel ID="cpMantCONTRATO" ClientInstanceName="cpMantCONTRATO" runat="server" ShowLoadingPanel="false" Width="100%" >
...
<table id="TableMant" cellspacing="0" cellpadding="0" width="100%" border="0">
    ...
    <tr>
        <td align="center" class="EncabezadoSecciones"><asp:Label id="lblTitulo" style="Z-INDEX: 101" runat="server">Mantenimiento de Contratos</asp:Label></td>
    </tr>
    <tr>
        <td>
    ...
    <tr>
        <td><uc1:ucListaCONTRATO id="ucListaCONTRATO1" VerCODISOCIO="false" PermitirVistaPrevia="true" runat="server"></uc1:ucListaCONTRATO></td>
    </tr>
    <tr>
        <td><uc1:ucVistaDetalleCONTRATO ID="ucVistaDetalleCONTRATO1" runat="server" Visible="false" ></uc1:ucVistaDetalleCONTRATO></td>
    </tr>                          
</table>
