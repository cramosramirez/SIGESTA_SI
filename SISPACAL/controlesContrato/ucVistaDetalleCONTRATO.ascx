 <%@ Control Language="VB" AutoEventWireup="false" CodeFile="ucVistaDetalleCONTRATO.ascx.vb" Inherits="controles_ucVistaDetalleCONTRATO" %>
...
<uc1:ucListaLOTES id="ucListaLOTES1" NombreGridCliente="ucListaLOTES1" PermitirEditarInline="true" TipoEdicion="0" TamanoPagina="7" PermitirEliminar="false" runat="server" 
        VerCUI="false" VerCODISOCIO="false" VerTIPO_CANA="true" VerTIPO_ROZA="true" VerTIPO_ALZA="true" VerTIPO_TRANS="true" VerEDITAR_LOTE_MAESTRO="true" VerANIOZAFRA="false" PermitirEditar="false"></uc1:ucListaLOTES>
            ...
            <dx:PopupControlContentControl ID="PopupControlContentControl1" runat="server">
                <dx:ASPxPanel ID="Panel1" runat="server" DefaultButton="btOK">
                    <PanelCollection>
                        ...
                        <hr />
                        <uc1:ucListaLOTES id="ucListaLOTES2" MostrarCheckUnaSeleccion="true" NombreGridCliente="ucListaLOTES2" 
                        ...
                        PermitirEditar="false"></uc1:ucListaLOTES>
                        <table>
                            <tr>
