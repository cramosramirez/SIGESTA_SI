...
''' -----------------------------------------------------------------------------
''' Project	 : SISPACAL
''' Class	 : ucListaSUB_ZONAS
''' 
''' -----------------------------------------------------------------------------
''' <summary>
''' Clase del Control de Usuario para mostrar un listado de la tabla SUB_ZONAS
''' </summary>
''' <remarks>
...
''' </history>
''' -----------------------------------------------------------------------------
Partial Class controlesMaestro_ucListaSUB_ZONAS
    Inherits ucListaBase

    Private mComponente As New cSUB_ZONAS
    Public Event Seleccionado(ByVal ZONA As String, ByVal SUB_ZONA As String)
    Public Event Editando(ByVal ZONA As String, ByVal SUB_ZONA As String)
...
#Region "Propiedades"
    ...
    Public Property ZONA() As String
        ...
        Set(ByVal Value As String)
            _ZONA = Value
            If Not Me.ViewState("ZONA") Is Nothing Then Me.ViewState.Remove("ZONA")
            Me.ViewState.Add("ZONA", Value)
        End Set
    End Property
    ...
    Public Property VerDESCRIP_SUB_ZONA() As Boolean
        Get
            Return Me.dxgvLista.Columns("DESCRIP_SUB_ZONA").Visible
        End Get
        Set(ByVal Value As Boolean)
            Me.dxgvLista.Columns("DESCRIP_SUB_ZONA").Visible = Value
        End Set
    End Property

    Public Property VerNO_SUB_ZONA() As Boolean
        Get
            Return Me.dxgvLista.Columns("NO_SUB_ZONA").Visible
        End Get
        Set(ByVal Value As Boolean)
            Me.dxgvLista.Columns("NO_SUB_ZONA").Visible = Value
        End Set
    End Property
    ...
    Public Property HeaderDESCRIP_SUB_ZONA() As String
        Get
            Return Me.dxgvLista.Columns("DESCRIP_SUB_ZONA").Caption
        End Get
        Set(ByVal Value As String)
            Me.dxgvLista.Columns("DESCRIP_SUB_ZONA").Caption = Value
        End Set
    End Property

    Public Property HeaderNO_SUB_ZONA() As String
        Get
            Return Me.dxgvLista.Columns("NO_SUB_ZONA").Caption
        End Get
        Set(ByVal Value As String)
            Me.dxgvLista.Columns("NO_SUB_ZONA").Caption = Value
        End Set
    End Property
...
#End Region
    ...
    Protected Sub dxgvLista_CustomJSProperties(ByVal sender As Object, ByVal e As DevExpress.Web.ASPxGridViewClientJSPropertiesEventArgs) Handles dxgvLista.CustomJSProperties
        If Me.PermitirSeleccionParaCombo Then
            ...
            For i As Integer = 0 To grid.VisibleRowCount - 1
                keyValues(i) = grid.GetRowValues(i, "SUB_ZONA")
                keyNames(i) = grid.GetRowValues(i, "DESCRIP_SUB_ZONA")
            Next i
    ...
    Protected Sub dxgvLista_RowCommand(ByVal sender As Object, ByVal e As DevExpress.Web.ASPxGridViewRowCommandEventArgs) Handles dxgvLista.RowCommand
        If e.CommandArgs.CommandName = "Select" And ComandoSeleccionar <> "Check" Then
            ...
            RaiseEvent Seleccionado(ZONA, e.CommandArgs.CommandArgument)
        End If
        If e.CommandArgs.CommandName = "Editar" Then
            RaiseEvent Editando(ZONA, e.CommandArgs.CommandArgument)
        End If
    End Sub
    ...
    Public Function DevolverSeleccionados() As listaSUB_ZONAS
        Dim mLista As New listaSUB_ZONAS
        For Each llave As Decimal In Me.dxgvLista.GetSelectedFieldValues("SUB_ZONA")
            Dim lEntidad As New SUB_ZONAS
            lEntidad.ZONA = Me.ZONA
            lEntidad.SUB_ZONA = llave
            mLista.Add(lEntidad)
        Next
        Return mLista
    End Function
    ...
    Protected Sub dxgvLista_CustomButtonCallback(ByVal sender As Object, ByVal e As DevExpress.Web.ASPxGridViewCustomButtonCallbackEventArgs) Handles dxgvLista.CustomButtonCallback
        If e.ButtonID = "btnEliminar" Then
            Dim lEntidad As SUB_ZONAS = CType(Me.dxgvLista.GetRow(e.VisibleIndex), SUB_ZONAS)

            If Me.mComponente.EliminarSUB_ZONAS(ZONA, lEntidad.SUB_ZONA) <> 1 Then
