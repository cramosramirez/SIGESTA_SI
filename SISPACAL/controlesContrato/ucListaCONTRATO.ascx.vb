...
''' </history>
''' -----------------------------------------------------------------------------
Partial Class controles_ucListaCONTRATO
...
#End Region
    ...
    Public Function DevolverSeleccionados() As listaCONTRATO
        Dim mLista As New listaCONTRATO
        For Each llave As String In Me.dxgvLista.GetSelectedFieldValues("CODICONTRATO")
            Dim lEntidad As CONTRATO = mComponente.ObtenerCONTRATO(llave)
            mLista.Add(lEntidad)
        Next
        Return mLista
    End Function
    ...
    Protected Sub dxgvLista_CustomButtonCallback(ByVal sender As Object, ByVal e As DevExpress.Web.ASPxGridViewCustomButtonCallbackEventArgs) Handles dxgvLista.CustomButtonCallback
        ...
        If e.ButtonID = "btnEditar" Then
            Dim lEntidad As CONTRATO = CType(Me.dxgvLista.GetRow(e.VisibleIndex), CONTRATO)
        ...
        If e.ButtonID = "btnEliminar" Then
            ...
            Dim lContratosZafra As listaCONTRATO_ZAFRAS = (New cCONTRATO_ZAFRAS).ObtenerListaPorCONTRATO(lEntidad.CODICONTRATO)
            If lContratosZafra IsNot Nothing AndAlso lContratosZafra.Count > 0 Then
                ...
                Next
            End If
            If Me.mComponente.EliminarCONTRATO(lEntidad.CODICONTRATO) <> 1 Then
