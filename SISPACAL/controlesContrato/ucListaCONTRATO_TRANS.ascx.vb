...
''' -----------------------------------------------------------------------------
''' Project	 : SISPACAL
''' Class	 : ucListaCONTRATO_TRANS
''' 
''' -----------------------------------------------------------------------------
''' <summary>
''' Clase del Control de Usuario para mostrar un listado de la tabla CONTRATO_TRANS
''' </summary>
''' <remarks>
...
''' </history>
''' -----------------------------------------------------------------------------
Partial Class controles_ucListaCONTRATO_TRANS
    Inherits ucListaBase
 
    Private mComponente As New cCONTRATO_TRANS
    Public Event Seleccionado(ByVal ID_CONTRA_TRANS As Int32) 
    Public Event Editando(ByVal ID_CONTRA_TRANS As Int32) 
...
#Region"Propiedades"
    ...
    Public Property VerCOD_CONTRATO() As Boolean
        Get
            Return Me.dxgvLista.Columns("COD_CONTRATO").Visible
        End Get
        Set(ByVal Value As Boolean)
            Me.dxgvLista.Columns("COD_CONTRATO").Visible = Value
        End Set
    End Property
    ...
    Public Property VerFECINI() As Boolean
        Get
            Return Me.dxgvLista.Columns("FECINI").Visible
        End Get
        Set(ByVal Value As Boolean)
            Me.dxgvLista.Columns("FECINI").Visible = Value
        End Set
    End Property

    Public Property VerFECFIN() As Boolean
        Get
            Return Me.dxgvLista.Columns("FECFIN").Visible
        End Get
        Set(ByVal Value As Boolean)
            Me.dxgvLista.Columns("FECFIN").Visible = Value
        End Set
    End Property

    Public Property VerLUGAR_CORTE() As Boolean
        Get
            Return Me.dxgvLista.Columns("LUGAR_CORTE").Visible
        End Get
        Set(ByVal Value As Boolean)
            Me.dxgvLista.Columns("LUGAR_CORTE").Visible = Value
        End Set
    End Property

    Public Property VerFECHA_CONTRA() As Boolean
        Get
            Return Me.dxgvLista.Columns("FECHA_CONTRA").Visible
        End Get
        Set(ByVal Value As Boolean)
            Me.dxgvLista.Columns("FECHA_CONTRA").Visible = Value
        End Set
    End Property
    ...
    Public Property VerNOMBRE_TRANS() As Boolean
        Get
            Return Me.dxgvLista.Columns("NOMBRE_TRANS").Visible
        End Get
        Set(ByVal Value As Boolean)
            Me.dxgvLista.Columns("NOMBRE_TRANS").Visible = Value
        End Set
    End Property

    Public Property VerNIT_TRANS() As Boolean
        Get
            Return Me.dxgvLista.Columns("NIT_TRANS").Visible
        End Get
        Set(ByVal Value As Boolean)
            Me.dxgvLista.Columns("NIT_TRANS").Visible = Value
        End Set
    End Property
    ...
    Public Property HeaderCOD_CONTRATO() As String
        Get
            Return Me.dxgvLista.Columns("COD_CONTRATO").Caption
        End Get
        Set(ByVal Value As String)
            Me.dxgvLista.Columns("COD_CONTRATO").Caption = Value
        End Set
    End Property
    ...
    Public Property HeaderFECINI() As String
        Get
            Return Me.dxgvLista.Columns("FECINI").Caption
        End Get
        Set(ByVal Value As String)
            Me.dxgvLista.Columns("FECINI").Caption = Value
        End Set
    End Property

    Public Property HeaderFECFIN() As String
        Get
            Return Me.dxgvLista.Columns("FECFIN").Caption
        End Get
        Set(ByVal Value As String)
            Me.dxgvLista.Columns("FECFIN").Caption = Value
        End Set
    End Property

    Public Property HeaderLUGAR_CORTE() As String
        Get
            Return Me.dxgvLista.Columns("LUGAR_CORTE").Caption
        End Get
        Set(ByVal Value As String)
            Me.dxgvLista.Columns("LUGAR_CORTE").Caption = Value
        End Set
    End Property

    Public Property HeaderFECHA_CONTRA() As String
        Get
            Return Me.dxgvLista.Columns("FECHA_CONTRA").Caption
        End Get
        Set(ByVal Value As String)
            Me.dxgvLista.Columns("FECHA_CONTRA").Caption = Value
        End Set
    End Property
    ...
    Public Property HeaderNOMBRE_TRANS() As String
        Get
            Return Me.dxgvLista.Columns("NOMBRE_TRANS").Caption
        End Get
        Set(ByVal Value As String)
            Me.dxgvLista.Columns("NOMBRE_TRANS").Caption = Value
        End Set
    End Property

    Public Property HeaderNIT_TRANS() As String
        Get
            Return Me.dxgvLista.Columns("NIT_TRANS").Caption
        End Get
        Set(ByVal Value As String)
            Me.dxgvLista.Columns("NIT_TRANS").Caption = Value
        End Set
    End Property
...
#End Region
    ...
    Protected Sub dxgvLista_CustomJSProperties(ByVal sender As Object, ByVal e As DevExpress.Web.ASPxGridViewClientJSPropertiesEventArgs) Handles dxgvLista.CustomJSProperties
        If Me.PermitirSeleccionParaCombo Then
            ...
            For i As Integer = 0 To grid.VisibleRowCount - 1
                keyValues(i) = grid.GetRowValues(i, "ID_CONTRA_TRANS")
                keyNames(i) = grid.GetRowValues(i, "COD_CONTRATO")
            Next i
    ...
    Public Function DevolverSeleccionados() As listaCONTRATO_TRANS
        Dim mLista As New listaCONTRATO_TRANS
        For Each llave As Decimal In Me.dxgvLista.GetSelectedFieldValues("ID_CONTRA_TRANS")
            Dim lEntidad As New CONTRATO_TRANS
            lEntidad.ID_CONTRA_TRANS = llave
            mLista.Add(lEntidad)
        Next
        Return mLista
    End Function
    ...
    Protected Sub dxgvLista_CustomButtonCallback(ByVal sender As Object, ByVal e As DevExpress.Web.ASPxGridViewCustomButtonCallbackEventArgs) Handles dxgvLista.CustomButtonCallback
        If e.ButtonID = "btnEliminar" Then
            Dim lEntidad As CONTRATO_TRANS = CType(Me.dxgvLista.GetRow(e.VisibleIndex), CONTRATO_TRANS)

            If Me.mComponente.EliminarCONTRATO_TRANS(lEntidad.ID_CONTRA_TRANS) <> 1 Then
