...
''' -----------------------------------------------------------------------------
''' Project	 : SISPACAL
''' Class	 : ucListaTARIFA_VUELO
''' 
''' -----------------------------------------------------------------------------
''' <summary>
''' Clase del Control de Usuario para mostrar un listado de la tabla TARIFA_VUELO
''' </summary>
''' <remarks>
...
''' </history>
''' -----------------------------------------------------------------------------
Partial Class controles_ucListaTARIFA_VUELO
    Inherits ucListaBase
 
    Private mComponente As New cTARIFA_VUELO
    Public Event Seleccionado(ByVal ID_TARIFA As Int32) 
    Public Event Editando(ByVal ID_TARIFA As Int32) 
...
#Region"Propiedades"
    ...
    Public Property VerID_TARIFA() As Boolean
        Get
            Return Me.dxgvLista.Columns("ID_TARIFA").Visible
        End Get
        Set(ByVal Value As Boolean)
            Me.dxgvLista.Columns("ID_TARIFA").Visible = Value
        End Set
    End Property
    ...
    Public Property VerPRECIO() As Boolean
        Get
            Return Me.dxgvLista.Columns("PRECIO").Visible
        End Get
        Set(ByVal Value As Boolean)
            Me.dxgvLista.Columns("PRECIO").Visible = Value
        End Set
    End Property

    Public Property VerOTRO_CARGO() As Boolean
        Get
            Return Me.dxgvLista.Columns("OTRO_CARGO").Visible
        End Get
        Set(ByVal Value As Boolean)
            Me.dxgvLista.Columns("OTRO_CARGO").Visible = Value
        End Set
    End Property
    ...
    Public Property HeaderID_TARIFA() As String
        Get
            Return Me.dxgvLista.Columns("ID_TARIFA").Caption
        End Get
        Set(ByVal Value As String)
            Me.dxgvLista.Columns("ID_TARIFA").Caption = Value
        End Set
    End Property
    ...
    Public Property HeaderPRECIO() As String
        Get
            Return Me.dxgvLista.Columns("PRECIO").Caption
        End Get
        Set(ByVal Value As String)
            Me.dxgvLista.Columns("PRECIO").Caption = Value
        End Set
    End Property

    Public Property HeaderOTRO_CARGO() As String
        Get
            Return Me.dxgvLista.Columns("OTRO_CARGO").Caption
        End Get
        Set(ByVal Value As String)
            Me.dxgvLista.Columns("OTRO_CARGO").Caption = Value
        End Set
    End Property
...
#End Region
    ...
    Protected Sub dxgvLista_CustomJSProperties(ByVal sender As Object, ByVal e As DevExpress.Web.ASPxGridViewClientJSPropertiesEventArgs) Handles dxgvLista.CustomJSProperties
        If Me.PermitirSeleccionParaCombo Then
            ...
            For i As Integer = 0 To grid.VisibleRowCount - 1
                keyValues(i) = grid.GetRowValues(i, "ID_TARIFA")
    ...
    Public Function DevolverSeleccionados() As listaTARIFA_VUELO
        Dim mLista As New listaTARIFA_VUELO
        For Each llave As Decimal In Me.dxgvLista.GetSelectedFieldValues("ID_TARIFA")
            Dim lEntidad As New TARIFA_VUELO
            lEntidad.ID_TARIFA = llave
            mLista.Add(lEntidad)
        Next
        Return mLista
    End Function
    ...
    Protected Sub dxgvLista_CustomButtonCallback(ByVal sender As Object, ByVal e As DevExpress.Web.ASPxGridViewCustomButtonCallbackEventArgs) Handles dxgvLista.CustomButtonCallback
        If e.ButtonID = "btnEliminar" Then
            Dim lEntidad As TARIFA_VUELO = CType(Me.dxgvLista.GetRow(e.VisibleIndex), TARIFA_VUELO)

            If Me.mComponente.EliminarTARIFA_VUELO(lEntidad.ID_TARIFA) <> 1 Then
