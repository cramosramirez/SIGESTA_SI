...
''' -----------------------------------------------------------------------------
''' Project	 : SISPACAL
''' Class	 : ucListaSOLIC_ANTICIPO
''' 
''' -----------------------------------------------------------------------------
''' <summary>
''' Clase del Control de Usuario para mostrar un listado de la tabla SOLIC_ANTICIPO
''' </summary>
''' <remarks>
...
''' </history>
''' -----------------------------------------------------------------------------
Partial Class controles_ucListaSOLIC_ANTICIPO
    Inherits ucListaBase
 
    Private mComponente As New cSOLIC_ANTICIPO
    Public Event Seleccionado(ByVal ID_ANTICIPO As Int32) 
    Public Event Editando(ByVal ID_ANTICIPO As Int32) 
...
#Region"Propiedades"
    ...
    Public Property VerNUM_ANTICIPO() As Boolean
        Get
            Return Me.dxgvLista.Columns("NUM_ANTICIPO").Visible
        End Get
        Set(ByVal Value As Boolean)
            Me.dxgvLista.Columns("NUM_ANTICIPO").Visible = Value
        End Set
    End Property
    ...
    Public Property VerTONS() As Boolean
        Get
            Return Me.dxgvLista.Columns("TONS").Visible
        End Get
        Set(ByVal Value As Boolean)
            Me.dxgvLista.Columns("TONS").Visible = Value
        End Set
    End Property

    Public Property VerUID_ANTICIPO_CONTRATO() As Boolean
        Get
            Return Me.dxgvLista.Columns("UID_ANTICIPO_CONTRATO").Visible
        End Get
        Set(ByVal Value As Boolean)
            Me.dxgvLista.Columns("UID_ANTICIPO_CONTRATO").Visible = Value
        End Set
    End Property
    ...
    Public Property HeaderNUM_ANTICIPO() As String
        Get
            Return Me.dxgvLista.Columns("NUM_ANTICIPO").Caption
        End Get
        Set(ByVal Value As String)
            Me.dxgvLista.Columns("NUM_ANTICIPO").Caption = Value
        End Set
    End Property
    ...
    Public Property HeaderTONS() As String
        Get
            Return Me.dxgvLista.Columns("TONS").Caption
        End Get
        Set(ByVal Value As String)
            Me.dxgvLista.Columns("TONS").Caption = Value
        End Set
    End Property

    Public Property HeaderUID_ANTICIPO_CONTRATO() As String
        Get
            Return Me.dxgvLista.Columns("UID_ANTICIPO_CONTRATO").Caption
        End Get
        Set(ByVal Value As String)
            Me.dxgvLista.Columns("UID_ANTICIPO_CONTRATO").Caption = Value
        End Set
    End Property
...
#End Region
    ...
    Public Function CargarDatosPoCriterios(ByVal ID_ZAFRA As Int32, _
        ...
        Me.odsListaPorCriterios.SelectParameters("NUM_ANTICIPO").DefaultValue = NUM_ANTICIPO.ToString()
    ...
    Protected Sub dxgvLista_CustomJSProperties(ByVal sender As Object, ByVal e As DevExpress.Web.ASPxGridViewClientJSPropertiesEventArgs) Handles dxgvLista.CustomJSProperties
        If Me.PermitirSeleccionParaCombo Then
            ...
            For i As Integer = 0 To grid.VisibleRowCount - 1
                keyValues(i) = grid.GetRowValues(i, "ID_ANTICIPO")
    ...
    Public Function DevolverSeleccionados() As listaSOLIC_ANTICIPO
        Dim mLista As New listaSOLIC_ANTICIPO
        For Each llave As Decimal In Me.dxgvLista.GetSelectedFieldValues("ID_ANTICIPO")
            Dim lEntidad As New SOLIC_ANTICIPO
            lEntidad.ID_ANTICIPO = llave
            mLista.Add(lEntidad)
        Next
        Return mLista
    End Function
    ...
    Protected Sub dxgvLista_CustomButtonCallback(ByVal sender As Object, ByVal e As DevExpress.Web.ASPxGridViewCustomButtonCallbackEventArgs) Handles dxgvLista.CustomButtonCallback
        If e.ButtonID = "btnEliminar" Then
            Dim lEntidad As SOLIC_ANTICIPO = CType(Me.dxgvLista.GetRow(e.VisibleIndex), SOLIC_ANTICIPO)

            If Me.mComponente.EliminarSOLIC_ANTICIPO(lEntidad.ID_ANTICIPO) <> 1 Then
    ...
    Protected Sub dxgvLista_CustomUnboundColumnData(sender As Object, e As DevExpress.Web.ASPxGridViewColumnDataEventArgs) Handles dxgvLista.CustomUnboundColumnData
        ...
        ElseIf e.Column.FieldName = "NOMBRE_PROVEEDOR" Then
            If e.GetListSourceFieldValue("CODIPROVEEDOR") IsNot Nothing Then
                ...
                End If
            End If
        ElseIf e.Column.FieldName = "INTERES" Then
            If e.GetListSourceFieldValue("PORC_INTERES") <> -1 Then
                e.Value = CDec(e.GetListSourceFieldValue("PORC_INTERES")).ToString("#,##0.00") + " %"
            Else
                e.Value = ""
            End If
        ElseIf e.Column.FieldName = "NOMBRE_CUENTA" Then
            If e.GetListSourceFieldValue("ID_CUENTA_FINAN") IsNot Nothing Then
                Dim lEntidad As CUENTA_FINAN = (New cCUENTA_FINAN).ObtenerCUENTA_FINAN(e.GetListSourceFieldValue("ID_CUENTA_FINAN"))
                If lEntidad IsNot Nothing Then
                    e.Value = lEntidad.NOMBRE_CUENTA
                End If
            End If
        End If
    End Sub
