...
''' -----------------------------------------------------------------------------
''' Project	 : SISPACAL
''' Class	 : ucListaSOLIC_ANTICIPO_ZAFRA
''' 
''' -----------------------------------------------------------------------------
''' <summary>
''' Clase del Control de Usuario para mostrar un listado de la tabla SOLIC_ANTICIPO_ZAFRA
''' </summary>
''' <remarks>
...
''' </history>
''' -----------------------------------------------------------------------------
Partial Class controles_ucListaSOLIC_ANTICIPO_ZAFRA
    Inherits ucListaBase
 
    Private mComponente As New cSOLIC_ANTICIPO_ZAFRA
    Public Event Seleccionado(ByVal ID_ANTI_ZAFRA As Int32) 
    Public Event Editando(ByVal ID_ANTI_ZAFRA As Int32)
    Public Event Eliminando(ByVal ID_ANTI_ZAFRA As Int32)
...
#Region"Propiedades"
    ...
    Public Property VerID_ANTI_ZAFRA() As Boolean
        Get
            Return Me.dxgvLista.Columns("ID_ANTI_ZAFRA").Visible
        End Get
        Set(ByVal Value As Boolean)
            Me.dxgvLista.Columns("ID_ANTI_ZAFRA").Visible = Value
        End Set
    End Property

    Public Property VerID_ANTICIPO() As Boolean
        Get
            Return Me.dxgvLista.Columns("ID_ANTICIPO").Visible
        End Get
        Set(ByVal Value As Boolean)
            Me.dxgvLista.Columns("ID_ANTICIPO").Visible = Value
        End Set
    End Property
    ...
    Public Property VerCUOTA() As Boolean
        Get
            Return Me.dxgvLista.Columns("CUOTA").Visible
        End Get
        Set(ByVal Value As Boolean)
            Me.dxgvLista.Columns("CUOTA").Visible = Value
        End Set
    End Property
    ...
    Public Property HeaderID_ANTI_ZAFRA() As String
        Get
            Return Me.dxgvLista.Columns("ID_ANTI_ZAFRA").Caption
        End Get
        Set(ByVal Value As String)
            Me.dxgvLista.Columns("ID_ANTI_ZAFRA").Caption = Value
        End Set
    End Property

    Public Property HeaderID_ANTICIPO() As String
        Get
            Return Me.dxgvLista.Columns("ID_ANTICIPO").Caption
        End Get
        Set(ByVal Value As String)
            Me.dxgvLista.Columns("ID_ANTICIPO").Caption = Value
        End Set
    End Property
    ...
    Public Property HeaderCUOTA() As String
        Get
            Return Me.dxgvLista.Columns("CUOTA").Caption
        End Get
        Set(ByVal Value As String)
            Me.dxgvLista.Columns("CUOTA").Caption = Value
        End Set
    End Property
...
#End Region
    ...
    Public Function CargarDatosCache(ByVal nombreSesion As String) As Integer
        ...
        Me.odsSOLIC_ANTICIPO_ZAFRAcache.SelectParameters("nombreSesion_ucListaSOLIC_ANTICIPO_ZAFRA").DefaultValue = nombreSesion
        Me.odsSOLIC_ANTICIPO_ZAFRAcache.DataBind()
        Me.dxgvLista.DataSourceID = "odsSOLIC_ANTICIPO_ZAFRAcache"
    ...
    ''' -----------------------------------------------------------------------------
    ''' <summary>
    ''' FunciÃ³n que Carga la informaciÃ³n de los registros de la tabla SOLIC_ANTICIPO_ZAFRA
    ''' </summary>
    ''' <remarks>
    ''' </remarks>
    ''' <history>
    ...
    ''' <summary>
    ''' FunciÃ³n que Carga la informaciÃ³n de los registros de la tabla SOLIC_ANTICIPO_ZAFRA
    ''' filtrado por la tabla SOLIC_ANTICIPO
    ''' </summary>
    ...
    ''' </history>
    ''' -----------------------------------------------------------------------------
    Public Function CargarDatosPorSOLIC_ANTICIPO(ByVal ID_ANTICIPO As Int32) As Integer
        Me.odsListaPorSOLIC_ANTICIPO.SelectParameters("ID_ANTICIPO").DefaultValue = ID_ANTICIPO.ToString()
        Me.odsListaPorSOLIC_ANTICIPO.SelectParameters("recuperarForaneas").DefaultValue = "False"
        Me.odsListaPorSOLIC_ANTICIPO.SelectParameters("asColumnaOrden").DefaultValue = ""
        Me.odsListaPorSOLIC_ANTICIPO.SelectParameters("asTipoOrden").DefaultValue = ""
        Me.odsListaPorSOLIC_ANTICIPO.DataBind()
        Me.dxgvLista.DataSourceID = "odsListaPorSOLIC_ANTICIPO"
        Me.dxgvLista.Selection.UnselectAll()
        Me.dxgvLista.Visible = True
        Me.dxgvLista.DataBind()
        Return 1
    ...
    Protected Sub dxgvLista_CustomJSProperties(ByVal sender As Object, ByVal e As DevExpress.Web.ASPxGridViewClientJSPropertiesEventArgs) Handles dxgvLista.CustomJSProperties
        If Me.PermitirSeleccionParaCombo Then
            ...
            For i As Integer = 0 To grid.VisibleRowCount - 1
                keyValues(i) = grid.GetRowValues(i, "ID_ANTI_ZAFRA")
                keyNames(i) = grid.GetRowValues(i, "ID_ANTICIPO")
            Next i
    ...
    Protected Sub dxgvLista_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles dxgvLista.Init
        ...
        End If
        dxgvLista.ForceDataRowType(GetType(listaSOLIC_ANTICIPO_ZAFRA))
    End Sub
    ...
    Public Function DevolverSeleccionados() As listaSOLIC_ANTICIPO_ZAFRA
        Dim mLista As New listaSOLIC_ANTICIPO_ZAFRA
        For Each llave As Decimal In Me.dxgvLista.GetSelectedFieldValues("ID_ANTI_ZAFRA")
            Dim lEntidad As New SOLIC_ANTICIPO_ZAFRA
            lEntidad.ID_ANTI_ZAFRA = llave
            mLista.Add(lEntidad)
        Next
        Return mLista
    End Function
    ...
    Protected Sub dxgvLista_CustomButtonCallback(ByVal sender As Object, ByVal e As DevExpress.Web.ASPxGridViewCustomButtonCallbackEventArgs) Handles dxgvLista.CustomButtonCallback
        If e.ButtonID = "btnEliminar" Then
            Dim lEntidad As SOLIC_ANTICIPO_ZAFRA = CType(Me.dxgvLista.GetRow(e.VisibleIndex), SOLIC_ANTICIPO_ZAFRA)
            Dim bSoliccache As New cSOLIC_ANTICIPO_ZAFRAcache

            If bSoliccache.Eliminar(lEntidad.ID_ANTI_ZAFRA, REFERENCIA) < 0 Then
