...
''' -----------------------------------------------------------------------------
''' Project	 : SISPACAL
''' Class	 : ucListaSOLIC_ANTICIPO_LOTE
''' 
''' -----------------------------------------------------------------------------
''' <summary>
''' Clase del Control de Usuario para mostrar un listado de la tabla SOLIC_ANTICIPO_LOTE
''' </summary>
''' <remarks>
...
''' </history>
''' -----------------------------------------------------------------------------
Partial Class controles_ucListaSOLIC_ANTICIPO_LOTE
    Inherits ucListaBase
 
    Private mComponente As New cSOLIC_ANTICIPO_LOTE
...
#End Region
    ...
    ''' -----------------------------------------------------------------------------
    ''' <summary>
    ''' FunciÃ³n que Carga la informaciÃ³n de los registros de la tabla SOLIC_ANTICIPO_LOTE
    ''' </summary>
    ''' <remarks>
    ''' </remarks>
    ''' <history>
    ...
    Public Function DevolverSeleccionados() As listaSOLIC_ANTICIPO_LOTE
        Dim mLista As New listaSOLIC_ANTICIPO_LOTE
    ...
    Protected Sub dxgvLista_CustomButtonCallback(ByVal sender As Object, ByVal e As DevExpress.Web.ASPxGridViewCustomButtonCallbackEventArgs) Handles dxgvLista.CustomButtonCallback
        If e.ButtonID = "btnEliminar" Then
            Dim lEntidad As SOLIC_ANTICIPO_LOTE = CType(Me.dxgvLista.GetRow(e.VisibleIndex), SOLIC_ANTICIPO_LOTE)

            If Me.mComponente.EliminarSOLIC_ANTICIPO_LOTE(lEntidad.ID_SOLI_LOTE) <> 1 Then
