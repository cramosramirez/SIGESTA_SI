...
''' -----------------------------------------------------------------------------
''' Project	 : SISPACAL
''' Class	 : ucListaLOTES_COSECHA
''' 
''' -----------------------------------------------------------------------------
''' <summary>
''' Clase del Control de Usuario para mostrar un listado de la tabla LOTES_COSECHA
''' </summary>
''' <remarks>
...
''' </history>
''' -----------------------------------------------------------------------------
Partial Class controles_ucListaLOTES_COSECHA
    Inherits ucListaBase

    Private mComponente As New cLOTES_COSECHA
    Public Event Seleccionado(ByVal ID_LOTES_COSECHA As Int32)
    Public Event Editando(ByVal ID_LOTES_COSECHA As Int32)
...
#Region "Propiedades"
    ...
    Public Property PermitirVistaCerrarLote() As Boolean
        Get
            If Me.ViewState("vs_colCierreLote") Is Nothing Then
                Return False
            Else
                Return Convert.ToBoolean(Me.ViewState("vs_colCierreLote"))
            End If
        End Get
        Set(ByVal Value As Boolean)
            Me.dxgvLista.Columns("colCierreLote").Visible = Value
            Me.ViewState("vs_colCierreLote") = Value
        End Set
    End Property
    ...
    Public Property PermitirOrdenar() As Boolean
        Get
            Return Me.dxgvLista.SettingsBehavior.AllowSort
        End Get
        Set(ByVal Value As Boolean)
            Me.dxgvLista.SettingsBehavior.AllowSort = Value
        End Set
    End Property
    ...
    Public Property VerID_LOTES_COSECHA() As Boolean
        Get
            Return Me.dxgvLista.Columns("ID_LOTES_COSECHA").Visible
        End Get
        Set(ByVal Value As Boolean)
            Me.dxgvLista.Columns("ID_LOTES_COSECHA").Visible = Value
        End Set
    End Property
    ...
    Public Property VerES_CONTRATADO() As Boolean
        Get
            Return Me.dxgvLista.Columns("ES_CONTRATADO").Visible
        End Get
        Set(ByVal Value As Boolean)
            Me.dxgvLista.Columns("ES_CONTRATADO").Visible = Value
        End Set
    End Property
    ...
    Public Property VerVARIEDAD() As Boolean
        Get
            Return Me.dxgvLista.Columns("VARIEDAD").Visible
        End Get
        Set(ByVal Value As Boolean)
            Me.dxgvLista.Columns("VARIEDAD").Visible = Value
        End Set
    End Property
    ...
    Public Property VerMZ_CONTRATO() As Boolean
        Get
            Return Me.dxgvLista.Columns("MZ_CONTRATO").Visible
        End Get
        Set(ByVal Value As Boolean)
            Me.dxgvLista.Columns("MZ_CONTRATO").Visible = Value
        End Set
    End Property
    Public Property VerTC_CONTRATO() As Boolean
        Get
            Return Me.dxgvLista.Columns("TC_CONTRATO").Visible
        End Get
        Set(ByVal Value As Boolean)
            Me.dxgvLista.Columns("TC_CONTRATO").Visible = Value
        End Set
    End Property
    ...
    Public Property HeaderID_LOTES_COSECHA() As String
        Get
            Return Me.dxgvLista.Columns("ID_LOTES_COSECHA").Caption
        End Get
        Set(ByVal Value As String)
            Me.dxgvLista.Columns("ID_LOTES_COSECHA").Caption = Value
        End Set
    End Property
...
#End Region
    ...
    Public Function CargarDatosPorCriterios(ByVal ID_ZAFRA As Int32,
        ...
        Me.odsListaPorCriterios.SelectParameters("USUARIO").DefaultValue = USUARIO
    ...
    Protected Sub dxgvLista_CustomJSProperties(ByVal sender As Object, ByVal e As DevExpress.Web.ASPxGridViewClientJSPropertiesEventArgs) Handles dxgvLista.CustomJSProperties
        If Me.PermitirSeleccionParaCombo Then
            ...
            For i As Integer = 0 To grid.VisibleRowCount - 1
                keyValues(i) = grid.GetRowValues(i, "ID_LOTES_COSECHA")
    ...
    Public Function DevolverSeleccionados() As listaLOTES_COSECHA
        Dim mLista As New listaLOTES_COSECHA
        For Each llave As Decimal In Me.dxgvLista.GetSelectedFieldValues("ID_LOTES_COSECHA")
            Dim lEntidad As New LOTES_COSECHA
            lEntidad.ID_LOTES_COSECHA = llave
            mLista.Add(lEntidad)
        Next
        Return mLista
    End Function
    ...
    Protected Sub dxgvLista_CustomButtonCallback(ByVal sender As Object, ByVal e As DevExpress.Web.ASPxGridViewCustomButtonCallbackEventArgs) Handles dxgvLista.CustomButtonCallback
        If e.ButtonID = "btnEliminar" Then
            Dim lEntidad As LOTES_COSECHA = CType(Me.dxgvLista.GetRow(e.VisibleIndex), LOTES_COSECHA)

            If Me.mComponente.EliminarLOTES_COSECHA(lEntidad.ID_LOTES_COSECHA) <> 1 Then
                'Si se cometio un error
                Me.AsignarMensaje("Error al Eliminar Registro", True, True)
            Else
                Me.dxgvLista.DataBind()
            End If
        ElseIf e.ButtonID = "btnCerrar" Then
            Dim bLotesCosecha As New cLOTES_COSECHA
            Dim lEntidad As LOTES_COSECHA = CType(Me.dxgvLista.GetRow(e.VisibleIndex), LOTES_COSECHA)
            lEntidad.FIN_LOTE = True
            lEntidad.FECHA_CIERRE = cFechaHora.ObtenerFechaHora
            lEntidad.USUARIO_ACT = Me.ObtenerUsuario
            bLotesCosecha.ActualizarLOTES_COSECHA(lEntidad)
            Me.dxgvLista.DataBind()
        ElseIf e.ButtonID = "btnAbrir" Then
            Dim bLotesCosecha As New cLOTES_COSECHA
            Dim lEntidad As LOTES_COSECHA = CType(Me.dxgvLista.GetRow(e.VisibleIndex), LOTES_COSECHA)
            lEntidad.FIN_LOTE = False
            lEntidad.FECHA_CIERRE = Nothing
            lEntidad.USUARIO_ACT = Me.ObtenerUsuario
            bLotesCosecha.ActualizarLOTES_COSECHA(lEntidad)
            Me.dxgvLista.DataBind()
        End If
    ...
    Protected Sub dxgvLista_CustomButtonInitialize(ByVal sender As Object, ByVal e As DevExpress.Web.ASPxGridViewCustomButtonEventArgs) Handles dxgvLista.CustomButtonInitialize
        ...
        ElseIf e.ButtonID = "btnCerrar" Then
            finLote = Convert.ToBoolean(dxgvLista.GetRowValues(e.VisibleIndex, "FIN_LOTE"))
            id = Convert.ToInt32(dxgvLista.GetRowValues(e.VisibleIndex, "ID_LOTES_COSECHA"))
            If id > 0 Then
                e.Visible = IIf(Not finLote, DevExpress.Utils.DefaultBoolean.True, DevExpress.Utils.DefaultBoolean.False)
            Else
        ...
        ElseIf e.ButtonID = "btnAbrir" Then
            ...
            id = Convert.ToInt32(dxgvLista.GetRowValues(e.VisibleIndex, "ID_LOTES_COSECHA"))
            If id > 0 Then
                e.Visible = IIf(finLote, DevExpress.Utils.DefaultBoolean.True, DevExpress.Utils.DefaultBoolean.False)
            Else
                e.Visible = DevExpress.Utils.DefaultBoolean.False
            End If
        End If
    ...
    Protected Sub dxgvLista_CustomUnboundColumnData(sender As Object, e As DevExpress.Web.ASPxGridViewColumnDataEventArgs) Handles dxgvLista.CustomUnboundColumnData
        ...
        If accesLote <> e.GetListSourceFieldValue("ACCESLOTE") Then
            ...
            If lLote IsNot Nothing Then
                ...
                codiLote = lLote.CODILOTE
                nombLote = lLote.NOMBLOTE

                lVariedad = (New cVARIEDAD).ObtenerVARIEDAD(lLote.CODIVARIEDA)
                If lVariedad IsNot Nothing Then
                    variedad_cana = lVariedad.NOM_VARIEDAD
                End If
                edad = lLote.EDAD_LOTE
                If lProveedor IsNot Nothing Then
                    codiProvee = CInt(lProveedor.CODIPROVEE).ToString
                    If lProveedor.CODISOCIO <> Utilerias.FormatoCODISOCIO(0) Then codiSocio = CInt(lProveedor.CODISOCIO).ToString
                    nombreProveedor = lProveedor.NOMBRES + " " + lProveedor.APELLIDOS
                End If


                lContratoZafra = (New cCONTRATO_ZAFRAS).ObtenerCONTRATO_ZAFRASPorZAFRA_LOTE(e.GetListSourceFieldValue("ID_ZAFRA"), accesLote)
                If lContratoZafra IsNot Nothing Then esContratado = True Else esContratado = False

                If esContratado Then
                ...
                Else
                    listamadurante = Nothing
                    area_contratada = 0
                    tonel_contratada = 0
                End If
                zona = lLote.ZONA
                lTipo = (New cTIPOS_GENERALES).ObtenerTIPOS_GENERALES(e.GetListSourceFieldValue("ID_TIPO_ROZA"))
                If lTipo IsNot Nothing Then
                    tipoRoza = lTipo.NOM_TIPO
                Else
                    tipoRoza = ""
                End If
                lTipo = (New cTIPOS_GENERALES).ObtenerTIPOS_GENERALES(e.GetListSourceFieldValue("ID_TIPO_TRANS"))
                If lTipo IsNot Nothing Then
                    tipoTransporte = lTipo.NOM_TIPO
                Else
                    tipoTransporte = ""
                End If
            End If
        ...
        ElseIf e.Column.FieldName = "VARIEDAD" Then
            e.Value = variedad_cana
        ElseIf e.Column.FieldName = "CICLO" Then
            e.Value = edad
        ...
        ElseIf e.Column.FieldName = "ES_CONTRATADO" Then
            e.Value = esContratado
        ElseIf e.Column.FieldName = "TIPO_ROZA" Then
            e.Value = tipoRoza
        ElseIf e.Column.FieldName = "TIPO_TRANSPORTE" Then
            e.Value = tipoTransporte
    ...
    Private Sub dxgvLista_HtmlRowPrepared(sender As Object, e As ASPxGridViewTableRowEventArgs) Handles dxgvLista.HtmlRowPrepared
        If e.RowType <> GridViewRowType.Data Then
            Return
        End If
        Dim id_lotes_cosecha As Integer = Convert.ToInt32(e.GetValue("ID_LOTES_COSECHA"))
        If id_lotes_cosecha < 0 Then
            e.Row.BackColor = System.Drawing.Color.LightBlue
            e.Row.Font.Bold = True
        End If
    End Sub

    Private Sub dxgvLista_HtmlDataCellPrepared(sender As Object, e As ASPxGridViewTableDataCellEventArgs) Handles dxgvLista.HtmlDataCellPrepared
        'If e.DataColumn.Name = "colVistaCierreLote" Then
        '    Dim lnkCerrar As LinkButton = Me.dxgvLista.FindRowCellTemplateControl(e.VisibleIndex, e.DataColumn, "lbtnCierreLote")
        '    Dim lnkAbrir As LinkButton = Me.dxgvLista.FindRowCellTemplateControl(e.VisibleIndex, e.DataColumn, "lbtnAbrirLote")

        '    If Convert.ToInt32(e.GetValue("ID_LOTES_COSECHA")) > 0 Then
        '        If Convert.ToBoolean(e.GetValue("FIN_LOTE")) Then
        '            lnkCerrar.Visible = False
        '            lnkAbrir.Visible = True
        '        Else
    ...
    Private Sub dxgvLista_CommandButtonInitialize(sender As Object, e As ASPxGridViewCommandButtonEventArgs) Handles dxgvLista.CommandButtonInitialize
        If e.ButtonType = ColumnCommandButtonType.Edit Then
            Dim finlote As Boolean = dxgvLista.GetRowValues(e.VisibleIndex, "FIN_LOTE")
            Dim id As String = dxgvLista.GetRowValues(e.VisibleIndex, "ID_LOTES_COSECHA")
            e.Visible = Not finlote AndAlso id > 0
        End If
    End Sub

    Private Sub dxgvLista_StartRowEditing(sender As Object, e As ASPxStartRowEditingEventArgs) Handles dxgvLista.StartRowEditing
        dxgvLista.Columns("colCierreLote").Visible = False
    End Sub

    Private Sub dxgvLista_RowUpdating(sender As Object, e As ASPxDataUpdatingEventArgs) Handles dxgvLista.RowUpdating
        dxgvLista.Columns("colCierreLote").Visible = Me.PermitirVistaCerrarLote
    End Sub

    Private Sub dxgvLista_CancelRowEditing(sender As Object, e As ASPxStartRowEditingEventArgs) Handles dxgvLista.CancelRowEditing
        dxgvLista.Columns("colCierreLote").Visible = Me.PermitirVistaCerrarLote
    End Sub
End Class
