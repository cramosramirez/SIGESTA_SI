...
''' -----------------------------------------------------------------------------
''' Project	 : SISPACAL
''' Class	 : ucListaCONTROL_ENTREGA_LOTE
''' 
''' -----------------------------------------------------------------------------
''' <summary>
''' Clase del Control de Usuario para mostrar un listado de la tabla CONTROL_ENTREGA_LOTE
''' </summary>
''' <remarks>
...
''' </history>
''' -----------------------------------------------------------------------------
Partial Class controles_ucListaCONTROL_ENTREGA_LOTE
    Inherits ucListaBase
 
    Private mComponente As New cCONTROL_ENTREGA_LOTE
    Public Event Seleccionado(ByVal ID_CTRL_ENTREGA_LOTE As Int32) 
    Public Event Editando(ByVal ID_CTRL_ENTREGA_LOTE As Int32) 
...
#Region"Propiedades"
    ...
    Public Property VerID_CTRL_ENTREGA_LOTE() As Boolean
        Get
            Return Me.dxgvLista.Columns("ID_CTRL_ENTREGA_LOTE").Visible
        End Get
        Set(ByVal Value As Boolean)
            Me.dxgvLista.Columns("ID_CTRL_ENTREGA_LOTE").Visible = Value
        End Set
    End Property
    ...
    Public Property VerINICIAL() As Boolean
        Get
            Return Me.dxgvLista.Columns("INICIAL").Visible
        End Get
        Set(ByVal Value As Boolean)
            Me.dxgvLista.Columns("INICIAL").Visible = Value
        End Set
    End Property
    ...
    Public Property HeaderID_CTRL_ENTREGA_LOTE() As String
        Get
            Return Me.dxgvLista.Columns("ID_CTRL_ENTREGA_LOTE").Caption
        End Get
        Set(ByVal Value As String)
            Me.dxgvLista.Columns("ID_CTRL_ENTREGA_LOTE").Caption = Value
        End Set
    End Property
    ...
    Public Property HeaderINICIAL() As String
        Get
            Return Me.dxgvLista.Columns("INICIAL").Caption
        End Get
        Set(ByVal Value As String)
            Me.dxgvLista.Columns("INICIAL").Caption = Value
        End Set
    End Property
...
#End Region
    ...
    ''' -----------------------------------------------------------------------------
    ''' <summary>
    ''' FunciÃ³n que Carga la informaciÃ³n de los registros de la tabla CONTROL_ENTREGA_LOTE
    ''' </summary>
    ''' <remarks>
    ''' </remarks>
    ''' <history>
    ...
    Protected Sub dxgvLista_CustomJSProperties(ByVal sender As Object, ByVal e As DevExpress.Web.ASPxGridViewClientJSPropertiesEventArgs) Handles dxgvLista.CustomJSProperties
        If Me.PermitirSeleccionParaCombo Then
            ...
            For i As Integer = 0 To grid.VisibleRowCount - 1
                keyValues(i) = grid.GetRowValues(i, "ID_CTRL_ENTREGA_LOTE")
    ...
    Public Function DevolverSeleccionados() As listaCONTROL_ENTREGA_LOTE
        Dim mLista As New listaCONTROL_ENTREGA_LOTE
        For Each llave As Decimal In Me.dxgvLista.GetSelectedFieldValues("ID_CTRL_ENTREGA_LOTE")
            Dim lEntidad As New CONTROL_ENTREGA_LOTE
            lEntidad.ID_CTRL_ENTREGA_LOTE = llave
            mLista.Add(lEntidad)
        Next
        Return mLista
    End Function
    ...
    Protected Sub dxgvLista_CustomButtonCallback(ByVal sender As Object, ByVal e As DevExpress.Web.ASPxGridViewCustomButtonCallbackEventArgs) Handles dxgvLista.CustomButtonCallback
        If e.ButtonID = "btnEliminar" Then
            Dim lEntidad As CONTROL_ENTREGA_LOTE = CType(Me.dxgvLista.GetRow(e.VisibleIndex), CONTROL_ENTREGA_LOTE)

            If Me.mComponente.EliminarCONTROL_ENTREGA_LOTE(lEntidad.ID_CTRL_ENTREGA_LOTE) <> 1 Then
