...
''' -----------------------------------------------------------------------------
''' Project	 : SISPACAL
''' Class	 : ucVistaDetalleLABFAB_ETAPA
''' 
''' -----------------------------------------------------------------------------
''' <summary>
''' Clase del Control de Usuario para mostrar en tiempo de edicion un registro
''' de la tabla LABFAB_ETAPA
''' </summary>
''' <remarks>
...
''' </history>
''' -----------------------------------------------------------------------------
Partial Class controles_ucVistaDetalleLABFAB_ETAPA
    Inherits ucBase
...
#Region"Propiedades"
    ...
    Public Property ID_ETAPA() As Int32
        Get
            Return Me.txtID_ETAPA.Text
        End Get
        Set(ByVal Value As Int32)
            Me._ID_ETAPA = Value
            Me.txtID_ETAPA.Text = CStr(Value)
            If Me._ID_ETAPA > 0 Then
                Me.CargarDatos()
            Else
                Me.LimpiarControles()
                Me.Nuevo()
    ...
    Public Property NOMBRE_ETAPA() As String
        Get
            Return Me.txtNOMBRE_ETAPA.Text
        End Get
        Set(ByVal value As String)
            Me.txtNOMBRE_ETAPA.Text = value.ToString()
        End Set
    End Property
    ...
    Public Property VerID_ETAPA() As Boolean
        Get
            Return Me.trID_ETAPA.Visible
        End Get
        Set(ByVal value As Boolean)
            Me.trID_ETAPA.Visible = value
        End Set
    End Property
    ...
    Private mEntidad As LABFAB_ETAPA
...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If Not Me.ViewState("ID_ETAPA") Is Nothing Then Me._ID_ETAPA = Me.ViewState("ID_ETAPA")

    End Sub

    ''' -----------------------------------------------------------------------------
    ''' <summary>
    ''' FunciÃ³n que Carga la informaciÃ³n del registro de la tabla LABFAB_ETAPA
    ''' </summary>
    ''' <remarks>
    ''' </remarks>
    ''' <history>
    ...
    Private Sub CargarDatos()
        ...
        mEntidad = New LABFAB_ETAPA
        mEntidad.ID_ETAPA = ID_ETAPA
 
        If mComponente.ObtenerLABFAB_ETAPA(mEntidad) <> 1 Then
            RaiseEvent ErrorEvent("Error al obtener Registro.")
            Return
        End If
        Me.txtID_ETAPA.Text = mEntidad.ID_ETAPA.ToString()
    ...
    ''' -----------------------------------------------------------------------------
    ''' <summary>
    ''' FunciÃ³n que Guarda la informaciÃ³n del registro en la tabla LABFAB_ETAPA
    ''' </summary>
    ''' <returns>
    ''' ""                              : Si no existe error
    ...
    Public Function Actualizar() As String
        ...
        Else
            mEntidad = mComponente.ObtenerLABFAB_ETAPA(CInt(Me.txtID_ETAPA.Text))
            mEntidad.USUARIO_ACT = Me.ObtenerUsuario
            mEntidad.FECHA_ACT = cFechaHora.ObtenerFechaHora
        End If
        mEntidad.NOMBRE_ETAPA = Me.txtNOMBRE_ETAPA.Text.ToUpper
        

        If mComponente.ActualizarLABFAB_ETAPA(mEntidad) <> 1 Then
