...
''' -----------------------------------------------------------------------------
''' Project	 : SISPACAL
''' Class	 : ucListaLABFAB_ETAPA
''' 
''' -----------------------------------------------------------------------------
''' <summary>
''' Clase del Control de Usuario para mostrar un listado de la tabla LABFAB_ETAPA
''' </summary>
''' <remarks>
...
''' </history>
''' -----------------------------------------------------------------------------
Partial Class controles_ucListaLABFAB_ETAPA
    Inherits ucListaBase
 
    Private mComponente As New cLABFAB_ETAPA
    Public Event Seleccionado(ByVal ID_ETAPA As Int32) 
    Public Event Editando(ByVal ID_ETAPA As Int32) 
...
#Region"Propiedades"
    ...
    Public Property VerNOMBRE_ETAPA() As Boolean
        Get
            Return Me.dxgvLista.Columns("NOMBRE_ETAPA").Visible
        End Get
        Set(ByVal Value As Boolean)
            Me.dxgvLista.Columns("NOMBRE_ETAPA").Visible = Value
        End Set
    End Property
    ...
    Public Property HeaderNOMBRE_ETAPA() As String
        Get
            Return Me.dxgvLista.Columns("NOMBRE_ETAPA").Caption
        End Get
        Set(ByVal Value As String)
            Me.dxgvLista.Columns("NOMBRE_ETAPA").Caption = Value
        End Set
    End Property
...
#End Region
    ...
    ''' -----------------------------------------------------------------------------
    ''' <summary>
    ''' FunciÃ³n que Carga la informaciÃ³n de los registros de la tabla LABFAB_ETAPA
    ''' </summary>
    ''' <remarks>
    ''' </remarks>
    ''' <history>
    ...
    Protected Sub dxgvLista_CustomJSProperties(ByVal sender As Object, ByVal e As DevExpress.Web.ASPxGridViewClientJSPropertiesEventArgs) Handles dxgvLista.CustomJSProperties
        If Me.PermitirSeleccionParaCombo Then
            ...
            For i As Integer = 0 To grid.VisibleRowCount - 1
                keyValues(i) = grid.GetRowValues(i, "ID_ETAPA")
                keyNames(i) = grid.GetRowValues(i, "NOMBRE_ETAPA")
            Next i
    ...
    Public Function DevolverSeleccionados() As listaLABFAB_ETAPA
        Dim mLista As New listaLABFAB_ETAPA
        For Each llave As Decimal In Me.dxgvLista.GetSelectedFieldValues("ID_ETAPA")
            Dim lEntidad As New LABFAB_ETAPA
            lEntidad.ID_ETAPA = llave
            mLista.Add(lEntidad)
        Next
        Return mLista
    End Function
    ...
    Protected Sub dxgvLista_CustomButtonCallback(ByVal sender As Object, ByVal e As DevExpress.Web.ASPxGridViewCustomButtonCallbackEventArgs) Handles dxgvLista.CustomButtonCallback
        If e.ButtonID = "btnEliminar" Then
            Dim lEntidad As LABFAB_ETAPA = CType(Me.dxgvLista.GetRow(e.VisibleIndex), LABFAB_ETAPA)

            If Me.mComponente.EliminarLABFAB_ETAPA(lEntidad.ID_ETAPA) <> 1 Then
