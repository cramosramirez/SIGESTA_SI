...
''' -----------------------------------------------------------------------------
''' Project	 : SISPACAL
''' Class	 : ucListaLABFAB_ANALISISXDIA
''' 
''' -----------------------------------------------------------------------------
''' <summary>
''' Clase del Control de Usuario para mostrar un listado de la tabla LABFAB_ANALISISXDIA
''' </summary>
''' <remarks>
...
''' </history>
''' -----------------------------------------------------------------------------
Partial Class controles_ucListaLABFAB_ANALISISXDIA
    Inherits ucListaBase
 
    Private mComponente As New cLABFAB_ANALISISXDIA
    Public Event Seleccionado(ByVal ID_ANALISISXDIA As Int32) 
    Public Event Editando(ByVal ID_ANALISISXDIA As Int32) 
...
#End Region
    ...
    Public Function CargarDatosPorLABFAB_DIAZAFRA(ByVal ID_DIAZAFRA As Int32) As Integer
        ...
        Me.odsListaPorLABFAB_DIAZAFRA.SelectParameters("recuperarHijas").DefaultValue = "False"
    ...
    Public Function CargarDatosPorLABFAB_ANALISIS(ByVal ID_ANALISIS As Int32) As Integer
        ...
        Me.odsListaPorLABFAB_ANALISIS.SelectParameters("recuperarHijas").DefaultValue = "False"
    ...
    Protected Sub dxgvLista_CustomJSProperties(ByVal sender As Object, ByVal e As DevExpress.Web.ASPxGridViewClientJSPropertiesEventArgs) Handles dxgvLista.CustomJSProperties
        If Me.PermitirSeleccionParaCombo Then
            ...
            For i As Integer = 0 To grid.VisibleRowCount - 1
                keyValues(i) = grid.GetRowValues(i, "ID_ANALISISXDIA")
                keyNames(i) = grid.GetRowValues(i, "ID_DIAZAFRA")
            Next i
    ...
    Public Function DevolverSeleccionados() As listaLABFAB_ANALISISXDIA
        Dim mLista As New listaLABFAB_ANALISISXDIA
        For Each llave As Decimal In Me.dxgvLista.GetSelectedFieldValues("ID_ANALISISXDIA")
            Dim lEntidad As New LABFAB_ANALISISXDIA
            lEntidad.ID_ANALISISXDIA = llave
            mLista.Add(lEntidad)
        Next
        Return mLista
    End Function
    ...
    Protected Sub dxgvLista_CustomButtonCallback(ByVal sender As Object, ByVal e As DevExpress.Web.ASPxGridViewCustomButtonCallbackEventArgs) Handles dxgvLista.CustomButtonCallback
        If e.ButtonID = "btnEliminar" Then
            Dim lEntidad As LABFAB_ANALISISXDIA = CType(Me.dxgvLista.GetRow(e.VisibleIndex), LABFAB_ANALISISXDIA)

            If Me.mComponente.EliminarLABFAB_ANALISISXDIA(lEntidad.ID_ANALISISXDIA) <> 1 Then
    ...
    Protected Sub dxgvLista_CustomUnboundColumnData(sender As Object, e As DevExpress.Web.ASPxGridViewColumnDataEventArgs) Handles dxgvLista.CustomUnboundColumnData
        ...
        ElseIf e.Column.FieldName = "ID_ETAPA" Then
            Dim lEntidad As LABFAB_ANALISIS = (New cLABFAB_ANALISIS).ObtenerLABFAB_ANALISIS(e.GetListSourceFieldValue("ID_ANALISIS"))
            If lEntidad IsNot Nothing Then
                Dim lMuestra As LABFAB_MUESTRA = (New cLABFAB_MUESTRA).ObtenerLABFAB_MUESTRA(lEntidad.ID_MUESTRA)
                If lMuestra IsNot Nothing Then e.Value = lMuestra.ID_ETAPA
            End If
        ElseIf e.Column.FieldName = "NOMBRE_ETAPA" Then
            ...
            If lEntidad IsNot Nothing Then
                ...
                End If
            End If
        ElseIf e.Column.FieldName = "ID_MUESTRA" Then
            Dim lEntidad As LABFAB_ANALISIS = (New cLABFAB_ANALISIS).ObtenerLABFAB_ANALISIS(e.GetListSourceFieldValue("ID_ANALISIS"))
            If lEntidad IsNot Nothing Then e.Value = lEntidad.ID_MUESTRA
        ElseIf e.Column.FieldName = "NOMBRE_MUESTRA" Then
            Dim lEntidad As LABFAB_ANALISIS = (New cLABFAB_ANALISIS).ObtenerLABFAB_ANALISIS(e.GetListSourceFieldValue("ID_ANALISIS"))
            If lEntidad IsNot Nothing Then
                Dim lMuestra As LABFAB_MUESTRA = (New cLABFAB_MUESTRA).ObtenerLABFAB_MUESTRA(lEntidad.ID_MUESTRA)
                If lMuestra IsNot Nothing Then e.Value = lMuestra.NOMBRE_MUESTRA
            End If
        ElseIf e.Column.FieldName = "NOMBRE_ANALISIS" Then
            Dim lEntidad As LABFAB_ANALISIS = (New cLABFAB_ANALISIS).ObtenerLABFAB_ANALISIS(e.GetListSourceFieldValue("ID_ANALISIS"))
            If lEntidad IsNot Nothing Then e.Value = lEntidad.NOMBRE_ANALISIS
        End If
    End Sub
End Class
