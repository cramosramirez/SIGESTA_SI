...
''' -----------------------------------------------------------------------------
''' Project	 : SISPACAL
''' Class	 : ucListaLABFAB_ANALISIS
''' 
''' -----------------------------------------------------------------------------
''' <summary>
''' Clase del Control de Usuario para mostrar un listado de la tabla LABFAB_ANALISIS
''' </summary>
''' <remarks>
...
''' </history>
''' -----------------------------------------------------------------------------
Partial Class controles_ucListaLABFAB_ANALISIS
...
#Region"Propiedades"
    ...
    Public Property PermitirNuevoAnalisis() As Boolean
        Get
            Return Me.dxgvLista.Columns("colNuevoAnalisis").Visible
        End Get
        Set(ByVal Value As Boolean)
            Me.dxgvLista.Columns("colNuevoAnalisis").Visible = Value
        End Set
    End Property
    ...
    Public Property VerID_MUESTRA() As Boolean
        Get
            Return Me.dxgvLista.Columns("ID_MUESTRA").Visible
        End Get
        Set(ByVal Value As Boolean)
            Me.dxgvLista.Columns("ID_MUESTRA").Visible = Value
        End Set
    End Property

    Public Property VerNOMBRE_ANALISIS() As Boolean
        Get
            Return Me.dxgvLista.Columns("NOMBRE_ANALISIS").Visible
        End Get
        Set(ByVal Value As Boolean)
            Me.dxgvLista.Columns("NOMBRE_ANALISIS").Visible = Value
        End Set
    End Property

    Public Property VerFORMULA() As Boolean
        Get
            Return Me.dxgvLista.Columns("FORMULA").Visible
        End Get
        Set(ByVal Value As Boolean)
            Me.dxgvLista.Columns("FORMULA").Visible = Value
        End Set
    End Property
    ...
    Public Property VerCANT_ANALISIS() As Boolean
        Get
            Return Me.dxgvLista.Columns("CANT_ANALISIS").Visible
        End Get
        Set(ByVal Value As Boolean)
            Me.dxgvLista.Columns("CANT_ANALISIS").Visible = Value
        End Set
    End Property
    ...
    Public Property HeaderID_MUESTRA() As String
        Get
            Return Me.dxgvLista.Columns("ID_MUESTRA").Caption
        End Get
        Set(ByVal Value As String)
            Me.dxgvLista.Columns("ID_MUESTRA").Caption = Value
        End Set
    End Property

    Public Property HeaderNOMBRE_ANALISIS() As String
        Get
            Return Me.dxgvLista.Columns("NOMBRE_ANALISIS").Caption
        End Get
        Set(ByVal Value As String)
            Me.dxgvLista.Columns("NOMBRE_ANALISIS").Caption = Value
        End Set
    End Property

    Public Property HeaderFORMULA() As String
        Get
            Return Me.dxgvLista.Columns("FORMULA").Caption
        End Get
        Set(ByVal Value As String)
            Me.dxgvLista.Columns("FORMULA").Caption = Value
        End Set
    End Property
    ...
    Public Property HeaderCANT_ANALISIS() As String
        Get
            Return Me.dxgvLista.Columns("CANT_ANALISIS").Caption
        End Get
        Set(ByVal Value As String)
            Me.dxgvLista.Columns("CANT_ANALISIS").Caption = Value
        End Set
    End Property
...
#End Region
    ...
    ''' <summary>
    ''' FunciÃ³n que Carga la informaciÃ³n de los registros de la tabla LABFAB_ANALISIS
    ''' filtrado por la tabla LABFAB_MUESTRA
    ''' </summary>
    ...
    ''' </history>
    ''' -----------------------------------------------------------------------------
    Public Function CargarDatosPorLABFAB_MUESTRA(ByVal ID_MUESTRA As Int32) As Integer
        Me.odsListaPorLABFAB_MUESTRA.SelectParameters("ID_MUESTRA").DefaultValue = ID_MUESTRA.ToString()
        Me.odsListaPorLABFAB_MUESTRA.SelectParameters("recuperarHijas").DefaultValue = "False"
        Me.odsListaPorLABFAB_MUESTRA.SelectParameters("recuperarForaneas").DefaultValue = "False"
        Me.odsListaPorLABFAB_MUESTRA.SelectParameters("asColumnaOrden").DefaultValue = ""
        Me.odsListaPorLABFAB_MUESTRA.SelectParameters("asTipoOrden").DefaultValue = ""
        Me.odsListaPorLABFAB_MUESTRA.DataBind()
        Me.dxgvLista.DataSourceID = "odsListaPorLABFAB_MUESTRA"
        Me.dxgvLista.Selection.UnselectAll()
        Me.dxgvLista.Visible = True
        Me.dxgvLista.DataBind()
        Return 1
    ...
    Protected Sub dxgvLista_CustomJSProperties(ByVal sender As Object, ByVal e As DevExpress.Web.ASPxGridViewClientJSPropertiesEventArgs) Handles dxgvLista.CustomJSProperties
        If Me.PermitirSeleccionParaCombo Then
            ...
            For i As Integer = 0 To grid.VisibleRowCount - 1
                keyValues(i) = grid.GetRowValues(i, "ID_ANALISIS")
                keyNames(i) = grid.GetRowValues(i, "ID_MUESTRA")
            Next i
    ...
    Public Function DevolverSeleccionados() As listaLABFAB_ANALISIS
        Dim mLista As New listaLABFAB_ANALISIS
        For Each llave As Decimal In Me.dxgvLista.GetSelectedFieldValues("ID_ANALISIS")
            Dim lEntidad As New LABFAB_ANALISIS
            lEntidad.ID_ANALISIS = llave
            mLista.Add(lEntidad)
        Next
        Return mLista
    End Function
    ...
    Protected Sub dxgvLista_CustomButtonCallback(ByVal sender As Object, ByVal e As DevExpress.Web.ASPxGridViewCustomButtonCallbackEventArgs) Handles dxgvLista.CustomButtonCallback
        If e.ButtonID = "btnEliminar" Then
            Dim lEntidad As LABFAB_ANALISIS = CType(Me.dxgvLista.GetRow(e.VisibleIndex), LABFAB_ANALISIS)

            If Me.mComponente.EliminarLABFAB_ANALISIS(lEntidad.ID_ANALISIS) <> 1 Then
    ...
    Protected Sub dxgvLista_CustomUnboundColumnData(sender As Object, e As DevExpress.Web.ASPxGridViewColumnDataEventArgs) Handles dxgvLista.CustomUnboundColumnData
        If e.Column.FieldName = "ID_ETAPA" Then
            Dim lEntidad As LABFAB_MUESTRA = (New cLABFAB_MUESTRA).ObtenerLABFAB_MUESTRA(e.GetListSourceFieldValue("ID_MUESTRA"))
            If lEntidad IsNot Nothing Then e.Value = lEntidad.ID_ETAPA
        ElseIf e.Column.FieldName = "NOMBRE_ETAPA" Then
            Dim lEntidad As LABFAB_MUESTRA = (New cLABFAB_MUESTRA).ObtenerLABFAB_MUESTRA(e.GetListSourceFieldValue("ID_MUESTRA"))
            If lEntidad IsNot Nothing Then
                Dim lEtapa As LABFAB_ETAPA = (New cLABFAB_ETAPA).ObtenerLABFAB_ETAPA(lEntidad.ID_ETAPA)
                If lEtapa IsNot Nothing Then e.Value = lEtapa.NOMBRE_ETAPA
            End If
        ElseIf e.Column.FieldName = "NOMBRE_MUESTRA" Then
            Dim lEntidad As LABFAB_MUESTRA = (New cLABFAB_MUESTRA).ObtenerLABFAB_MUESTRA(e.GetListSourceFieldValue("ID_MUESTRA"))
            If lEntidad IsNot Nothing Then e.Value = lEntidad.NOMBRE_MUESTRA
        End If
    End Sub
End Class
