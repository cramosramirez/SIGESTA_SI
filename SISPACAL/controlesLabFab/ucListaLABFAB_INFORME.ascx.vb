...
''' -----------------------------------------------------------------------------
''' Project	 : SISPACAL
''' Class	 : ucListaLABFAB_INFORME
''' 
''' -----------------------------------------------------------------------------
''' <summary>
''' Clase del Control de Usuario para mostrar un listado de la tabla LABFAB_INFORME
''' </summary>
''' <remarks>
...
''' </history>
''' -----------------------------------------------------------------------------
Partial Class controles_ucListaLABFAB_INFORME
    Inherits ucListaBase
 
    Private mComponente As New cLABFAB_INFORME
    Public Event Seleccionado(ByVal ID_INFO As Int32) 
    Public Event Editando(ByVal ID_INFO As Int32) 
...
#Region"Propiedades"
    ...
    Public Property VerNOMBRE_INFO() As Boolean
        Get
            Return Me.dxgvLista.Columns("NOMBRE_INFO").Visible
        End Get
        Set(ByVal Value As Boolean)
            Me.dxgvLista.Columns("NOMBRE_INFO").Visible = Value
        End Set
    End Property
    ...
    Public Property HeaderNOMBRE_INFO() As String
        Get
            Return Me.dxgvLista.Columns("NOMBRE_INFO").Caption
        End Get
        Set(ByVal Value As String)
            Me.dxgvLista.Columns("NOMBRE_INFO").Caption = Value
        End Set
    End Property
...
#End Region
    ...
    ''' -----------------------------------------------------------------------------
    ''' <summary>
    ''' FunciÃ³n que Carga la informaciÃ³n de los registros de la tabla LABFAB_INFORME
    ''' </summary>
    ''' <remarks>
    ''' </remarks>
    ''' <history>
    ...
    Protected Sub dxgvLista_CustomJSProperties(ByVal sender As Object, ByVal e As DevExpress.Web.ASPxGridViewClientJSPropertiesEventArgs) Handles dxgvLista.CustomJSProperties
        If Me.PermitirSeleccionParaCombo Then
            ...
            For i As Integer = 0 To grid.VisibleRowCount - 1
                keyValues(i) = grid.GetRowValues(i, "ID_INFO")
                keyNames(i) = grid.GetRowValues(i, "NOMBRE_INFO")
            Next i
    ...
    Public Function DevolverSeleccionados() As listaLABFAB_INFORME
        Dim mLista As New listaLABFAB_INFORME
        For Each llave As Decimal In Me.dxgvLista.GetSelectedFieldValues("ID_INFO")
            Dim lEntidad As New LABFAB_INFORME
            lEntidad.ID_INFO = llave
            mLista.Add(lEntidad)
        Next
        Return mLista
    End Function
    ...
    Protected Sub dxgvLista_CustomButtonCallback(ByVal sender As Object, ByVal e As DevExpress.Web.ASPxGridViewCustomButtonCallbackEventArgs) Handles dxgvLista.CustomButtonCallback
        If e.ButtonID = "btnEliminar" Then
            Dim lEntidad As LABFAB_INFORME = CType(Me.dxgvLista.GetRow(e.VisibleIndex), LABFAB_INFORME)

            If Me.mComponente.EliminarLABFAB_INFORME(lEntidad.ID_INFO) <> 1 Then
