...
''' -----------------------------------------------------------------------------
''' Project	 : SISPACAL
''' Class	 : ucListaPERIODOREQ
''' 
''' -----------------------------------------------------------------------------
''' <summary>
''' Clase del Control de Usuario para mostrar un listado de la tabla PERIODOREQ
''' </summary>
''' <remarks>
...
#Region"Propiedades"
    ...
    Public Property VerDESCRIP_PERIODO() As Boolean
        Get
            Return Me.dxgvLista.Columns("DESCRIP_PERIODO").Visible
        End Get
        Set(ByVal Value As Boolean)
            Me.dxgvLista.Columns("DESCRIP_PERIODO").Visible = Value
        End Set
    End Property
    ...
    Public Property HeaderDESCRIP_PERIODO() As String
        Get
            Return Me.dxgvLista.Columns("DESCRIP_PERIODO").Caption
        End Get
        Set(ByVal Value As String)
            Me.dxgvLista.Columns("DESCRIP_PERIODO").Caption = Value
        End Set
    End Property
...
#End Region
    ...
    Protected Sub dxgvLista_CustomJSProperties(ByVal sender As Object, ByVal e As DevExpress.Web.ASPxGridViewClientJSPropertiesEventArgs) Handles dxgvLista.CustomJSProperties
        If Me.PermitirSeleccionParaCombo Then
            ...
            For i As Integer = 0 To grid.VisibleRowCount - 1
                keyValues(i) = grid.GetRowValues(i, "ID_PERIODOREQ")
                keyNames(i) = grid.GetRowValues(i, "DESCRIP_PERIODO")
            Next i
    ...
    Public Function DevolverSeleccionados() As listaPERIODOREQ
        Dim mLista As New listaPERIODOREQ
        For Each llave As Decimal In Me.dxgvLista.GetSelectedFieldValues("ID_PERIODOREQ")
            Dim lEntidad As New PERIODOREQ
            lEntidad.ID_PERIODOREQ = llave
            mLista.Add(lEntidad)
        Next
        Return mLista
    End Function
    ...
    Protected Sub dxgvLista_CustomButtonCallback(ByVal sender As Object, ByVal e As DevExpress.Web.ASPxGridViewCustomButtonCallbackEventArgs) Handles dxgvLista.CustomButtonCallback
        If e.ButtonID = "btnEliminar" Then
            Dim lEntidad As PERIODOREQ = CType(Me.dxgvLista.GetRow(e.VisibleIndex), PERIODOREQ)

            If Me.mComponente.EliminarPERIODOREQ(lEntidad.ID_PERIODOREQ) <> 1 Then
