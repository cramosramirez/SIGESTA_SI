...
''' -----------------------------------------------------------------------------
''' Project	 : SISPACAL
''' Class	 : ucListaSOLICITANTE
''' 
''' -----------------------------------------------------------------------------
''' <summary>
''' Clase del Control de Usuario para mostrar un listado de la tabla SOLICITANTE
''' </summary>
''' <remarks>
...
''' </history>
''' -----------------------------------------------------------------------------
Partial Class controles_ucListaSOLICITANTE
    Inherits ucListaBase
 
    Private mComponente As New cSOLICITANTE
    Public Event Seleccionado(ByVal ID_SOLICITANTE As Int32) 
    Public Event Editando(ByVal ID_SOLICITANTE As Int32) 
...
#Region"Propiedades"
    ...
    Public Property VerNOMBRE_SOLICITANTE() As Boolean
        Get
            Return Me.dxgvLista.Columns("NOMBRE_SOLICITANTE").Visible
        End Get
        Set(ByVal Value As Boolean)
            Me.dxgvLista.Columns("NOMBRE_SOLICITANTE").Visible = Value
        End Set
    End Property
    ...
    Public Property HeaderNOMBRE_SOLICITANTE() As String
        Get
            Return Me.dxgvLista.Columns("NOMBRE_SOLICITANTE").Caption
        End Get
        Set(ByVal Value As String)
            Me.dxgvLista.Columns("NOMBRE_SOLICITANTE").Caption = Value
        End Set
    End Property
...
#End Region
    ...
    Protected Sub dxgvLista_CustomJSProperties(ByVal sender As Object, ByVal e As DevExpress.Web.ASPxGridViewClientJSPropertiesEventArgs) Handles dxgvLista.CustomJSProperties
        If Me.PermitirSeleccionParaCombo Then
            ...
            For i As Integer = 0 To grid.VisibleRowCount - 1
                keyValues(i) = grid.GetRowValues(i, "ID_SOLICITANTE")
                keyNames(i) = grid.GetRowValues(i, "CODIGO")
            Next i
    ...
    Public Function DevolverSeleccionados() As listaSOLICITANTE
        Dim mLista As New listaSOLICITANTE
        For Each llave As Decimal In Me.dxgvLista.GetSelectedFieldValues("ID_SOLICITANTE")
            Dim lEntidad As New SOLICITANTE
            lEntidad.ID_SOLICITANTE = llave
            mLista.Add(lEntidad)
        Next
        Return mLista
    End Function
    ...
    Protected Sub dxgvLista_CustomButtonCallback(ByVal sender As Object, ByVal e As DevExpress.Web.ASPxGridViewCustomButtonCallbackEventArgs) Handles dxgvLista.CustomButtonCallback
        If e.ButtonID = "btnEliminar" Then
            Dim lEntidad As SOLICITANTE = CType(Me.dxgvLista.GetRow(e.VisibleIndex), SOLICITANTE)

            If Me.mComponente.EliminarSOLICITANTE(lEntidad.ID_SOLICITANTE) <> 1 Then
