<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ucReporteRequisicion.ascx.vb" Inherits="controlesRequisicion_ucReporteRequisicion" %>
<%@ Register Src="~/controles/ucBarraNavegacion.ascx" TagName="ucBarraNavegacion" TagPrefix="uc1" %>
<%@ Register Src="~/controlesRequisicion/ucCriteriosRequisicion.ascx" TagName="ucCriteriosRequisicion" TagPrefix="uc1" %>
...
<table id="TableMant" border="0" cellpadding="0" cellspacing="0" width="100%">
    ...
    <tr>
        <td>
            <uc1:ucCriteriosRequisicion ID="ucCriteriosRequisicion1" runat="server"></uc1:ucCriteriosRequisicion>
        </td>
    </tr>
   <tr>
        <td>
