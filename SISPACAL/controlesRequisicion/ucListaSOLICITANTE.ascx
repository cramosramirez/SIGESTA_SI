<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ucListaSOLICITANTE.ascx.vb" Inherits="controles_ucListaSOLICITANTE" %>
<%@ Register TagPrefix="cc1" Namespace="SISPACAL.WebUC" Assembly="SISPACAL_WebUC" %>
<%@ Register assembly="DevExpress.Web.v14.2, Version=14.2.4.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" namespace="DevExpress.Web" tagprefix="dx" %>

<%@ Register src="ucVistaDetalleSOLICITANTE.ascx" tagname="ucVistaDetalleSOLICITANTE" tagprefix="uc1" %>
<dx:ASPxGridView ID="dxgvLista" runat="server" AutoGenerateColumns="False" DataSourceID="odsLista" KeyFieldName="ID_SOLICITANTE">
        ...
        <dx:GridViewDataTextColumn VisibleIndex="1">
            <DataItemTemplate>
                <asp:LinkButton ID="lbtnEditar" runat="server" CommandName="Editar" 
                    CommandArgument='<%# Bind("ID_SOLICITANTE") %>'>Editar</asp:LinkButton>
                &nbsp;<asp:LinkButton ID="lbtnSeleccionar" runat="server" 
                    CommandArgument='<%# Bind("ID_SOLICITANTE") %>' CommandName="Seleccionar" 
                    Visible="False">Seleccionar</asp:LinkButton>
            </DataItemTemplate>
        </dx:GridViewDataTextColumn>
        <dx:GridViewDataTextColumn FieldName="ID_SOLICITANTE" ReadOnly="True" VisibleIndex="2" Caption="Id solicitante" />
        <dx:GridViewDataTextColumn FieldName="CODIGO" VisibleIndex="3" Caption="Codigo" />
        <dx:GridViewDataTextColumn FieldName="NOMBRE_SOLICITANTE" VisibleIndex="4" Caption="Nombre solicitante" />
        <dx:GridViewCommandColumn AllowDragDrop="False"  Caption=" "
            Name="Eliminar" VisibleIndex="5">
            <CustomButtons>
    ...
    <Templates>
        <EditForm>
            <uc1:ucVistaDetalleSOLICITANTE ID="ucVistaDetalleSOLICITANTE1" runat="server" 
                ID_SOLICITANTE='<%# Bind("ID_SOLICITANTE") %>' CODIGO='<%# Bind("CODIGO") %>' NOMBRE_SOLICITANTE='<%# Bind("NOMBRE_SOLICITANTE") %>' />
...
<asp:ObjectDataSource ID="odsLista" runat="server" 
    SelectMethod="ObtenerLista" InsertMethod="AgregarSOLICITANTE" DeleteMethod="EliminarSOLICITANTE" UpdateMethod="ActualizarSOLICITANTE"
    ...
    <InsertParameters>
        <asp:Parameter DefaultValue="0" Name="ID_SOLICITANTE" Type="Int32" />
        <asp:Parameter Name="CODIGO" Type="String" />
        <asp:Parameter Name="NOMBRE_SOLICITANTE" Type="String" />
    </InsertParameters>
    <UpdateParameters>
