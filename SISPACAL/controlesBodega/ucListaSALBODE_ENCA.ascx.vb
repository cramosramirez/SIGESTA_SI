...
''' -----------------------------------------------------------------------------
''' Project	 : SISPACAL
''' Class	 : ucListaSALBODE_ENCA
''' 
''' -----------------------------------------------------------------------------
''' <summary>
''' Clase del Control de Usuario para mostrar un listado de la tabla SALBODE_ENCA
''' </summary>
''' <remarks>
...
''' </history>
''' -----------------------------------------------------------------------------
Partial Class controles_ucListaSALBODE_ENCA
    Inherits ucListaBase
 
    Private mComponente As New cSALBODE_ENCA
    Public Event Seleccionado(ByVal ID_SALBODE_ENCA As Int32) 
    Public Event Editando(ByVal ID_SALBODE_ENCA As Int32) 
...
#End Region
    ...
    Protected Sub dxgvLista_CustomJSProperties(ByVal sender As Object, ByVal e As DevExpress.Web.ASPxGridViewClientJSPropertiesEventArgs) Handles dxgvLista.CustomJSProperties
        If Me.PermitirSeleccionParaCombo Then
            ...
            For i As Integer = 0 To grid.VisibleRowCount - 1
                keyValues(i) = grid.GetRowValues(i, "ID_SALBODE_ENCA")
    ...
    Public Function DevolverSeleccionados() As listaSALBODE_ENCA
        Dim mLista As New listaSALBODE_ENCA
        For Each llave As Decimal In Me.dxgvLista.GetSelectedFieldValues("ID_SALBODE_ENCA")
            Dim lEntidad As New SALBODE_ENCA
            lEntidad.ID_SALBODE_ENCA = llave
            mLista.Add(lEntidad)
        Next
        Return mLista
    End Function
    ...
    Protected Sub dxgvLista_CustomButtonCallback(ByVal sender As Object, ByVal e As DevExpress.Web.ASPxGridViewCustomButtonCallbackEventArgs) Handles dxgvLista.CustomButtonCallback
        If e.ButtonID = "btnEliminar" Then
            Dim lEntidad As SALBODE_ENCA = CType(Me.dxgvLista.GetRow(e.VisibleIndex), SALBODE_ENCA)

            If Me.mComponente.EliminarSALBODE_ENCA(lEntidad.ID_SALBODE_ENCA) <> 1 Then
