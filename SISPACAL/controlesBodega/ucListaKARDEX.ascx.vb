...
''' -----------------------------------------------------------------------------
''' <summary>
''' Clase del Control de Usuario para mostrar un listado de la tabla KARDEX
''' </summary>
''' <remarks>
...
''' </history>
''' -----------------------------------------------------------------------------
Partial Class controles_ucListaKARDEX
    Inherits ucListaBase
 
    Private mComponente As New cKARDEX
    Public Event Seleccionado(ByVal ID_KARDEX As Int32) 
    Public Event Editando(ByVal ID_KARDEX As Int32) 
...
#Region"Propiedades"
    ...
    Public Property VerID_KARDEX() As Boolean
        Get
            Return Me.dxgvLista.Columns("ID_KARDEX").Visible
        End Get
        Set(ByVal Value As Boolean)
            Me.dxgvLista.Columns("ID_KARDEX").Visible = Value
        End Set
    End Property
    ...
    Public Property VerREFERENCIA() As Boolean
        Get
            Return Me.dxgvLista.Columns("REFERENCIA").Visible
        End Get
        Set(ByVal Value As Boolean)
            Me.dxgvLista.Columns("REFERENCIA").Visible = Value
        End Set
    End Property
    ...
    Public Property VerENT_UNIDAD() As Boolean
        Get
            Return Me.dxgvLista.Columns("ENT_UNIDAD").Visible
        End Get
        Set(ByVal Value As Boolean)
            Me.dxgvLista.Columns("ENT_UNIDAD").Visible = Value
        End Set
    End Property

    Public Property VerENT_PRECIO_UNITARIO() As Boolean
        Get
            Return Me.dxgvLista.Columns("ENT_PRECIO_UNITARIO").Visible
        End Get
        Set(ByVal Value As Boolean)
            Me.dxgvLista.Columns("ENT_PRECIO_UNITARIO").Visible = Value
        End Set
    End Property

    Public Property VerENT_TOTAL() As Boolean
        Get
            Return Me.dxgvLista.Columns("ENT_TOTAL").Visible
        End Get
        Set(ByVal Value As Boolean)
            Me.dxgvLista.Columns("ENT_TOTAL").Visible = Value
        End Set
    End Property

    Public Property VerSAL_UNIDAD() As Boolean
        Get
            Return Me.dxgvLista.Columns("SAL_UNIDAD").Visible
        End Get
        Set(ByVal Value As Boolean)
            Me.dxgvLista.Columns("SAL_UNIDAD").Visible = Value
        End Set
    End Property

    Public Property VerSAL_PRECIO_UNITARIO() As Boolean
        Get
            Return Me.dxgvLista.Columns("SAL_PRECIO_UNITARIO").Visible
        End Get
        Set(ByVal Value As Boolean)
            Me.dxgvLista.Columns("SAL_PRECIO_UNITARIO").Visible = Value
        End Set
    End Property

    Public Property VerSAL_TOTAL() As Boolean
        Get
            Return Me.dxgvLista.Columns("SAL_TOTAL").Visible
        End Get
        Set(ByVal Value As Boolean)
            Me.dxgvLista.Columns("SAL_TOTAL").Visible = Value
        End Set
    End Property

    Public Property VerSDO_UNIDAD() As Boolean
        Get
            Return Me.dxgvLista.Columns("SDO_UNIDAD").Visible
        End Get
        Set(ByVal Value As Boolean)
            Me.dxgvLista.Columns("SDO_UNIDAD").Visible = Value
        End Set
    End Property

    Public Property VerSDO_PRECIO_UNITARIO() As Boolean
        Get
            Return Me.dxgvLista.Columns("SDO_PRECIO_UNITARIO").Visible
        End Get
        Set(ByVal Value As Boolean)
            Me.dxgvLista.Columns("SDO_PRECIO_UNITARIO").Visible = Value
        End Set
    End Property

    Public Property VerSDO_TOTAL() As Boolean
        Get
            Return Me.dxgvLista.Columns("SDO_TOTAL").Visible
        End Get
        Set(ByVal Value As Boolean)
            Me.dxgvLista.Columns("SDO_TOTAL").Visible = Value
        End Set
    End Property
    ...
    Public Property HeaderID_KARDEX() As String
        Get
            Return Me.dxgvLista.Columns("ID_KARDEX").Caption
        End Get
        Set(ByVal Value As String)
            Me.dxgvLista.Columns("ID_KARDEX").Caption = Value
        End Set
    End Property
    ...
    Public Property HeaderREFERENCIA() As String
        Get
            Return Me.dxgvLista.Columns("REFERENCIA").Caption
        End Get
        Set(ByVal Value As String)
            Me.dxgvLista.Columns("REFERENCIA").Caption = Value
        End Set
    End Property
    ...
    Public Property HeaderENT_UNIDAD() As String
        Get
            Return Me.dxgvLista.Columns("ENT_UNIDAD").Caption
        End Get
        Set(ByVal Value As String)
            Me.dxgvLista.Columns("ENT_UNIDAD").Caption = Value
        End Set
    End Property

    Public Property HeaderENT_PRECIO_UNITARIO() As String
        Get
            Return Me.dxgvLista.Columns("ENT_PRECIO_UNITARIO").Caption
        End Get
        Set(ByVal Value As String)
            Me.dxgvLista.Columns("ENT_PRECIO_UNITARIO").Caption = Value
        End Set
    End Property

    Public Property HeaderENT_TOTAL() As String
        Get
            Return Me.dxgvLista.Columns("ENT_TOTAL").Caption
        End Get
        Set(ByVal Value As String)
            Me.dxgvLista.Columns("ENT_TOTAL").Caption = Value
        End Set
    End Property

    Public Property HeaderSAL_UNIDAD() As String
        Get
            Return Me.dxgvLista.Columns("SAL_UNIDAD").Caption
        End Get
        Set(ByVal Value As String)
            Me.dxgvLista.Columns("SAL_UNIDAD").Caption = Value
        End Set
    End Property

    Public Property HeaderSAL_PRECIO_UNITARIO() As String
        Get
            Return Me.dxgvLista.Columns("SAL_PRECIO_UNITARIO").Caption
        End Get
        Set(ByVal Value As String)
            Me.dxgvLista.Columns("SAL_PRECIO_UNITARIO").Caption = Value
        End Set
    End Property

    Public Property HeaderSAL_TOTAL() As String
        Get
            Return Me.dxgvLista.Columns("SAL_TOTAL").Caption
        End Get
        Set(ByVal Value As String)
            Me.dxgvLista.Columns("SAL_TOTAL").Caption = Value
        End Set
    End Property

    Public Property HeaderSDO_UNIDAD() As String
        Get
            Return Me.dxgvLista.Columns("SDO_UNIDAD").Caption
        End Get
        Set(ByVal Value As String)
            Me.dxgvLista.Columns("SDO_UNIDAD").Caption = Value
        End Set
    End Property

    Public Property HeaderSDO_PRECIO_UNITARIO() As String
        Get
            Return Me.dxgvLista.Columns("SDO_PRECIO_UNITARIO").Caption
        End Get
        Set(ByVal Value As String)
            Me.dxgvLista.Columns("SDO_PRECIO_UNITARIO").Caption = Value
        End Set
    End Property

    Public Property HeaderSDO_TOTAL() As String
        Get
            Return Me.dxgvLista.Columns("SDO_TOTAL").Caption
        End Get
        Set(ByVal Value As String)
            Me.dxgvLista.Columns("SDO_TOTAL").Caption = Value
        End Set
    End Property
...
#End Region
    ...
    ''' -----------------------------------------------------------------------------
    ''' <summary>
    ''' FunciÃ³n que Carga la informaciÃ³n de los registros de la tabla KARDEX
    ''' </summary>
    ''' <remarks>
    ''' </remarks>
    ''' <history>
    ...
    Protected Sub dxgvLista_CustomJSProperties(ByVal sender As Object, ByVal e As DevExpress.Web.ASPxGridViewClientJSPropertiesEventArgs) Handles dxgvLista.CustomJSProperties
        If Me.PermitirSeleccionParaCombo Then
            ...
            For i As Integer = 0 To grid.VisibleRowCount - 1
                keyValues(i) = grid.GetRowValues(i, "ID_KARDEX")
    ...
    Public Function DevolverSeleccionados() As listaKARDEX
        Dim mLista As New listaKARDEX
        For Each llave As Decimal In Me.dxgvLista.GetSelectedFieldValues("ID_KARDEX")
            Dim lEntidad As New KARDEX
            lEntidad.ID_KARDEX = llave
            mLista.Add(lEntidad)
        Next
        Return mLista
    End Function
    ...
    Protected Sub dxgvLista_CustomButtonCallback(ByVal sender As Object, ByVal e As DevExpress.Web.ASPxGridViewCustomButtonCallbackEventArgs) Handles dxgvLista.CustomButtonCallback
        If e.ButtonID = "btnEliminar" Then
            Dim lEntidad As KARDEX = CType(Me.dxgvLista.GetRow(e.VisibleIndex), KARDEX)

            If Me.mComponente.EliminarKARDEX(lEntidad.ID_KARDEX) <> 1 Then
    ...
    Protected Sub dxgvLista_CustomUnboundColumnData(sender As Object, e As DevExpress.Web.ASPxGridViewColumnDataEventArgs) Handles dxgvLista.CustomUnboundColumnData
        If e.Column.FieldName = "TIPO_MOVTO" Then
        ...
        ElseIf e.Column.FieldName = "NOMBRE_PRODUCTO" Then
            Dim lEntidad As PRODUCTO = (New cPRODUCTO).ObtenerPRODUCTO(e.GetListSourceFieldValue("ID_PRODUCTO"))
            If lEntidad IsNot Nothing Then e.Value = lEntidad.NOMBRE_PRODUCTO + " " + lEntidad.PRESENTACION
        ElseIf e.Column.FieldName = "NOMBRE_PROVEEDOR" Then
            Dim lEntidad As PRODUCTO = (New cPRODUCTO).ObtenerPRODUCTO(e.GetListSourceFieldValue("ID_PRODUCTO"))
            If lEntidad IsNot Nothing Then
                Dim lProvee As PROVEEDOR_AGRICOLA = (New cPROVEEDOR_AGRICOLA).ObtenerPROVEEDOR_AGRICOLA(lEntidad.ID_PROVEE)
                If lProvee IsNot Nothing Then
                    e.Value = lProvee.NOMBRE
                End If
            End If
        End If
    End Sub
